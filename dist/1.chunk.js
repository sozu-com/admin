...
var AddPropertyComponent = (function () {
    ...
    AddPropertyComponent.prototype.addCustomArea = function () {
        this.model.custom_attributes.push({ name: '', value: '' });
    };
    AddPropertyComponent.prototype.removeCustomArea = function (index) {
        this.model.custom_attributes.splice(index, 1);
    };
    AddPropertyComponent.prototype.addNewCarpetArea = function () {
        this.model.carpet_areas.push({ area: '', price: '' });
    };
    AddPropertyComponent.prototype.removeCarpetArea = function (index) {
