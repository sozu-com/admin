...
module.exports = "<div class=\"white-bg\">\n    <div class=\"chat-area scrollbox\" malihu-scrollbar [scrollbarOptions]=\"scrollbarOptions\" style=\"height: 704px; width: 429px; padding-right: 17px; outline: none; overflow: hidden;\">\n      <div *ngFor=\"let m of parameter.messages\" class=\"chat-user\" [ngClass]=\"m.conversation_user.admin_id == admin_id ? 'chat-user-one' : 'chat-user-two'\">\n        <p style=\"word-wrap: break-word;\">{{m.message}}</p>\n        <span class=\"time\">\n        {{m.created_at  | chatTime: m.created_at}}\n        </span>\n      </div>\n  </div>\n  <div class=\"chat-text\">\n      <input id=\"message\" autocomplete=\"off\" [(ngModel)]=\"message\" (keyup.enter)=\"sendMessage()\" class=\"chat-input\" type=\"text\" name=\"message\" placeholder=\"Type your message here …\">\n      <!-- <textarea rows=\"3\" autocomplete=\"off\" [(ngModel)]=\"message\" class=\"chat-input\" placeholder=\"Type your message here …\" (keyup.enter)=\"sendMessage()\"></textarea> -->\n      <button (click)=\"sendMessage()\" class=\"btn\">Send</button>\n  </div>\n</div>"
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(admin, constant) {
        this.admin = admin;
        this.constant = constant;
        this.scrollbarOptions = { axis: 'y', theme: 'dark', scrollInertia: 0, scrollbar: 'bottom', scrollbarPosition: 'inside' };
        this.parameter = {};
    }
    ...
    ChatComponent.prototype.getMessages = function () {
        ...
        this.admin.postDataApi('conversation/getMessages', { lead_id: this.lead_id, user_id: this.user_id }).subscribe(function (res) {
    ...
    ChatComponent.prototype.initSocket = function () {
        var _this = this;
        this.parameter.socket = __WEBPACK_IMPORTED_MODULE_2_socket_io_client__["connect"](this.admin.socketUrl);
    ...
    ChatComponent.prototype.sendMessage = function () {
        var _this = this;
        if (this.message) {
            this.admin.postDataApi('conversation/sendMessage', { conversation_id: this.parameter.conversation_id, message: this.message }).subscribe(function (r) {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('malihuScrollBar'),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" ? _a : Object)
    ], ChatComponent.prototype, "malihuScrollBar", void 0);
    ChatComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */]]
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_admin_service__["a" /* AdminService */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */]) === "function" ? _c : Object])
    ], ChatComponent);
...
var InterestedPropertyComponent = /** @class */ (function () {
    function InterestedPropertyComponent(model, admin) {
        this.model = model;
        this.admin = admin;
        this.parameter = {};
    }
    ...
    InterestedPropertyComponent.prototype.attachProperty = function () {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('adminType'),
        __metadata("design:type", Object)
    ], InterestedPropertyComponent.prototype, "adminType", void 0);
    __decorate([
    ...
    InterestedPropertyComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__models_leads_model__["a" /* DealFinalize */]]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__models_leads_model__["a" /* DealFinalize */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__models_leads_model__["a" /* DealFinalize */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */]) === "function" ? _b : Object])
...
module.exports = "<div class=\"container-fluid\">\n  <div class=\"white-bg padding15\">\n     <div class=\"row\">\n         <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n           <div *ngIf=\"parameter.lead?.user\" class=\"profile\">\n              <div class=\"fig-block\">\n                 <img [src]=\"parameter.lead.user.image\" onerror='src=\"http://via.placeholder.com/56x56\"' alt=\"img\">\n              </div>\n              <div class=\"profile-info\">\n                 <h6>{{parameter.lead.user.name}}</h6>\n                 <p>{{parameter.lead.user.phone}}</p>\n              </div>\n           </div>\n        </div>\n         <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n           <div *ngIf=\"parameter.lead?.broker\" class=\"profile\">\n              <div class=\"fig-block\">\n                 <img [src]=\"parameter.lead.broker.image\" onerror='src=\"http://via.placeholder.com/56x56\"' alt=\"img\">\n              </div>\n              <div class=\"profile-info\">\n                 <h6>{{parameter.lead.broker.name}}</h6>\n                 <p>Broker</p>\n              </div>\n           </div>\n        </div>\n        <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n           <div  class=\"form-group d-flex marginT10 float-right right-side\">\n             <div class=\"dropdown btn-cont\">\n               <button type=\"button\" class=\"btn btn-primary dropdown-toggle\" data-toggle=\"dropdown\">\n                 Action\n               </button>\n               <div class=\"dropdown-menu dropdown-menu-right\">\n                 <a (click)=\"assignToBroker()\" *ngIf=\"!parameter.lead?.broker && parameter.lead?.user\" class=\"dropdown-item\" href=\"javascript://\">Assign to broker</a>\n                 <a (click)=\"blockThisLead()\" class=\"dropdown-item\" href=\"javascript://\">Block</a>\n               </div>\n            </div>\n           </div>\n        </div>\n     </div>\n  </div>\n  <!-- <ngx-loading [show]=\"parameter.loading\"></ngx-loading> -->\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div *ngIf=\"parameter.lead\" class=\"white-bg padding30\">\n\n           <div class=\"row\">\n              <div class=\"col-md-6\">\n                 <h6>Details</h6>\n              </div>\n              <div class=\"col-md-6\">\n                 <div class=\"edit text-right\"><a href=\"javascript://\">Edit</a></div>\n              </div>\n           </div>\n           <div class=\"details-table\">\n             <table class=\"table\">\n                <tbody><tr>\n                   <td style=\"padding-left:0\"><label>Full Name</label></td>\n                   <td>{{parameter.lead.name}}</td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Contact Number</label></td>\n                   <td>{{parameter.lead.phone}}</td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Email address</label></td>\n                   <td>{{parameter.lead.email}}</td>\n                </tr>\n                <tr *ngIf=\"parameter.lead?.configuration\">\n                   <td style=\"padding-left:0\"><label>Interested In</label></td>\n                   <td>\n                     <span *ngFor=\"let conf of parameter.lead.configuration\">\n                       {{conf.name}}\n                     </span>\n                   </td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Favourite Projects</label></td>\n                   <td>80 <a class=\"view-all\" href=\"javascript://\">View All</a></td>\n                </tr>\n              </tbody>\n             </table>\n           </div>\n        </div>\n        <div class=\"spacer30\"></div>\n        <div class=\"white-bg padding15\">\n           <p class=\"p16 marginB0\">Fill in Information</p>\n        </div>\n        <hr class=\"margin0\">\n        <div class=\"white-bg padding40\">\n           <div class=\"form-group-4\">\n              <label>Preferred</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio\">\n              <span class=\"checkmark\">Neighbourhood</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio\">\n              <span class=\"checkmark\">Building</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n           <div class=\"row\">\n              <div class=\"col-sm-6 col-12\">\n                 <div class=\"form-group-4\">\n                    <label>Family Size</label>\n                    <input class=\"form-control\" type=\"text\" name=\"\">\n                 </div>\n              </div>\n              <div class=\"col-sm-6 col-12\">\n                 <div class=\"form-group-4\">\n                    <label>Kids - Age group</label>\n                    <input class=\"form-control\" type=\"text\" name=\"\">\n                 </div>\n              </div>\n           </div>\n           <div class=\"inline-form-group-2 marginT20\">\n              <div class=\"row\">\n                 <div class=\"col-6\"><label class=\"float-left\">Pets</label></div>\n                 <div class=\"col-6\">\n                    <label class=\"cust-check-bx\">\n                    <input type=\"checkbox\">\n                    <span class=\"checkmark\"></span>\n                    </label>\n                 </div>\n              </div>\n           </div>\n           <div class=\"form-group-4 marginT20\">\n              <label>Close proximity needed to</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio1\">\n              <span class=\"checkmark\">Workplace</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">School</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">Gym</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">Temple</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n           <div class=\"form-group-4 date-picker\">\n              <label>How soon planning to buy/rent</label>\n              <input type=\"text\" class=\"form-control\" id=\"datetimepicker\" placeholder=\"Select Date\">\n              <span class=\"sel-date\">Select date</span>\n           </div>\n           <div class=\"form-group-4 marginT20\">\n              <label>Car Types</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio2\">\n              <span class=\"checkmark\">Electric</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio2\">\n              <span class=\"checkmark\">SUV</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n           <div class=\"btn-cont text-right\">\n              <button class=\"btn btn-primary \">Save</button>\n           </div>\n        </div>\n\n     </div>\n     <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div *ngIf=\"!parameter.lead?.user\" class=\"white-bg padding20\">\n          User is not registered.\n        </div>\n\n        <div *ngIf=\"parameter.lead?.user\">\n          <app-chat [lead_id]=\"parameter.lead_id\" [user_id]=\"parameter.user_id\" [admin_id]=\"parameter.admin_id\"></app-chat>\n        </div>\n\n        <div class=\"spacer30\"></div>\n        <div class=\"white-bg padding15\">\n           <div class=\"row\">\n              <div class=\"col-6\">\n                 <p class=\"p16 marginB0\">Write a Note</p>\n              </div>\n              <div class=\"col-6 text-right\"><a class=\"add\" href=\"javascript://\">Add</a></div>\n           </div>\n        </div>\n        <hr class=\"margin0\">\n        <div class=\"write-note white-bg padding40\">\n           <div class=\"wn-block\">\n              <div class=\"circle\">\n                 <span></span>\n              </div>\n              <a class=\"delete\" href=\"javascript://\">Delete</a>\n              <p class=\"time\">07 Apr 2018 · 10:30AM</p>\n              <p class=\"p13\">Hey! I am interested in the  property you’ve listed. I was thinking of having a look at it..<a class=\"view-more\" href=\"javascript://\">view more</a></p>\n           </div>\n           <div class=\"wn-block\">\n              <div class=\"circle\">\n                 <span></span>\n              </div>\n              <a class=\"delete\" href=\"javascript://\">Delete</a>\n              <p class=\"time\">07 Apr 2018 · 10:30AM</p>\n              <p class=\"p13\">Hey! I am interested in the  property you’ve listed. I was thinking of having a look at it..<a class=\"view-more\" href=\"javascript://\">view more</a></p>\n           </div>\n        </div>\n     </div>\n  </div>\n\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-6\">\n        <p class=\"p16\">Interested Properties</p>\n     </div>\n   <div class=\"col-6\">\n        <div class=\"btn-cont text-right\"> <a routerLink=\"/dashboard/properties/add-property/0\" class=\"btn btn-fourth\" href=\"javascript://\">Add</a></div>\n     </div>\n  </div>\n  \n  <div class=\"spacer15\"></div>\n  <div class=\"row\" *ngIf=\"parameter.interested_properties?.length>0\">\n    <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\" *ngFor=\"let ip of parameter.interested_properties\">\n      <app-interested-property *ngIf=\"ip.building\" [data]=\"ip\" [adminType]=\"3\"></app-interested-property>\n    </div>\n  </div>\n  <div *ngIf=\"parameter.interested_properties?.length == 0\">\n    <p class=\"show-error\">\n      {{constant.errorMsg.NO_INTERESTED_PROPERTY_FOUND}}\n    </p>\n  </div>\n\n\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-6\">\n        <p class=\"p16\">Viewed Projects or properties</p>\n     </div>\n     <div class=\"col-6\">\n        <a class=\"view-all-2 float-right\" href=\"javascript://\">View All</a>\n     </div>\n  </div>\n  <div class=\"spacer15\"></div>\n  <div class=\"row\">\n     <div class=\"col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg\">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a>\n           </div>\n        </div>\n     </div>\n     <div class=\"col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg \">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a>\n           </div>\n        </div>\n     </div>\n    <div class=\"col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg \">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a>\n           </div>\n        </div>\n     </div>\n  </div>\n\n</div>\n"
...
var CsrBuyerDetailComponent = /** @class */ (function () {
    function CsrBuyerDetailComponent(router, route, admin, constant) {
        var _this = this;
        this.router = router;
        this.route = route;
        this.admin = admin;
        ...
        this.admin.loginData$.subscribe(function (success) {
            ...
            console.log('admin_id', _this.parameter.admin_id);
        });
    }
    CsrBuyerDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            // this.parameter.loading = true;
            _this.admin.postDataApi('leads/details', { lead_id: _this.parameter.id }).subscribe(function (r) {
                // console.log(r);
                ...
                _this.parameter.lead_id = _this.parameter.id;
                _this.parameter.user_id = _this.parameter.lead.user ? _this.parameter.lead.user.id : 0;
                console.log('userid', _this.parameter.lead_id, _this.parameter.user_id);
            });
        });
    };
    CsrBuyerDetailComponent.prototype.assignToBroker = function () {
        var _this = this;
        this.admin.postDataApi('conversation/assignBroker', { lead_id: this.parameter.id }).subscribe(function (r) {
            console.log('conversation/assignBroker', r);
            _this.parameter.lead = r.data;
            console.log(_this.parameter.lead);
        }
        // error => {
        //   swal('Error', error.message, 'error');
        // }
    ...
    CsrBuyerDetailComponent.prototype.blockThisLead = function () {
        this.admin.postDataApi('conversation/block', { lead_id: this.parameter.id }).subscribe(function (r) {
    ...
    CsrBuyerDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */]) === "function" ? _d : Object])
...
var CsrCloserDetailComponent = /** @class */ (function () {
    function CsrCloserDetailComponent(router, route, admin, constant) {
        this.router = router;
        this.route = route;
        this.admin = admin;
        this.constant = constant;
    ...
    CsrCloserDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.id = params.id;
            _this.admin.postDataApi('leads/details', { lead_id: _this.id }).subscribe(function (r) {
                // console.log(r);
                _this.lead = r.data.lead;
                console.log(_this.lead);
                if (_this.lead.user) {
                    _this.admin.postDataApi('conversation/getMessages', { lead_id: _this.id, user_id: _this.lead.user.id }).subscribe(function (res) {
                        _this.conversation = res.data[0];
    ...
    CsrCloserDetailComponent.prototype.assignToBroker = function () {
        var _this = this;
        this.admin.postDataApi('conversation/assignBroker', { lead_id: this.id }).subscribe(function (r) {
            console.log(r);
            _this.lead = r.data;
            console.log(_this.lead);
        }
    ...
    CsrCloserDetailComponent.prototype.sendMessage = function () {
        var _this = this;
        this.admin.postDataApi('conversation/sendMessage', { conversation_id: this.conversation.id, message: this.message }).subscribe(function (r) {
            console.log(r);
            _this.message = '';
        });
    };
    CsrCloserDetailComponent.prototype.initSocket = function () {
        var _this = this;
        this.socket = __WEBPACK_IMPORTED_MODULE_3_socket_io_client__["connect"](this.admin.socketUrl);
        this.socket.on('connect', function (fun) {
            ...
            if (_this.connected) {
                ...
                _this.socket.on('message', function (res) {
                    console.log(res);
                });
            }
        });
    ...
    CsrCloserDetailComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__common_constants__["a" /* Constant */]]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__common_constants__["a" /* Constant */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__common_constants__["a" /* Constant */]) === "function" ? _d : Object])
...
var CsrCloserComponent = /** @class */ (function () {
    function CsrCloserComponent(admin, router, constant) {
        this.admin = admin;
        this.router = router;
        this.constant = constant;
        this.parameter = {};
...
module.exports = "<!-- <ngx-loading [show]=\"parameter.loading\"></ngx-loading> -->\n\n<div class=\"container-fluid\">\n\n  <div class=\"row\">\n     <div class=\"col-md-3\">\n        <a class=\"view-all-2\" href=\"javascript://\"><i class=\"fa fa-angle-left\"></i><span>View all</span></a>\n     </div>\n     <div class=\"col-md-9\">\n        <div class=\"cust-tabs-2\">\n          <ul class=\"nav nav-tabs\">\n            <li class=\"nav-item\">\n                <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==1}\" (click)=\"changeFlag(1)\" >This Week</a>\n            </li>\n            <li class=\"nav-item\">\n                <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==2}\" (click)=\"changeFlag(2)\" >This Month</a>\n            </li>\n            <li class=\"nav-item\">\n                <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==3}\" (click)=\"changeFlag(3)\" >Last Month</a>\n            </li>\n            <li class=\"nav-item\">\n                <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==4}\" (click)=\"changeFlag(4)\" >Lifetime</a>\n            </li>\n            <li class=\"nav-item\">\n                <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==5}\" (click)=\"changeFlag(5)\" >Custom</a>\n            </li>\n          </ul>\n        </div>\n     </div>\n     <div class=\"col-12\">\n        <hr style=\"margin-top:0;\">\n     </div>\n  </div>\n  <div class=\"sigle-row-table\">\n     <table class=\"table table-striped\">\n        <tbody><tr>\n           <td> <img class=\"rounded-circle\" src=\"http://via.placeholder.com/50x50\" alt=\"img\"></td>\n           <td class=\"text-left\">\n              <span class=\"name\">Lillian Russell</span>\n           </td>\n           <td class=\"text-left\">\n              728-111-1874\n           </td>\n           <td class=\"text-left\">\n              eunice_aufderhar@yahoo.com\n           </td>\n           <td>\n              14\n           </td>\n           <td>\n              <a href=\"javascript://\" class=\"icon-block edit-icon\"><img src=\"assets/img/edit.png\" alt=\"img\"></a>\n              <a href=\"javascript://\" class=\"icon-block block-icon\"><img src=\"assets/img/block.png\" alt=\"img\"></a>\n           </td>\n        </tr>\n     </tbody></table>\n  </div>\n  <div class=\"row\">\n     <div class=\"col-lg-8 col-md-12 col-sm-12 col-12\">\n        <div class=\"info-box all-leads\">\n           <div class=\"row\">\n              <div class=\"col-md-6 col-sm-6 col-12 active\">\n                 <div class=\"one-row \">\n                    <div class=\"o-block\">\n                       <h5>Leads</h5>\n                       <small>Total</small>\n                    </div>\n                    <div class=\"o-block\">\n                       <a class=\"view-all\" href=\"javascript://\">View All</a>\n                       <h4>26</h4>\n                    </div>\n                 </div>\n              </div>\n              <div class=\"col-md-6 col-sm-6 col-12\">\n                 <div class=\"one-row\">\n                    <div class=\"o-block\">\n                       <h5>Leads</h5>\n                       <small>Without Properties</small>\n                    </div>\n                    <div class=\"o-block\">\n                       <a class=\"view-all\" href=\"javascript://\">View All</a>\n                       <h4>10</h4>\n                    </div>\n                 </div>\n              </div>\n           </div>\n        </div>\n                      <div class=\"info-box all-leads\">\n           <div class=\"row\">\n              <div class=\"col-md-6 col-sm-6 col-12\">\n                 <div class=\"one-row \">\n                    <div class=\"o-block\">\n                       <h5>Leads</h5>\n                       <small>With Properties</small>\n                    </div>\n                    <div class=\"o-block\">\n                       <a class=\"view-all\" href=\"javascript://\">View All</a>\n                       <h4>26</h4>\n                    </div>\n                 </div>\n              </div>\n              <div class=\"col-md-6 col-sm-6 col-12\">\n                 <div class=\"one-row\">\n                    <div class=\"o-block\">\n                       <h5>Leads</h5>\n                       <small>Pending Properties (in Draft)</small>\n                    </div>\n                    <div class=\"o-block\">\n                       <a class=\"view-all\" href=\"javascript://\">View All</a>\n                       <h4>10</h4>\n                    </div>\n                 </div>\n              </div>\n           </div>\n        </div>\n\n     </div>\n     <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"chat-msg all-leads\">\n           <div class=\"row\">\n              <div class=\"col-6\">\n                 <h5>Chat</h5>\n              </div>\n              <div class=\"col-6 text-right\"><a class=\"msg\" href=\"javascript://\">Message</a></div>\n           </div>\n           <p>Waiting for response</p>\n           <p>\n              <strong>Mario Hudson</strong>\n              When you are free to have a meeting\n              with interested customers?\n           </p>\n           <p>\n              <strong>Rosie Benson</strong>\n              Is there any availability in the localities\n              I was asking you tomorrow and also p…\n           </p>\n        </div>\n     </div>\n  </div>\n  <div class=\"row\">\n     <div class=\"col-12\">\n        <div class=\"spacer40\"></div>\n     </div>\n\n  </div>\n  <div class=\"row\">\n     <div class=\"col-6\">\n        <div class=\"title-group\">\n           <h5>Leads (Without Properties)</h5>\n           <p>Showing 6 out of 9</p>\n        </div>\n     </div>\n     <div class=\"col-6\">\n        <div class=\"add-new text-right\">\n           <a class=\"btn\" href=\"javascript://\">+Add New</a>\n        </div>\n     </div>\n  </div>\n  <div class=\"white-bg\">\n     <div class=\"tabel-section\">\n        <div class=\"table-responsive\">\n           <table class=\"table table-striped border-0\">\n              <tbody>\n\n              <tr>\n              <th style=\"width:6%; border-top:0\">&nbsp;</th>\n                 <th style=\"width:20%; border-top:0\">\n                    <div class=\"table-search\">\n                       <label>Name</label>\n                       <input type=\"Search here\" name=\"\">\n                    </div>\n                 </th>\n                 <th style=\"width:20%; text-align:left; border-top:0\">\n                    <div class=\"table-search\">\n                       <label>Contact Number</label>\n                       <input type=\"Search here\" name=\"\">\n                    </div>\n                 </th>\n                 <th style=\"width:20%; border-top:0\">\n                    <div class=\"table-search\">\n                       <label>Email Address</label>\n                       <input type=\"Search here\" name=\"\">\n                    </div>\n                 </th>\n                 <th style=\"width:20%; vertical-align: top; border-top:0\">\n                    Assignee\n\n                 </th>\n                 <th>\n                 <label>Properties</label>\n                  <div class=\"ppties\">\n                     <a href=\"javascript://\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Coming soon\">A<img src=\"assets/img/top-arrow.png\" alt=\"img\"></a>\n                     </div>\n                 </th>\n                  <th>\n                   <label>&nbsp;</label>\n                  <div class=\"ppties\">\n                     <a href=\"javascript://\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Coming soon\">R<img src=\"assets/img/top-arrow.png\" alt=\"img\"></a>\n                     </div>\n                 </th>\n                  <th>\n                  <label>&nbsp;</label>\n                  <div class=\"ppties\">\n                     <a href=\"javascript://\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Coming soon\">P<img src=\"assets/img/top-arrow.png\" alt=\"img\"></a>\n                     </div>\n                 </th>\n                  <th>\n                  <label>&nbsp;</label>\n                  <div class=\"ppties\">\n                     <a href=\"javascript://\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"In Draft\">D<img src=\"assets/img/top-arrow.png\" alt=\"img\"></a>\n                     </div>\n                 </th>\n                  <th>\n                  <label>&nbsp;</label>\n                  <div class=\"ppties\">\n                     <a href=\"javascript://\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Coming soon\">T<img src=\"assets/img/top-arrow.png\" alt=\"img\"></a>\n                     </div>\n                 </th>\n              </tr>\n              <tr *ngFor=\"let item of items| paginate: { itemsPerPage: parameter.itemsPerPage, currentPage: parameter.p, totalItems: parameter.total }\">\n                <td>\n                  <img *ngIf=\"item.image\" class=\"rounded-circle\" [src]=\"item.image\" alt=\"img\">\n                  <img *ngIf=\"!item.image\" class=\"rounded-circle\" src=\"./../../../assets/img/default_img.png\" alt=\"img\">\n                </td>\n                <td class=\"text-left\">\n                  <span class=\"name\">{{item.name}}</span>\n                 </td>\n                 <td class=\"text-left\" *ngIf=\"item.phone\">{{item.country_code}}-{{item.phone}}</td>\n                 <td class=\"text-left\" *ngIf=\"!item.phone\">NA</td>\n                  <td class=\"text-left\">\n                    {{item.email}}\n                 </td>\n                 <td>\n                   Logan Cast\n                 </td>\n                 <td>\n                    15\n                 </td>\n                 <td>\n                    14\n                 </td>\n                 <td>\n                    13\n                 </td>\n                 <td>\n                    12\n                 </td>\n                 <td>\n                    11\n                 </td>\n              </tr>\n\n           </tbody></table>\n        </div>\n     </div>\n\n  </div>\n</div>\n"
...
var CsrSellerComponent = /** @class */ (function () {
    function CsrSellerComponent(admin, router, constant) {
        this.admin = admin;
        this.router = router;
        this.constant = constant;
        this.parameter = {};
...
module.exports = "\n<!-- <ngx-loading [show]=\"parameter.loading\"></ngx-loading> -->\n\n<div class=\"container-fluid\">\n  <div class=\"row\">\n      <div class=\"col-md-3\">\n        <a class=\"view-all-2\" href=\"javascript://\"><i class=\"fa fa-angle-left\"></i><span>View all</span></a>\n      </div>\n      <div class=\"col-md-9\">\n        <div class=\"cust-tabs-2\">\n            <ul class=\"nav nav-tabs\">\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==1}\" (click)=\"changeFlag(1)\" >This Week</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==2}\" (click)=\"changeFlag(2)\" >This Month</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==3}\" (click)=\"changeFlag(3)\" >Last Month</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==4}\" (click)=\"changeFlag(4)\" >Lifetime</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==5}\" (click)=\"changeFlag(5)\" >Custom</a>\n              </li>\n            </ul>\n        </div>\n      </div>\n      <div class=\"col-12\">\n        <hr style=\"margin-top:0;\">\n      </div>\n  </div>\n\n  <div class=\"sigle-row-table\">\n    <table class=\"table table-striped\">\n        <tr>\n          <td> <img class=\"rounded-circle\" src=\"./../../../assets/img/default_img.png\" alt=\"img\"></td>\n          <td class=\"text-left\">\n              <span class=\"name\">Lillian Russell</span>\n          </td>\n          <td class=\"text-left\">\n              728-111-1874\n          </td>\n          <td class=\"text-left\">\n              eunice_aufderhar@yahoo.com\n          </td>\n          <td>\n              14\n          </td>\n          <td>\n              <a href=\"javascript://\" class=\"icon-block edit-icon\"><img src=\"./../../../assets/img/edit.png\" alt=\"img\"></a>\n              <a href=\"javascript://\" class=\"icon-block block-icon\"><img src=\"./../../../assets/img/unblock.png\" alt=\"img\"></a>\n          </td>\n        </tr>\n    </table>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"info-box\">\n            <div class=\"one-row\">\n              <div class=\"o-block\">\n                  <h5>Buildings</h5>\n                  <small>Requests Pending</small>\n              </div>\n              <div class=\"o-block\">\n                  <a class=\"view-all\" href=\"javascript://\">View All</a>\n                  <h4>15</h4>\n              </div>\n            </div>\n            <div class=\"three-row\">\n              <div class=\"t-block\">\n                  <p><strong>3</strong></p>\n                  <p>Admin</p>\n              </div>\n              <div class=\"t-block\">\n                  <p><strong>6</strong></p>\n                  <p>CSR</p>\n              </div>\n              <div class=\"t-block\">\n                  <p><strong>5</strong></p>\n                  <p>User</p>\n              </div>\n            </div>\n        </div>\n      </div>\n    <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"four-block\">\n            <div class=\"d-flex\">\n              <div class=\"f-block approved\">\n                  <h5>Approved</h5>\n                  <h3>25</h3>\n              </div>\n              <div class=\"f-block unapproved\">\n                  <h5>Unapproved</h5>\n                  <h3>02</h3>\n              </div>\n            </div>\n            <div class=\"d-flex\">\n              <div class=\"f-block pending active\">\n                  <h5>Pending</h5>\n                  <h3>01</h3>\n              </div>\n              <div class=\"f-block unapproved\">\n                  <h5>In Draft</h5>\n                  <h3>02</h3>\n              </div>\n            </div>\n        </div>\n      </div>\n      <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"chat-msg\">\n            <div class=\"row\">\n              <div class=\"col-6\">\n                  <h5>Chat</h5>\n              </div>\n              <div class=\"col-6 text-right\"><a class=\"msg\" href=\"javascript://\">Message</a></div>\n            </div>\n            <p>Waiting for response</p>\n            <p>\n              <strong>Mario Hudson</strong>\n              When you are free to have a meeting\n              with interested customers?\n            </p>\n            <p>\n              <strong>Rosie Benson</strong>\n              Is there any availability in the localities\n              I was asking you tomorrow and also p…\n            </p>\n        </div>\n      </div>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-12\">\n        <div class=\"spacer40\"></div>\n      </div>\n      <div class=\"col-12\">\n        <div class=\"title-group\">\n            <h5>Requests Pending</h5>\n           <p>Showing {{items?.length}} out of {{parameter.total}}</p>\n        </div>\n      </div>\n  </div>\n\n  <div class=\"white-bg\">\n        <div class=\"tabel-section\">\n           <div class=\"table-responsive\">\n              <table class=\"table table-striped table-align-left vertical-align-top border-0\">\n                 <tr>\n                    <th class=\"border-top-0\" style=\"width:20%\">\n                       <div class=\"table-search\">\n                          <label>Name of Building</label>\n                          <input type=\"Search here\" name=\"\">\n                       </div>\n                    </th>\n                    <th class=\"border-top-0\" style=\"width:20%; text-align:left;\">\n                       <div class=\"table-search\">\n                          <label>Location</label>\n                          <input type=\"Search here\" name=\"\">\n                       </div>\n                    </th>\n                    <th class=\"border-top-0\" style=\"width:20%\">\n                       <div class=\"table-search\">\n                          <label>Developer</label>\n                          <input type=\"Search here\" name=\"\">\n                       </div>\n                    </th>\n                    <th class=\"border-top-0\" style=\"width:20%;\">\n                       Contact and <br>\n                       Email address\n                    </th>\n                    <th  class=\"border-top-0\" style=\"width:14%\">\n                       Assignee\n                    </th>\n                    <th class=\"border-top-0\" style=\"width:14%\">\n                       Mark <br>\n                       Complete\n                    </th>\n                 </tr>\n                 <tr>\n                    <td><strong>Home Land Towers</strong></td>\n                    <td>570 Balistreri \n                       Mews Apt. 293, Chandigarh.\n                    </td>\n                    <td>Jordan Price</td>\n                    <td>050-791-7903<br>\n                       rylan_champlin@gmail.com\n                    </td>\n                    <td>Corey Garrett</td>\n                    <td style=\"vertical-align:middle; \">\n                       <label class=\"marked\">  <input type=\"checkbox\" checked=\"checked\">\n                         <span class=\"checkmark\"></span>\n                       </label>\n\n                    </td>\n                 </tr>\n                     <tr>\n                    <td><strong>Home Land Towers</strong></td>\n                    <td>570 Balistreri \n                       Mews Apt. 293, Chandigarh.\n                    </td>\n                    <td>Jordan Price</td>\n                    <td>050-791-7903<br>\n                       rylan_champlin@gmail.com\n                    </td>\n                    <td>Corey Garrett</td>\n                    <td style=\"vertical-align:middle; \">\n                       <label class=\"marked\">  <input type=\"checkbox\" checked=\"checked\">\n                         <span class=\"checkmark\"></span>\n                       </label>\n                    </td>\n                 </tr>\n                     <tr>\n                    <td><strong>Home Land Towers</strong></td>\n                    <td>570 Balistreri \n                       Mews Apt. 293, Chandigarh.\n                    </td>\n                    <td>Jordan Price</td>\n                    <td>050-791-7903<br>\n                       rylan_champlin@gmail.com\n                    </td>\n                    <td>Corey Garrett</td>\n                    <td style=\"vertical-align:middle; \">\n                       <label class=\"marked\">  <input type=\"checkbox\" checked=\"checked\">\n                         <span class=\"checkmark\"></span>\n                       </label>\n\n                    </td>\n                 </tr>\n                <tr>\n                    <td><strong>Home Land Towers</strong></td>\n                    <td>570 Balistreri \n                       Mews Apt. 293, Chandigarh.\n                    </td>\n                    <td>Jordan Price</td>\n                    <td>050-791-7903<br>\n                       rylan_champlin@gmail.com\n                    </td>\n                    <td>Corey Garrett</td>\n                    <td style=\"vertical-align:middle; \">\n                       <label class=\"marked\">  <input type=\"checkbox\" checked=\"checked\">\n                         <span class=\"checkmark\"></span>\n                       </label>\n                    </td>\n                 </tr>\n              </table>\n           </div>\n        </div>\n     </div>\n\n</div>\n"
...
module.exports = "<!-- <ngx-loading [show]=\"parameter.loading\"></ngx-loading> -->\n<div class=\"container-fluid\">\n  <div class=\"white-bg padding15\">\n     <div class=\"row\">\n      <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n         <div *ngIf=\"parameter.lead?.user\" class=\"profile\">\n            <div class=\"fig-block\">\n               <img [src]=\"parameter.lead.user.image\" onerror='src=\"http://via.placeholder.com/56x56\"' alt=\"img\">\n            </div>\n            <div class=\"profile-info\">\n               <h6>{{parameter.lead.user.name}}</h6>\n               <p>{{parameter.lead.user.phone}}</p>\n            </div>\n         </div>\n      </div>\n      <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div class=\"form-group d-flex marginT10 float-right right-side\">\n          <a class=\"btn btn-outline-primary\" href=\"javascript://\">Invoices</a> \n          <select class=\"form-control green-select marginL15\">\n             <option>Actions</option>\n             <option>Actions</option>\n             <option>Actions</option>\n          </select>\n        </div>\n      </div>\n     </div>\n  </div>\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div *ngIf=\"parameter.lead\" class=\"white-bg padding30\">\n           <div class=\"row\">\n              <div class=\"col-md-6\">\n                 <h6>Details</h6>\n              </div>\n              <div class=\"col-md-6\">\n                 <div class=\"edit text-right\"><a href=\"javascript://\">Edit</a></div>\n              </div>\n           </div>\n           <div class=\"details-table\">\n             <table class=\"table\">\n                <tbody><tr>\n                   <td style=\"padding-left:0\"><label>Full Name</label></td>\n                   <td>{{parameter.lead.name}}</td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Contact Number</label></td>\n                   <td>{{parameter.lead.phone}}</td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Email address</label></td>\n                   <td>{{parameter.lead.email}}</td>\n                </tr>\n                <tr *ngIf=\"parameter.lead?.configuration\">\n                   <td style=\"padding-left:0\"><label>Interested In</label></td>\n                   <td>\n                     <span *ngFor=\"let conf of parameter.lead.configuration\">\n                       {{conf.name}}\n                     </span>\n                   </td>\n                </tr>\n                <tr>\n                   <td style=\"padding-left:0\"><label>Favourite Projects</label></td>\n                   <td>80 <a class=\"view-all\" href=\"javascript://\">View All</a></td>\n                </tr>\n              </tbody>\n             </table>\n           </div>\n        </div>\n\n        <div class=\"spacer30\"></div>\n        <div *ngIf=\"parameter.lead?.user\">\n          <app-chat [lead_id]=\"parameter.lead_id\" [user_id]=\"parameter.user_id\" [admin_id]=\"parameter.admin_id\"></app-chat>\n        </div>\n\n     </div>\n     <div class=\"col-lg-6 col-md-12 col-sm-12 col-12\">\n        <div class=\"white-bg chat-with-developer padding15\">\n           <i class=\"float-left marginR15\"><img src=\"assets/img/chat-icon.png\" alt=\"img\"></i>\n           <a href=\"javascript://\">Chat with Developers <i class=\"fa fa-angle-right\"></i></a>\n        </div>\n        <div class=\"white-bg padding15\">\n           <p class=\"p16 marginB0\">Fill in Information</p>\n        </div>\n        <hr class=\"margin0\">\n        <div class=\"white-bg padding40\">\n           <div class=\"form-group-4\">\n              <label>Preferred</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio\">\n              <span class=\"checkmark\">Neighbourhood</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio\">\n              <span class=\"checkmark\">Building</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n           <div class=\"row\">\n              <div class=\"col-sm-6 col-12\">\n                 <div class=\"form-group-4\">\n                    <label>Family Size</label>\n                    <input class=\"form-control\" type=\"text\" name=\"\">\n                 </div>\n              </div>\n              <div class=\"col-sm-6 col-12\">\n                 <div class=\"form-group-4\">\n                    <label>Kids - Age group</label>\n                    <input class=\"form-control\" type=\"text\" name=\"\">\n                 </div>\n              </div>\n           </div>\n           <div class=\"inline-form-group-2 marginT20\">\n              <div class=\"row\">\n                 <div class=\"col-6\"><label class=\"float-left\">Pets</label></div>\n                 <div class=\"col-6\">\n                    <label class=\"cust-check-bx\">\n                    <input type=\"checkbox\">\n                    <span class=\"checkmark\"></span>\n                    </label>\n                 </div>\n              </div>\n           </div>\n           <div class=\"form-group-4 marginT20\">\n              <label>Close proximity needed to</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio1\">\n              <span class=\"checkmark\">Workplace</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">School</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">Gym</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio1\">\n              <span class=\"checkmark\">Temple</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n           <div class=\"form-group-4 date-picker\">\n              <label>How soon planning to buy/rent</label>\n              <input type=\"text\" class=\"form-control\" id=\"datetimepicker\" placeholder=\"Select Date\">\n              <span class=\"sel-date\">Select date</span>\n           </div>\n           <div class=\"form-group-4 marginT20\">\n              <label>Car Types</label>\n              <div class=\"clearfix\"></div>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" checked=\"checked\" name=\"radio2\">\n              <span class=\"checkmark\">Electric</span>\n              </label>\n              <label class=\"cust-radio\">\n              <input type=\"radio\" name=\"radio2\">\n              <span class=\"checkmark\">SUV</span>\n              </label>\n              <div class=\"clearfix\"></div>\n           </div>\n        </div>\n        <div class=\"spacer30\"></div>\n        <div class=\"white-bg padding15\">\n           <div class=\"row\">\n              <div class=\"col-6\">\n                 <p class=\"p16 marginB0\">Write a Note</p>\n              </div>\n              <div class=\"col-6 text-right\"><a class=\"add\" href=\"javascript://\">Add</a></div>\n           </div>\n        </div>\n        <hr class=\"margin0\">\n        <div class=\"write-note white-bg padding40\">\n           <div class=\"wn-block\">\n              <div class=\"circle\">\n                 <span></span>\n              </div>\n              <a class=\"delete\" href=\"javascript://\">Delete</a>\n              <p class=\"time\">07 Apr 2018 · 10:30AM</p>\n              <p class=\"p13\">Hey! I am interested in the  property you’ve listed. I was thinking of having a look at it..<a class=\"view-more\" href=\"javascript://\">view more</a></p>\n           </div>\n           <div class=\"wn-block\">\n              <div class=\"circle\">\n                 <span></span>\n              </div>\n              <a class=\"delete\" href=\"javascript://\">Delete</a>\n              <p class=\"time\">07 Apr 2018 · 10:30AM</p>\n              <p class=\"p13\">Hey! I am interested in the  property you’ve listed. I was thinking of having a look at it..<a class=\"view-more\" href=\"javascript://\">view more</a></p>\n           </div>\n        </div>\n     </div>\n  </div>\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-6\">\n        <p class=\"p16\">Interested Properties</p>\n     </div>\n   <div class=\"col-6\">\n        <div class=\"btn-cont text-right\"> <a routerLink=\"/dashboard/properties/add-property/0\" class=\"btn btn-fourth\" href=\"javascript://\">Add</a></div>\n     </div>\n  </div>\n  \n  <div class=\"spacer15\"></div>\n  <div class=\"row\" *ngIf=\"parameter.interested_properties?.length>0\">\n    <!-- <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\" *ngFor=\"let ip of parameter.interested_properties\"> -->\n    <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\" *ngFor=\"let ip of parameter.interested_properties\">\n      <app-interested-property [data]=\"ip\" [adminType]=\"4\"></app-interested-property>\n    </div>\n  </div>\n  <div *ngIf=\"parameter.interested_properties?.length == 0\">\n    <p class=\"show-error\">\n      {{constant.errorMsg.NO_INTERESTED_PROPERTY_FOUND}}\n    </p>\n  </div>\n\n  <div class=\"spacer30\"></div>\n  <div class=\"row\">\n     <div class=\"col-6\">\n        <p class=\"p16\">Viewed Projects or properties</p>\n     </div>\n     <div class=\"col-6\">\n        <a class=\"view-all-2 float-right\" href=\"javascript://\">View All</a>\n     </div>\n  </div>\n  <div class=\"spacer15\"></div>\n  <div class=\"row\">\n     <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg\">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a>\n           </div>\n        </div>\n     </div>\n     <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg \">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a>\n           </div>\n        </div>\n     </div>\n    <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"project-des-bx white-bg \">\n           <div class=\"price\">$26k+</div>\n           <div class=\"fig-block\">\n              <img src=\"http://via.placeholder.com/80x80\" alt=\"img\">\n           </div>\n           <div class=\"project-des-content\">\n              <small>SNN Builders</small>\n              <h5>Morning Homes</h5>\n              <p class=\"p12\">Kaveri Nagar, Murugeshpalya, Mumbai East.</p>\n              <p class=\"p13\">1 RK, 1, 2 BHK Apartments</p>\n              <!-- <a class=\"delete-2\" href=\"javascript://\"><img src=\"assets/img/delete-green.png\" alt=\"img\"></a> -->\n              <a class=\"btn btn-primary\" href=\"javascript://\" data-toggle=\"modal\" data-target=\"#dealFinalise\" #modalOpen>Add New</a>\n           </div>\n        </div>\n     </div>\n  </div>\n</div>\n"
...
var SERVER_URL = 'http://kanguroo.com.mx/api:8080';
var InhouseBrokerDetailComponent = /** @class */ (function () {
    function InhouseBrokerDetailComponent(router, route, admin, constant, dealFinalise) {
        var _this = this;
        this.router = router;
        this.route = route;
        this.admin = admin;
        this.constant = constant;
        this.dealFinalise = dealFinalise;
        this.parameter = {};
        this.admin.loginData$.subscribe(function (success) {
            _this.parameter.admin_id = success['id'];
            console.log('admin_id', _this.parameter.admin_id);
    ...
    InhouseBrokerDetailComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */], __WEBPACK_IMPORTED_MODULE_4__models_leads_model__["a" /* DealFinalize */]]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" ? _a : Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */]) === "function" ? _b : Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_admin_service__["a" /* AdminService */]) === "function" ? _c : Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__common_constants__["a" /* Constant */]) === "function" ? _d : Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__models_leads_model__["a" /* DealFinalize */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__models_leads_model__["a" /* DealFinalize */]) === "function" ? _e : Object])
...
module.exports = "\n<!-- <ngx-loading [show]=\"parameter.loading\"></ngx-loading> -->\n\n<div class=\"container-fluid\">\n  <div class=\"row\">\n      <div class=\"col-md-3\">\n        <a class=\"view-all-2\" href=\"javascript://\"><i class=\"fa fa-angle-left\"></i><span>View all</span></a>\n      </div>\n      <div class=\"col-md-9\">\n        <div class=\"cust-tabs-2\">\n            <ul class=\"nav nav-tabs\">\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==1}\" (click)=\"changeFlag(1)\" >This Week</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==2}\" (click)=\"changeFlag(2)\" >This Month</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==3}\" (click)=\"changeFlag(3)\" >Last Month</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==4}\" (click)=\"changeFlag(4)\" >Lifetime</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" [ngClass]=\"{'active':parameter.flag==5}\" (click)=\"changeFlag(5)\" >Custom</a>\n              </li>\n            </ul>\n        </div>\n      </div>\n      <div class=\"col-12\">\n        <hr style=\"margin-top:0;\">\n      </div>\n  </div>\n\n  <div class=\"sigle-row-table\">\n    <table class=\"table table-striped\">\n        <tr>\n          <td> <img class=\"rounded-circle\" src=\"./../../../assets/img/default_img.png\" alt=\"img\"></td>\n          <td class=\"text-left\">\n              <span class=\"name\">Lillian Russell</span>\n          </td>\n          <td class=\"text-left\">\n              728-111-1874\n          </td>\n          <td class=\"text-left\">\n              eunice_aufderhar@yahoo.com\n          </td>\n          <td>\n              14\n          </td>\n          <td>\n              <a href=\"javascript://\" class=\"icon-block edit-icon\"><img src=\"./../../../assets/img/edit.png\" alt=\"img\"></a>\n              <a href=\"javascript://\" class=\"icon-block block-icon\"><img src=\"./../../../assets/img/unblock.png\" alt=\"img\"></a>\n          </td>\n        </tr>\n    </table>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"info-box\">\n            <div class=\"one-row\">\n              <div class=\"o-block\">\n                  <h5>Buildings</h5>\n                  <small>Requests Pending</small>\n              </div>\n              <div class=\"o-block\">\n                  <a class=\"view-all\" href=\"javascript://\">View All</a>\n                  <h4>15</h4>\n              </div>\n            </div>\n            <div class=\"three-row\">\n              <div class=\"t-block\">\n                  <p><strong>3</strong></p>\n                  <p>Admin</p>\n              </div>\n              <div class=\"t-block\">\n                  <p><strong>6</strong></p>\n                  <p>CSR</p>\n              </div>\n              <div class=\"t-block\">\n                  <p><strong>5</strong></p>\n                  <p>User</p>\n              </div>\n            </div>\n        </div>\n      </div>\n    <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"four-block\">\n            <div class=\"d-flex\">\n              <div class=\"f-block approved\">\n                  <h5>Approved</h5>\n                  <h3>25</h3>\n              </div>\n              <div class=\"f-block unapproved\">\n                  <h5>Unapproved</h5>\n                  <h3>02</h3>\n              </div>\n            </div>\n            <div class=\"d-flex\">\n              <div class=\"f-block pending active\">\n                  <h5>Pending</h5>\n                  <h3>01</h3>\n              </div>\n              <div class=\"f-block unapproved\">\n                  <h5>In Draft</h5>\n                  <h3>02</h3>\n              </div>\n            </div>\n        </div>\n      </div>\n      <div class=\"col-lg-4 col-md-12 col-sm-12 col-12\">\n        <div class=\"chat-msg\">\n            <div class=\"row\">\n              <div class=\"col-6\">\n                  <h5>Chat</h5>\n              </div>\n              <div class=\"col-6 text-right\"><a class=\"msg\" href=\"javascript://\">Message</a></div>\n            </div>\n            <p>Waiting for response</p>\n            <p>\n              <strong>Mario Hudson</strong>\n              When you are free to have a meeting\n              with interested customers?\n            </p>\n            <p>\n              <strong>Rosie Benson</strong>\n              Is there any availability in the localities\n              I was asking you tomorrow and also p…\n            </p>\n        </div>\n      </div>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-12\">\n        <div class=\"spacer40\"></div>\n      </div>\n      <div class=\"col-12\">\n        <div class=\"title-group\">\n            <h5>All Leads</h5>\n            <p>Showing {{items?.length}} out of {{parameter.total}}</p>\n        </div>\n      </div>\n  </div>\n\n  <div class=\"white-bg\">\n      <div class=\"tabel-section\">\n        <div class=\"table-responsive\">\n            <table class=\"table table-striped table-align-left vertical-align-top\">\n              <tr>\n                  <th>\n                    <div class=\"table-search\">\n                        <!-- <label>Image</label> -->\n                    </div>\n                  </th>\n                  <th style=\"width:20%\">\n                    <div class=\"table-search\">\n                        <label>Name</label>\n                        <div class=\"searh-3\">\n                            <input type=\"text\" [(ngModel)]=\"parameter.name\" (keyup.enter)=\"changeFilter('name',$event.target.value)\" name=\"\">\n                            <button *ngIf=\"parameter.name\" (click)=\"changeFilter('name', parameter.name)\"><i class=\"fa fa-search\"></i></button>\n                        </div>\n                    </div>\n                  </th>\n                  <th style=\"width:20%; text-align:left;\">\n                    <div class=\"table-search\">\n                        <label>Contact Number</label>\n                        <div class=\"searh-3\">\n                            <input type=\"text\" [(ngModel)]=\"parameter.phone\" (keyup.enter)=\"changeFilter('phone',$event.target.value)\" name=\"\">\n                            <button *ngIf=\"parameter.phone\" (click)=\"changeFilter('phone', parameter.phone)\"><i class=\"fa fa-search\"></i></button>\n                        </div>\n                    </div>\n                  </th>\n                  <th style=\"width:20%\">\n                    <div class=\"table-search\">\n                        <label>Email</label>\n                        <div class=\"searh-3\">\n                            <input type=\"text\" [(ngModel)]=\"parameter.email\" (keyup.enter)=\"changeFilter('email',$event.target.value)\" name=\"\">\n                            <button *ngIf=\"parameter.email\" (click)=\"changeFilter('email', parameter.email)\"><i class=\"fa fa-search\"></i></button>\n                        </div>\n                    </div>\n                  </th>\n                  <th style=\"width:10%\">\n                    Interested In\n                  </th>\n                  <th>\n                    Assignee\n                  </th>\n                  <th >\n                    <!-- Mark\n                    Complete -->\n                  </th>\n              </tr>\n              <tr *ngFor=\"let item of items| paginate: { itemsPerPage: parameter.itemsPerPage, currentPage: parameter.p, totalItems: parameter.total }\">\n                <td>\n                  <img *ngIf=\"item.image\" class=\"rounded-circle\" [src]=\"item.image\" alt=\"img\">\n                  <img *ngIf=\"!item.image\" class=\"rounded-circle\" src=\"./../../../assets/img/default_img.png\" alt=\"img\">\n                </td>\n                <td class=\"text-left\">\n                  <span routerLink=\"/dashboard/leads/inhouse-broker/{{item.id}}\"  class=\"name\">{{item.name}}</span>\n                </td>\n                <td class=\"text-left\" *ngIf=\"item.phone\">{{item.country_code}}-{{item.phone}}</td>\n                <td class=\"text-left\" *ngIf=\"!item.phone\">NA</td>\n                <td class=\"text-left\">{{item.email}}</td>\n                <td>2 BHK</td>\n                <td class=\"text-left\" *ngIf=\"item?.admin?.name\">{{item.admin.name}}</td>\n                <td class=\"text-left\" *ngIf=\"!item?.admin?.name\">Not Assigned</td>\n                <td>\n                  <a href=\"javascript://\" routerLink=\"/dashboard/leads/inhouse-broker/{{item.id}}\" class=\"icon-block edit-icon\"><img src=\"assets/img/edit.png\" alt=\"img\"></a>\n                  <a href=\"javascript://\" *ngIf=\"item.is_blocked == 1\" (click)=\"blockUnblockPopup(i, item.id, 0, parameter.type)\" title=\"Unblock user\" class=\"icon-block block-icon unblock-bg\"><img src=\"assets/img/block.png\" alt=\"img\"></a>\n                  <a href=\"javascript://\" *ngIf=\"item.is_blocked == 0\" (click)=\"blockUnblockPopup(i, item.id, 1, parameter.type)\" title=\"Block user\" class=\"icon-block block-icon\"><img src=\"assets/img/unblock.png\" alt=\"img\"></a>\n                </td>\n              </tr>\n            </table>\n        </div>\n      </div>\n  </div>\n\n</div>\n"
...
var InhouseBrokerComponent = /** @class */ (function () {
    function InhouseBrokerComponent(admin, router, constant) {
        this.admin = admin;
        this.router = router;
        this.constant = constant;
        this.parameter = {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pipes_chat_time_pipe__ = __webpack_require__("../../../../../src/app/pipes/chat-time.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__leads_component__ = __webpack_require__("../../../../../src/app/layout/leads/leads.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__data_collector_data_collector_component__ = __webpack_require__("../../../../../src/app/layout/leads/data-collector/data-collector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__csr_seller_csr_seller_component__ = __webpack_require__("../../../../../src/app/layout/leads/csr-seller/csr-seller.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__csr_buyer_csr_buyer_component__ = __webpack_require__("../../../../../src/app/layout/leads/csr-buyer/csr-buyer.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__inhouse_broker_inhouse_broker_component__ = __webpack_require__("../../../../../src/app/layout/leads/inhouse-broker/inhouse-broker.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__csr_closer_csr_closer_component__ = __webpack_require__("../../../../../src/app/layout/leads/csr-closer/csr-closer.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__csr_buyer_csr_buyer_detail_csr_buyer_detail_component__ = __webpack_require__("../../../../../src/app/layout/leads/csr-buyer/csr-buyer-detail/csr-buyer-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__inhouse_broker_inhouse_broker_detail_inhouse_broker_detail_component__ = __webpack_require__("../../../../../src/app/layout/leads/inhouse-broker/inhouse-broker-detail/inhouse-broker-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__csr_closer_csr_closer_detail_csr_closer_detail_component__ = __webpack_require__("../../../../../src/app/layout/leads/csr-closer/csr-closer-detail/csr-closer-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__common_blocks_chat_chat_component__ = __webpack_require__("../../../../../src/app/layout/common-blocks/chat/chat.component.ts");
...
var routes = [
    { path: 'data-collectors', component: __WEBPACK_IMPORTED_MODULE_10__data_collector_data_collector_component__["a" /* DataCollectorComponent */] },
    { path: 'csr-sellers', component: __WEBPACK_IMPORTED_MODULE_11__csr_seller_csr_seller_component__["a" /* CsrSellerComponent */] },
    { path: 'csr-buyers', component: __WEBPACK_IMPORTED_MODULE_12__csr_buyer_csr_buyer_component__["a" /* CsrBuyerComponent */] },
    { path: 'csr-buyers/:id', component: __WEBPACK_IMPORTED_MODULE_15__csr_buyer_csr_buyer_detail_csr_buyer_detail_component__["a" /* CsrBuyerDetailComponent */] },
    { path: 'inhouse-broker', component: __WEBPACK_IMPORTED_MODULE_13__inhouse_broker_inhouse_broker_component__["a" /* InhouseBrokerComponent */] },
    { path: 'inhouse-broker/:id', component: __WEBPACK_IMPORTED_MODULE_16__inhouse_broker_inhouse_broker_detail_inhouse_broker_detail_component__["a" /* InhouseBrokerDetailComponent */] },
    { path: 'csr-closers', component: __WEBPACK_IMPORTED_MODULE_14__csr_closer_csr_closer_component__["a" /* CsrCloserComponent */] },
    { path: 'csr-closers/:id', component: __WEBPACK_IMPORTED_MODULE_17__csr_closer_csr_closer_detail_csr_closer_detail_component__["a" /* CsrCloserDetailComponent */] }
];
var LeadsModule = /** @class */ (function () {
    ...
    LeadsModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_9__leads_component__["a" /* LeadsComponent */],
                __WEBPACK_IMPORTED_MODULE_10__data_collector_data_collector_component__["a" /* DataCollectorComponent */],
                __WEBPACK_IMPORTED_MODULE_11__csr_seller_csr_seller_component__["a" /* CsrSellerComponent */],
                __WEBPACK_IMPORTED_MODULE_12__csr_buyer_csr_buyer_component__["a" /* CsrBuyerComponent */],
                __WEBPACK_IMPORTED_MODULE_13__inhouse_broker_inhouse_broker_component__["a" /* InhouseBrokerComponent */],
                __WEBPACK_IMPORTED_MODULE_14__csr_closer_csr_closer_component__["a" /* CsrCloserComponent */],
                __WEBPACK_IMPORTED_MODULE_15__csr_buyer_csr_buyer_detail_csr_buyer_detail_component__["a" /* CsrBuyerDetailComponent */],
                __WEBPACK_IMPORTED_MODULE_16__inhouse_broker_inhouse_broker_detail_inhouse_broker_detail_component__["a" /* InhouseBrokerDetailComponent */],
                __WEBPACK_IMPORTED_MODULE_17__csr_closer_csr_closer_detail_csr_closer_detail_component__["a" /* CsrCloserDetailComponent */],
                __WEBPACK_IMPORTED_MODULE_18__common_blocks_chat_chat_component__["a" /* ChatComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_8__pipes_chat_time_pipe__["a" /* ChatTimePipe */]
            ]
        })
    ], LeadsModule);
    return LeadsModule;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DealFinalize; });
...
var ChatTimePipe = /** @class */ (function () {
    ...
    ChatTimePipe.prototype.transform = function (created_at) {
        return __WEBPACK_IMPORTED_MODULE_1_moment__(created_at, 'YYYY-MM-DD H:m:s').utc(true).local().fromNow();
    };
