...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_bank_model__ = __webpack_require__("../../../../../src/app/models/bank.model.ts");
...
var BanksComponent = /** @class */ (function () {
    function BanksComponent(constant, model, element, route, admin, router, sanitization) {
    ...
    BanksComponent.prototype.getBuyers = function (type, page, name, phone, email) {
        var _this = this;
        this.parameter.p = page;
    ...
    BanksComponent.prototype.addNewUser = function (formdata) {
        var _this = this;
        // this.parameter.loading = true;
