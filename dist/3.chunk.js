...
var BankComponent = /** @class */ (function () {
    ...
    BankComponent.prototype.ngOnInit = function () {
        var date = new Date();
        this.parameter.min = __WEBPACK_IMPORTED_MODULE_2_moment__(date.getFullYear() + '-' + '01' + '-' + '01').format('YYYY-MM-DD');
