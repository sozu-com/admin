...
var NotaryComponent = /** @class */ (function () {
    function NotaryComponent(constant, model, element, route, admin, router, sanitization) {
...
var routes = [
    ...
    { path: 'notary-leads/notary-lead-details', component: __WEBPACK_IMPORTED_MODULE_9__notary_leads_notary_leads_details_notary_leads_details_component__["a" /* NotaryLeadsDetailsComponent */] },
];
