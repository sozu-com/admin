...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(constant, model, admin, spinner, translate) {
...
var routes = [
    {
        ...
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['User Management', 'can_read', ''] }
    }
];
