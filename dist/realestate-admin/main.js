...
var InhouseUsersComponent = /** @class */ (function () {
    ...
    InhouseUsersComponent.prototype.placeMarker = function ($event, paramLat, paramLng) {
    ...
    InhouseUsersComponent.prototype.getGeoLocation = function (lat, lng) {
        var _this = this;
        if (navigator.geolocation) {
            ...
            geocoder.geocode(request, function (results, status) {
                if (status === google.maps.GeocoderStatus.OK) {
                    ...
                    if (result != null) {
                        _this.model.adr = result.formatted_address;
                    }
                    else {
                        _this.model.adr = lat + ',' + lng;
                    }
                }
            });
        }
