...
var map = {
	...
	"./collections/collections.module": [
		...
		"collections-collections-module~projects-projects-module~properties-properties-module",
		"common",
		"collections-collections-module"
	],
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot(appRoutes, { preloadingStrategy: _angular_router__WEBPACK_IMPORTED_MODULE_4__["PreloadAllModules"] }),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_common_fileUpload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/common/fileUpload */ "./src/app/common/fileUpload.ts");
/* harmony import */ var src_app_models_agency_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/models/agency.model */ "./src/app/models/agency.model.ts");
/* harmony import */ var src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/common/constants */ "./src/app/common/constants.ts");
/* harmony import */ var src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/models/inhouse-users.model */ "./src/app/models/inhouse-users.model.ts");
/* harmony import */ var src_app_services_common_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/common.service */ "./src/app/services/common.service.ts");
...
var InhouseUsersComponent = /** @class */ (function () {
    function InhouseUsersComponent(constant, cs, model, route, spinner, admin, router, ngZone, translate) {
        var _this = this;
        this.constant = constant;
        this.cs = cs;
        this.model = model;
    ...
    InhouseUsersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.file1 = new src_app_common_fileUpload__WEBPACK_IMPORTED_MODULE_1__["FileUpload"](false, this.admin);
        this.model.country_code = this.constant.country_code;
        this.model.dial_code = this.constant.dial_code;
        this.model.agency = new src_app_models_agency_model__WEBPACK_IMPORTED_MODULE_2__["Agency"]();
        this.parameter.itemsPerPage = this.constant.itemsPerPage;
    ...
    InhouseUsersComponent.prototype.emptyModel = function () {
        this.model.country_code = this.constant.country_code;
        this.model.dial_code = this.constant.dial_code;
        this.model = new src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__["UserModel"]();
    ...
    InhouseUsersComponent.prototype.editUser = function (userdata, index) {
        ...
        this.admin.postDataApi('getNewUserById', { id: userdata.id }).subscribe(function (r) {
            ...
            _this.model.agency = userdata.agency ? userdata.agency : new src_app_models_agency_model__WEBPACK_IMPORTED_MODULE_2__["Agency"]();
    ...
    InhouseUsersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"], src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__["User"], src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__["Address"], src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__["UserModel"]]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"], src_app_services_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"],
            src_app_models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_4__["UserModel"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_8__["NgxSpinnerService"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_7__["AdminService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"],
...
/* harmony import */ var _inhouse_users_address_address_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./inhouse-users/address/address.component */ "./src/app/layout/inhouse-users/address/address.component.ts");
...
/* harmony import */ var _generate_thumb_generate_thumb_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./generate-thumb/generate-thumb.component */ "./src/app/layout/generate-thumb/generate-thumb.component.ts");
/* harmony import */ var _directives_acl_permission_directive__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../directives/acl-permission.directive */ "./src/app/directives/acl-permission.directive.ts");
/* harmony import */ var _guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../guards/acl-user.guard */ "./src/app/guards/acl-user.guard.ts");
/* harmony import */ var _fire_base_messaging_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../fire-base/messaging.service */ "./src/app/fire-base/messaging.service.ts");
/* harmony import */ var _modules_shared_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../modules/shared.module */ "./src/app/modules/shared.module.ts");
/* harmony import */ var _img360viewer_img360viewer_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./img360viewer/img360viewer.component */ "./src/app/layout/img360viewer/img360viewer.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    LayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _modules_shared_module__WEBPACK_IMPORTED_MODULE_29__["SharedModule"],
            ...
            declarations: [
                ...
                _inhouse_users_address_address_component__WEBPACK_IMPORTED_MODULE_23__["AddressComponent"],
                _generate_thumb_generate_thumb_component__WEBPACK_IMPORTED_MODULE_25__["GenerateThumbComponent"],
                _directives_acl_permission_directive__WEBPACK_IMPORTED_MODULE_26__["AclPermissionDirective"],
                _img360viewer_img360viewer_component__WEBPACK_IMPORTED_MODULE_30__["Img360viewerComponent"]
            ],
            providers: [_fire_base_messaging_service__WEBPACK_IMPORTED_MODULE_28__["MessagingService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_24__["AuthGuard"], _guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_27__["AclUserGuard"]],
        ...
        this.admin.adminLogin(email.toLowerCase(), password)
            ...
            if (success.data.permissions) {
                if (success.data.permissions.can_csr_buyer === 1) {
                    ...
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default()(_this.translate.instant('swal.error'), _this.translate.instant('login.apiMessages.noAccess'), 'error');
                }
            }
