...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, location, interceptor) {
        var _this = this;
        this.router = router;
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["PlatformLocation"], _services_http_interceptor__WEBPACK_IMPORTED_MODULE_2__["HttpInterceptor"]])
    ], AppComponent);
    return AppComponent;
}());
...
var ForgotPasswordComponent = /** @class */ (function () {
    ...
    ForgotPasswordComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"]])
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_models_chat_model__WEBPACK_IMPORTED_MODULE_4__["Chat"]]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"],
            ...
            _models_chat_model__WEBPACK_IMPORTED_MODULE_4__["Chat"],
...
var NotesComponent = /** @class */ (function () {
    ...
    NotesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_models_leads_model__WEBPACK_IMPORTED_MODULE_2__["Notes"]]
        }),
        __metadata("design:paramtypes", [_services_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"], _models_leads_model__WEBPACK_IMPORTED_MODULE_2__["Notes"], _common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"]])
    ], NotesComponent);
...
var InhouseUsersComponent = /** @class */ (function () {
    function InhouseUsersComponent(constant, cs, model, route, admin, router, mapsAPILoader, ngZone, sanitization) {
        var _this = this;
        this.constant = constant;
        this.cs = cs;
        this.model = model;
    ...
    InhouseUsersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.file1 = new src_app_common_fileUpload__WEBPACK_IMPORTED_MODULE_8__["FileUpload"](false, this.admin);
    ...
    InhouseUsersComponent.prototype.onSelectFile1 = function (event, paramUrl, paramFile) {
        var _this = this;
        if (event.target.files && event.target.files[0]) {
            var reader = new FileReader();
            // this.parameter.image = event.target.files[0];
            reader.onload = function (e) {
                _this[paramUrl] = e.target.result;
                _this[paramFile] = _this.sanitization.bypassSecurityTrustStyle("url(" + _this[paramUrl] + ")");
                _this.cs.saveImage(event.target.files[0]).subscribe(function (success) {
    ...
    InhouseUsersComponent.prototype.editUser = function (userdata, index) {
        ...
        this.admin.postDataApi('getNewUserById', { id: userdata.id }).subscribe(function (r) {
            ...
            _this.model.company_name = userdata.company_name;
            ...
            if (userdata.branches && userdata.branches.length > 0) {
                _this.model.branch_office = userdata.branches[0].address;
                _this.model.branch_lat = userdata.branches[0].lat;
                _this.model.branch_lng = userdata.branches[0].lng;
            }
            _this.model.image = userdata.image != null ? userdata.image : '';
            if (_this.model.image) {
                _this.image = _this.sanitization.bypassSecurityTrustStyle("url(" + _this.model.image + ")");
            }
            _this.model.company_logo = userdata.company_logo != null ? userdata.company_logo : '';
            if (_this.model.company_logo) {
                _this.company_logo = _this.sanitization.bypassSecurityTrustStyle("url(" + _this.model.company_logo + ")");
            }
        ...
        if (navigator.geolocation) {
            ...
            geocoder.geocode(request, function (results, status) {
                if (status === google.maps.GeocoderStatus.OK) {
                    ...
                    console.log('1', _this.model[param]);
                }
            });
        }
    };
    ...
    InhouseUsersComponent.prototype.saveImages = function () {
        ...
        this.file1.upload().then(function (r) {
            _this.model.company_images = _this.file1.files;
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('mapDiv'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], InhouseUsersComponent.prototype, "mapDiv", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('search2'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], InhouseUsersComponent.prototype, "search1ElementRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('modalOpen'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ...
    InhouseUsersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_common_constants__WEBPACK_IMPORTED_MODULE_4__["Constant"], _models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_3__["User"], _models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_3__["Address"], _models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_3__["UserModel"]]
        }),
        __metadata("design:paramtypes", [_common_constants__WEBPACK_IMPORTED_MODULE_4__["Constant"], _services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"],
            _models_inhouse_users_model__WEBPACK_IMPORTED_MODULE_3__["UserModel"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _services_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                ngx_loading__WEBPACK_IMPORTED_MODULE_14__["NgxLoadingModule"].forRoot({
                    animationType: ngx_loading__WEBPACK_IMPORTED_MODULE_14__["ngxLoadingAnimationTypes"].rectangleBounce,
                    primaryColour: '#00B96F'
                }),
...
/* harmony import */ var _layout_common_blocks_chat_chat_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../layout/common-blocks/chat/chat.component */ "./src/app/layout/common-blocks/chat/chat.component.ts");
...
/* harmony import */ var _layout_common_blocks_notes_notes_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../layout/common-blocks/notes/notes.component */ "./src/app/layout/common-blocks/notes/notes.component.ts");
/* harmony import */ var _pipes_moment_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pipes/moment.pipe */ "./src/app/pipes/moment.pipe.ts");
...
/* harmony import */ var _pipes_thousand_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../pipes/thousand.pipe */ "./src/app/pipes/thousand.pipe.ts");
/* harmony import */ var _layout_common_blocks_block_get_property_block_get_property_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../layout/common-blocks/block-get-property/block-get-property.component */ "./src/app/layout/common-blocks/block-get-property/block-get-property.component.ts");
...
/* harmony import */ var _pipes_number_with_commas_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../pipes/number-with-commas.pipe */ "./src/app/pipes/number-with-commas.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _layout_common_blocks_chat_chat_component__WEBPACK_IMPORTED_MODULE_3__["ChatComponent"],
                _pipes_chat_time_pipe__WEBPACK_IMPORTED_MODULE_4__["ChatTimePipe"],
                _layout_common_blocks_notes_notes_component__WEBPACK_IMPORTED_MODULE_5__["NotesComponent"],
                _pipes_moment_pipe__WEBPACK_IMPORTED_MODULE_6__["MomentPipe"],
                _pipes_thousand_pipe__WEBPACK_IMPORTED_MODULE_8__["ThousandPipe"],
                _pipes_img_pipe__WEBPACK_IMPORTED_MODULE_11__["ImgPipe"],
                _layout_common_blocks_block_get_property_block_get_property_component__WEBPACK_IMPORTED_MODULE_9__["BlockGetPropertyComponent"],
                _pipes_number_with_commas_pipe__WEBPACK_IMPORTED_MODULE_12__["NumberWithCommasPipe"]
            ],
            exports: [
                _layout_common_blocks_chat_chat_component__WEBPACK_IMPORTED_MODULE_3__["ChatComponent"],
                _pipes_chat_time_pipe__WEBPACK_IMPORTED_MODULE_4__["ChatTimePipe"],
...
var AdminService = /** @class */ (function () {
    ...
    AdminService.prototype.getDetails = function () {
        ...
        return this.http.post(this.baseUrl + 'get-details', {}, { headers: headers })
            ...
            return rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"].of(true);
        })
            .catch(this.errorHandler);
    };
