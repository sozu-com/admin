...
var AddProjectComponent = /** @class */ (function () {
    ...
    AddProjectComponent.prototype.saveTowerAmenityImages = function () {
        ...
        if (this.file2.files.length > 6) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.chooseMax6Images'), 'error');
            return false;
        }
        if (this.amen360Img.files.length > 6) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.chooseMax6360Images'), 'error');
            return false;
        }
        if (this.amenVideo.files.length > 6) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.chooseMax6Videos'), 'error');
            return false;
        }
        this.file2.upload().then(function (r) {
    ...
    AddProjectComponent.prototype.addProject = function () {
        ...
        if (modelSave.possession_status_id &&
            ...
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseSelectLaunchDate'), 'error');
            return false;
        }
        if (modelSave.images) {
        ...
        if (modelSave.dev_email) {
            if (!modelSave.dev_name) {
                swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddDeveloperName'), 'error');
                return false;
            }
            if (!modelSave.dev_countrycode) {
                swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddDeveloperCountryCode'), 'error');
                return false;
            }
            if (!modelSave.dev_email) {
                swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddDeveloperEmail'), 'error');
                return false;
            }
            if (!modelSave.dev_phone) {
                swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddDeveloperPhone'), 'error');
                return false;
            }
            if (!modelSave.dev_logo) {
                swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddDeveloperImage'), 'error');
                return false;
            }
        }
    ...
    AddProjectComponent.prototype.addNewCustom = function () {
        if (!this.new_custom.name || !this.new_custom.value) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseAddParameterNameandValue'), 'error');
            return false;
        }
    ...
    AddProjectComponent.prototype.addNewTower = function () {
        ...
        if (!this.newTower.tower_name) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseEnterTowerName'), 'error');
            return false;
        }
        if (!this.newTower.num_of_floors && this.newTower.num_of_floors !== 0) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseEnterNumberoffloors'), 'error');
            return false;
        }
        if (!this.newTower.possession_status_id) {
            swal(this.translate.instant('swal.error'), this.translate.instant('message.info.pleaseChoosePossessionStatus'), 'error');
            return false;
        }
    ...
    AddProjectComponent.prototype.selectManagedBy = function (name, type, managedBy) {
        ...
        if (managedBy === 1) {
            if (this.model.company && this.model.company.id) {
                swal(this.translate.instant('message.info.companyIsLinkedtothisproject'), this.translate.instant('message.info.pleaseRemoveCompanytoLinkManager'), 'error');
            }
        }
        if (managedBy === 2) {
            if (this.model.manager && this.model.manager.id) {
                swal(this.translate.instant('message.info.managerIsLinkedToThisProject'), this.translate.instant('message.info.pleaseRemoveManagertoLinkCompany'), 'error');
            }
        }
        this.spinner.show();
...
var ProjectsComponent = /** @class */ (function () {
    function ProjectsComponent(constant, apiConstant, route, admin, projectService, spinner, translate) {
        this.constant = constant;
...
var routes = [
    {
        ...
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Building Management', 'can_read', 'can_data_collector'] }
    },
    {
    ...
    },
    {
        ...
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Building Management', 'can_create', 'can_data_collector'] }
    },
    {
        path: 'edit-project/:id', component: _add_project_add_project_component__WEBPACK_IMPORTED_MODULE_12__["AddProjectComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Building Management', 'can_update', 'can_data_collector'] }
    },
    {
