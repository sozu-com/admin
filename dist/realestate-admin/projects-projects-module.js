...
/* harmony import */ var _common_videoUpload__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../../common/videoUpload */ "./src/app/common/videoUpload.ts");
...
var AddProjectComponent = /** @class */ (function () {
    function AddProjectComponent(model, admin, route, router, mapsAPILoader, ngZone, constant, apiConstants, cs, element) {
        this.model = model;
        this.admin = admin;
        this.route = route;
        this.router = router;
    ...
    AddProjectComponent.prototype.ngOnInit = function () {
        ...
        this.amen360Img = new _common_fileUpload__WEBPACK_IMPORTED_MODULE_7__["FileUpload"](false, this.admin);
        this.amenVideo = new _common_videoUpload__WEBPACK_IMPORTED_MODULE_8__["VideoUpload"](false, this.admin);
        this.config360Img = new _common_fileUpload__WEBPACK_IMPORTED_MODULE_7__["FileUpload"](false, this.admin);
        this.configVideo = new _common_fileUpload__WEBPACK_IMPORTED_MODULE_7__["FileUpload"](false, this.admin);
        this.route.params.subscribe(function (params) {
            ...
            console.log(_this.amenVideo.files, 'this.amenVideo.files');
        });
        this.zoom = 4;
    ...
    AddProjectComponent.prototype.saveTowerAmenityImages = function () {
        ...
        this.amenVideo.upload().then(function (r) {
            console.log(_this.amenVideo.files, 'amen video');
            _this.allTowerAmenities[_this.amenity_index].videos = _this.amenVideo.files;
            console.log(_this.allTowerAmenities[_this.amenity_index], 'alltowerrrrrrrrr');
        });
        // this.modalAmenClose.nativeElement.click();
        this.file2.files.forEach(function (element) {
            if (element.loading !== true) {
        ...
        this.allAmenvideos.forEach(function (ele, index) {
            return new Promise(function (resolve, reject) {
                _this.cs.saveVideo(ele.videoFile, ele.fileToUpload).subscribe(function (success) {
                    console.log(_this.model.amenvideos, ' this.model.amenvideos');
