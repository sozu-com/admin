...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9ub3Rhcnkvbm90YXJ5LWxlYWRzL25vdGFyeS1sZWFkcy1kZXRhaWxzL25vdGFyeS1sZWFkcy1kZXRhaWxzLmNvbXBvbmVudC5jc3MifQ== */"
...
var NotaryLeadsDetailsComponent = /** @class */ (function () {
    function NotaryLeadsDetailsComponent(route, router, admin, cs, constant, selectedProperties, model, scheduleMeeting, spinner, translate) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.admin = admin;
    ...
    NotaryLeadsDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_3__["SelectedProperties"], src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_3__["BankAssigned"], src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_3__["NotaryAssigned"], src_app_models_chat_model__WEBPACK_IMPORTED_MODULE_4__["Chat"], src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_3__["ScheduleMeeting"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            ...
            src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_3__["ScheduleMeeting"],
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9ub3Rhcnkvbm90YXJ5LWxlYWRzL25vdGFyeS1sZWFkcy5jb21wb25lbnQuY3NzIn0= */"
...
var NotaryLeadsComponent = /** @class */ (function () {
    function NotaryLeadsComponent(admin, leadsService, constant, availability, route, spinner, translate) {
        this.admin = admin;
    ...
    NotaryLeadsComponent.prototype.closeModal = function () {
        this.modalClose.nativeElement.click();
        this.availability = new src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_4__["AddNotaryAvailabilty"]();
    };
    NotaryLeadsComponent.prototype.add = function () {
        ...
        this.admin.postDataApi('leads/addNoataryAvailability', this.availability)
            ...
            _this.spinner.hide();
            _this.closeModal();
            swal(_this.translate.instant('swal.success'), _this.translate.instant('message.success.availabilityAddedSuccessfully'), 'success');
        }, function (error) {
            _this.spinner.hide();
        });
    };
    ...
    NotaryLeadsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_4__["AddNotaryAvailabilty"], src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_4__["NotaryLeads"]]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_5__["AdminService"],
            ...
            src_app_models_leads_model__WEBPACK_IMPORTED_MODULE_4__["AddNotaryAvailabilty"],
...
module.exports = ".add-img{\n    background-size: cover;background-repeat: no-repeat;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_models_users_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/models/users.model */ "./src/app/models/users.model.ts");
...
var NotaryComponent = /** @class */ (function () {
    function NotaryComponent(constant, spinner, admin, cs, translate) {
        this.constant = constant;
        this.spinner = spinner;
        this.admin = admin;
        this.cs = cs;
    ...
    NotaryComponent.prototype.ngOnInit = function () {
        this.model = new src_app_models_users_model__WEBPACK_IMPORTED_MODULE_1__["Users"]();
    ...
    NotaryComponent.prototype.telInputObject = function (obj) {
        this.obj = obj;
    };
    ...
    NotaryComponent.prototype.setLeadSort = function () {
        this.parameter.lead_sort = this.parameter.lead_sort === 2 ? 1 : 2;
        this.getNoatariesListing(this.parameter.page, this.parameter.company_name, this.parameter.name, this.parameter.phone, this.parameter.email);
    };
    NotaryComponent.prototype.changeListner = function (event, paramLoader, param) {
        var _this = this;
    ...
    NotaryComponent.prototype.importNoatary = function () {
        ...
        if (file.files && file.files[0]) {
            ...
            this.admin.postDataApi('importNoatary', input)
                ...
                _this.label = _this.translate.instant('table.title.chooseNotariesFile');
    ...
    NotaryComponent.prototype.addNewUser = function (formData) {
        ...
        this.admin.postDataApi('addNoatary', this.model)
            ...
            _this.model = new src_app_models_users_model__WEBPACK_IMPORTED_MODULE_1__["Users"]();
            formData.reset();
        }, function (error) {
            _this.spinner.hide();
        });
    ...
    NotaryComponent.prototype.blockUnblockPopup = function (index, id, flag) {
        ...
        switch (flag) {
            case 0:
                this.parameter.text = this.translate.instant('message.error.wantToUnblockNotary');
                this.parameter.successText = this.translate.instant('message.success.unblockedSuccessfully');
                break;
            case 1:
                this.parameter.text = this.translate.instant('message.error.wantToBlockNotary');
    ...
    NotaryComponent.prototype.deletePopup = function (item, index) {
        var _this = this;
        this.parameter.title = this.translate.instant('message.error.areYouSure');
        this.parameter.text = this.translate.instant('message.error.wantToDeleteNotary');
        swal({
            html: this.parameter.title + '<br>' + this.parameter.text,
            type: 'warning',
            showCancelButton: true,
...
/* harmony import */ var _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./notary-leads/notary-leads.component */ "./src/app/layout/notary/notary-leads/notary-leads.component.ts");
/* harmony import */ var _notary_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./notary.component */ "./src/app/layout/notary/notary.component.ts");
/* harmony import */ var _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./notary-leads/notary-leads-details/notary-leads-details.component */ "./src/app/layout/notary/notary-leads/notary-leads-details/notary-leads-details.component.ts");
...
/* harmony import */ var _modules_shared_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../modules/shared.module */ "./src/app/modules/shared.module.ts");
...
var routes = [
    {
        path: 'view-notary', component: _notary_component__WEBPACK_IMPORTED_MODULE_11__["NotaryComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Notaries Management', 'can_read', 'can_noatary'] }
    },
    // all leads
    {
        path: 'notary-leads', component: _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_10__["NotaryLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] }
    },
    // leads wrt particular notary
    {
        path: 'view-notary-leads/:id', component: _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_10__["NotaryLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] }
    },
    // details
    {
        path: 'notary-leads/:id', component: _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_12__["NotaryLeadsDetailsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_13__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] }
    }
];
var NotaryModule = /** @class */ (function () {
    ...
    NotaryModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _notary_component__WEBPACK_IMPORTED_MODULE_11__["NotaryComponent"],
                _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_10__["NotaryLeadsComponent"],
                _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_12__["NotaryLeadsDetailsComponent"]
            ]
        })
    ], NotaryModule);
    return NotaryModule;
