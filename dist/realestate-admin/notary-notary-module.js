...
var NotaryLeadsDetailsComponent = /** @class */ (function () {
    function NotaryLeadsDetailsComponent(route, router, admin, cs, constant, selectedProperties, model, scheduleMeeting, spinner) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.admin = admin;
...
var NotaryLeadsComponent = /** @class */ (function () {
    function NotaryLeadsComponent(admin, constant, availability, route, spinner) {
        this.admin = admin;
        this.constant = constant;
...
var NotaryComponent = /** @class */ (function () {
    function NotaryComponent(constant, spinner, admin, cs) {
        this.constant = constant;
        this.spinner = spinner;
        this.admin = admin;
        this.cs = cs;
...
/* harmony import */ var _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./notary-leads/notary-leads.component */ "./src/app/layout/notary/notary-leads/notary-leads.component.ts");
/* harmony import */ var _notary_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./notary.component */ "./src/app/layout/notary/notary.component.ts");
/* harmony import */ var _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./notary-leads/notary-leads-details/notary-leads-details.component */ "./src/app/layout/notary/notary-leads/notary-leads-details/notary-leads-details.component.ts");
...
var routes = [
    { path: 'view-notary', component: _notary_component__WEBPACK_IMPORTED_MODULE_9__["NotaryComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_11__["AclUserGuard"]], data: { roles: ['Notaries Management', 'can_read', 'can_noatary'] } },
    // all leads
    { path: 'notary-leads', component: _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_8__["NotaryLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_11__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] } },
    // leads wrt particular notary
    { path: 'view-notary-leads/:id', component: _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_8__["NotaryLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_11__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] } },
    // details
    { path: 'notary-leads/:id', component: _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_10__["NotaryLeadsDetailsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_11__["AclUserGuard"]], data: { roles: ['Notary Lead Management', 'can_read', 'can_noatary'] } }
];
var NotaryModule = /** @class */ (function () {
    ...
    NotaryModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _notary_component__WEBPACK_IMPORTED_MODULE_9__["NotaryComponent"],
                _notary_leads_notary_leads_component__WEBPACK_IMPORTED_MODULE_8__["NotaryLeadsComponent"],
                _notary_leads_notary_leads_details_notary_leads_details_component__WEBPACK_IMPORTED_MODULE_10__["NotaryLeadsDetailsComponent"]
            ]
        })
    ], NotaryModule);
    return NotaryModule;
