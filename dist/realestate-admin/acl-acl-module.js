...
var AclComponent = /** @class */ (function () {
    function AclComponent(constant, admin, cs, sanitization, router, spinner, location) {
...
/* harmony import */ var _acl_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./acl.component */ "./src/app/layout/acl/acl.component.ts");
/* harmony import */ var _add_acl_add_acl_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./add-acl/add-acl.component */ "./src/app/layout/acl/add-acl/add-acl.component.ts");
...
var routes = [
    ...
    { path: '', component: _acl_component__WEBPACK_IMPORTED_MODULE_8__["AclComponent"], canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Access Controls', 'can_read', ''] } },
    { path: 'add-acl-user/:id', component: _add_acl_add_acl_component__WEBPACK_IMPORTED_MODULE_9__["AddAclComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Access Controls', 'can_create', ''] } }
];
var AclModule = /** @class */ (function () {
    ...
    AclModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _acl_component__WEBPACK_IMPORTED_MODULE_8__["AclComponent"],
                _add_acl_add_acl_component__WEBPACK_IMPORTED_MODULE_9__["AddAclComponent"]
            ]
        })
    ], AclModule);
    return AclModule;
...
var AddAclComponent = /** @class */ (function () {
    function AddAclComponent(constant, cs, admin, route, spinner, router) {
        var _this = this;
        this.constant = constant;
        this.cs = cs;
        this.admin = admin;
        ...
        this.admin.postDataApi('addAclUser', this.model)
            ...
            if (success.success === '0') {
                ...
                if (_this.model.id === '') {
                    ...
                    console.log(_this.parameter.admin_id, _this.model.id);
