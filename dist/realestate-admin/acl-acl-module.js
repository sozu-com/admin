...
var routes = [
    ...
    { path: '', component: _acl_component__WEBPACK_IMPORTED_MODULE_8__["AclComponent"], canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Access Controls', 'can_read', ''] } },
    {
        path: 'add-acl-user/:id', component: _add_acl_add_acl_component__WEBPACK_IMPORTED_MODULE_9__["AddAclComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Access Controls', 'can_create', ''] }
    }
];
...
var AddAclComponent = /** @class */ (function () {
    function AddAclComponent(constant, cs, admin, route, spinner, router, translate) {
        var _this = this;
        this.constant = constant;
        this.cs = cs;
        this.admin = admin;
