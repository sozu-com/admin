...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9tYW5hZ2Vycy9tYW5hZ2Vycy5jb21wb25lbnQuY3NzIn0= */"
...
/* harmony import */ var src_app_models_company_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/models/company.model */ "./src/app/models/company.model.ts");
...
var ManagersComponent = /** @class */ (function () {
    function ManagersComponent(constant, cs, route, admin, spinner, ngZone, translate, mapsAPILoader, router) {
        var _this = this;
    ...
    ManagersComponent.prototype.ngOnInit = function () {
        ...
        this.file1 = new src_app_common_fileUpload__WEBPACK_IMPORTED_MODULE_3__["FileUpload"](false, this.admin);
        this.model = new src_app_models_company_model__WEBPACK_IMPORTED_MODULE_4__["Manager"]();
        this.model.is_company = 'true';
        this.model.project_sort = 2;
        this.model.country_code = this.constant.country_code;
        this.model.dial_code = this.constant.dial_code;
        this.model.company = new src_app_models_company_model__WEBPACK_IMPORTED_MODULE_4__["Company"]();
        this.parameter.itemsPerPage = this.constant.itemsPerPage;
        this.setCurrentPosition();
        // this.setCurrentPosition();
        this.parameter.sub = this.route.params.subscribe(function (params) {
            if (params.type == 'manager') {
                _this.parameter.name = params.name;
            }
            else if (params.type == 'company') {
                _this.parameter.company_name = params.name;
            }
    ...
    ManagersComponent.prototype.setIsCompany = function (is_company) {
        this.model.is_company = is_company;
    };
    ManagersComponent.prototype.editUser = function (userdata, index) {
        this.parameter.index = index;
        this.model = userdata;
        this.model.company = userdata.company ? userdata.company : new src_app_models_company_model__WEBPACK_IMPORTED_MODULE_4__["Company"]();
    ...
    ManagersComponent.prototype.setIsFreelancer = function (is_freelancer) {
    ...
    ManagersComponent.prototype.loadPlaces = function (paramAdd, paramLat, paramLng, searchRef) {
        var _this = this;
    ...
    ManagersComponent.prototype.setCurrentPosition = function () {
    ...
    ManagersComponent.prototype.placeMarker = function ($event, paramLat, paramLng, param) {
    ...
    ManagersComponent.prototype.getGeoLocation = function (lat, lng, param) {
        var _this = this;
    ...
    ManagersComponent.prototype.viewCompany = function (item) {
    ...
    ], ManagersComponent.prototype, "searchElementRef", void 0);
    __decorate([
    ...
    ManagersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_6__["Constant"], src_app_services_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"],
...
/* harmony import */ var src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/guards/acl-user.guard */ "./src/app/guards/acl-user.guard.ts");
...
/* harmony import */ var _managers_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./managers.component */ "./src/app/layout/managers/managers.component.ts");
...
var routes = [
    {
        path: 'view-all', component: _managers_component__WEBPACK_IMPORTED_MODULE_11__["ManagersComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Managers Management', 'can_read', ''] }
    }, {
        path: 'view-all/:type/:name', component: _managers_component__WEBPACK_IMPORTED_MODULE_11__["ManagersComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Managers Management', 'can_read', ''] }
    }
];
var ManagersModule = /** @class */ (function () {
    ...
    ManagersModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _managers_component__WEBPACK_IMPORTED_MODULE_11__["ManagersComponent"]
            ]
        })
    ], ManagersModule);
