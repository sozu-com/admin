...
var ProjectComponent = /** @class */ (function () {
    ...
    ProjectComponent.prototype.addPossessionStatusPopup = function (index, id, name_en, name_es, status, type) {
        var _this = this;
        this.parameter.index = index;
        var text = status === 1 ? this.translate.instant('message.question.wantToUnblockPossessionStatus') :
            this.translate.instant('message.question.wantToBlockPossessionStatus');
        swal({
            html: this.translate.instant('message.question.areYouSure') + '<br>' + this.parameter.text,
            type: 'warning',
            showCancelButton: true,
    ...
    ProjectComponent.prototype.addBuildingTypePopup = function (index, id, name_en, name_es, status, type) {
        var _this = this;
        this.parameter.index = index;
        var text = status === 1 ? this.translate.instant('message.question.wantToUnblockProjectType') :
            this.translate.instant('message.question.wantToBlockProjectType');
        swal({
            html: this.translate.instant('message.question.areYouSure') + '<br>' + this.parameter.text,
            type: 'warning',
            showCancelButton: true,
    ...
    ProjectComponent.prototype.addAmenityPopup = function (index, id, icon, name_en, name_es, status, type) {
        var _this = this;
        this.parameter.index = index;
        var text = status === 1 ? this.translate.instant('message.question.wantToUnblockAmenity') :
...
var PropertyComponent = /** @class */ (function () {
    ...
    PropertyComponent.prototype.addPropertyConfigurationPopup = function (index, id, name_en, name_es, bedroom, bathroom, half_bathroom, status, type) {
        ...
        this.parameter.index = index;
        var self = this;
        var text = status === 1 ? this.translate.instant('message.question.wantToUnblockPropertyConfig') :
    ...
    PropertyComponent.prototype.addPropertyTypePopup = function (index, id, name_en, name_es, status, type) {
        ...
        this.parameter.index = index;
        var self = this;
        var text = status === 1 ? this.translate.instant('message.question.wantToUnblockPropertyType') :
