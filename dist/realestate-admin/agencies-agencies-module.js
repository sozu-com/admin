...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9hZ2VuY2llcy9hZGQtYWdlbmN5L2FkZC1hZ2VuY3kuY29tcG9uZW50LmNzcyJ9 */"
...
var AddAgencyComponent = /** @class */ (function () {
    ...
    AddAgencyComponent.prototype.getCurrencies = function () {
        var _this = this;
    ...
    AddAgencyComponent.prototype.onCountryChange = function (e) {
    ...
    AddAgencyComponent.prototype.getAgencyById = function (id) {
        ...
        this.admin.postDataApi('getAgencyById', { 'id': id })
            ...
            _this.model.agency_banks = success.data.agency_banks;
    ...
    AddAgencyComponent.prototype.add = function (formData) {
        ...
        if (modelSave['agency_banks'] && modelSave['agency_banks'].length > 0) {
            var i = 0;
            for (var index = 0; index < modelSave['agency_banks'].length; index++) {
                var element = modelSave['agency_banks'][index];
        ...
        this.admin.postDataApi('addAgency', modelSave)
            ...
            if (success.success === '0') {
                ...
                _this.router.navigate(['/dashboard/agencies/view-all']);
                if (_this.model.id === '') {
                    _this.model.image = '';
                    _this.model.logo = '';
                    formData.reset();
    ...
    AddAgencyComponent.prototype.addLegalEntityBank = function (e) {
    ...
    AddAgencyComponent.prototype.removeLegalEntityBank = function ($event, item, i) {
        var _this = this;
    ...
    AddAgencyComponent.prototype.addDeveloperBank = function (e) {
        var bank = new src_app_models_legalEntity_model__WEBPACK_IMPORTED_MODULE_9__["Banks"]();
        console.log(this.model);
        this.model.agency_banks.push(bank);
    };
    AddAgencyComponent.prototype.removeDeveloperBank = function ($event, item, i) {
        var _this = this;
        $event.stopPropagation();
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9hZ2VuY2llcy9hZ2VuY2llcy5jb21wb25lbnQuY3NzIn0= */"
...
var AgenciesComponent = /** @class */ (function () {
    function AgenciesComponent(constant, spinner, admin, router, route, translate) {
        this.constant = constant;
        this.spinner = spinner;
        this.admin = admin;
        this.router = router;
...
var routes = [
    {
        path: 'view-all', component: _agencies_component__WEBPACK_IMPORTED_MODULE_12__["AgenciesComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Agencies Management', 'can_read', ''] }
    },
    {
        path: 'view-all/:name', component: _agencies_component__WEBPACK_IMPORTED_MODULE_12__["AgenciesComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_10__["AclUserGuard"]], data: { roles: ['Agencies Management', 'can_read', ''] }
    },
    {
