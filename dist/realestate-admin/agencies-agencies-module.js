...
var AddAgencyComponent = /** @class */ (function () {
    function AddAgencyComponent(router, constant, cs, mapsAPILoader, ngZone, admin, route, spinner) {
        this.router = router;
...
var AgenciesComponent = /** @class */ (function () {
    function AgenciesComponent(constant, spinner, admin, router) {
        this.constant = constant;
        this.spinner = spinner;
        this.admin = admin;
        this.router = router;
    ...
    AgenciesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_common_constants__WEBPACK_IMPORTED_MODULE_2__["Constant"],
            ...
            _services_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], AgenciesComponent);
...
/* harmony import */ var _agencies_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./agencies.component */ "./src/app/layout/agencies/agencies.component.ts");
/* harmony import */ var _add_agency_add_agency_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./add-agency/add-agency.component */ "./src/app/layout/agencies/add-agency/add-agency.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: _agencies_component__WEBPACK_IMPORTED_MODULE_11__["AgenciesComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['User Management', 'can_read', ''] } },
    { path: 'add-agency/:id', component: _add_agency_add_agency_component__WEBPACK_IMPORTED_MODULE_12__["AddAgencyComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['User Management', 'can_read', ''] } }
];
var AgenciesModule = /** @class */ (function () {
    ...
    AgenciesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _agencies_component__WEBPACK_IMPORTED_MODULE_11__["AgenciesComponent"],
                _add_agency_add_agency_component__WEBPACK_IMPORTED_MODULE_12__["AddAgencyComponent"]
            ]
        })
    ], AgenciesModule);
