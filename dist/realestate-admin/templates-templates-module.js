...
var AddTemplateComponent = /** @class */ (function () {
    function AddTemplateComponent(admin, route, spinner, http) {
        this.admin = admin;
        this.route = route;
...
var TemplatesComponent = /** @class */ (function () {
    function TemplatesComponent(admin, constant, http, spinner) {
        this.admin = admin;
...
/* harmony import */ var _add_template_add_template_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./add-template/add-template.component */ "./src/app/layout/templates/add-template/add-template.component.ts");
/* harmony import */ var _templates_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./templates.component */ "./src/app/layout/templates/templates.component.ts");
...
var routes = [
    { path: 'view-all', component: _templates_component__WEBPACK_IMPORTED_MODULE_10__["TemplatesComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Templates', 'can_read', ''] } },
    { path: 'add-template/:id', component: _add_template_add_template_component__WEBPACK_IMPORTED_MODULE_9__["AddTemplateComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Templates', 'can_create', ''] } },
    { path: 'edit-template/:id', component: _add_template_add_template_component__WEBPACK_IMPORTED_MODULE_9__["AddTemplateComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Templates', 'can_update', ''] } }
];
var TemplatesModule = /** @class */ (function () {
    ...
    TemplatesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _templates_component__WEBPACK_IMPORTED_MODULE_10__["TemplatesComponent"],
                _add_template_add_template_component__WEBPACK_IMPORTED_MODULE_9__["AddTemplateComponent"]
            ],
            imports: [
