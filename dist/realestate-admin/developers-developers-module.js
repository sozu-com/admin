...
var AddDeveloperComponent = /** @class */ (function () {
    function AddDeveloperComponent(constant, cs, mapsAPILoader, ngZone, admin, route, spinner) {
...
var DevelopersComponent = /** @class */ (function () {
    function DevelopersComponent(constant, admin, router, spinner) {
        this.constant = constant;
        this.admin = admin;
        this.router = router;
        this.spinner = spinner;
