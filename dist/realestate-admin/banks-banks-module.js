...
var BankLeadDetailsComponent = /** @class */ (function () {
    function BankLeadDetailsComponent(route, router, admin, cs, constant, spinner, selectedProperties, model) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.admin = admin;
...
var BankLeadsComponent = /** @class */ (function () {
    function BankLeadsComponent(admin, constant, route, spinner) {
        this.admin = admin;
        this.constant = constant;
        this.route = route;
        this.spinner = spinner;
...
var BanksComponent = /** @class */ (function () {
    function BanksComponent(constant, admin, spinner, cs) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.cs = cs;
...
/* harmony import */ var _banks_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./banks.component */ "./src/app/layout/banks/banks.component.ts");
...
/* harmony import */ var _bank_leads_bank_leads_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./bank-leads/bank-leads.component */ "./src/app/layout/banks/bank-leads/bank-leads.component.ts");
/* harmony import */ var _bank_leads_bank_lead_details_bank_lead_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./bank-leads/bank-lead-details/bank-lead-details.component */ "./src/app/layout/banks/bank-leads/bank-lead-details/bank-lead-details.component.ts");
...
var routes = [
    { path: 'view-banks', component: _banks_component__WEBPACK_IMPORTED_MODULE_8__["BanksComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Bank Management', 'can_read', 'can_bank'] } },
    // all leads
    { path: 'bank-leads', component: _bank_leads_bank_leads_component__WEBPACK_IMPORTED_MODULE_10__["BankLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Bank Lead Management', 'can_read', 'can_bank'] } },
    // leads wrt particular bank
    { path: 'view-bank-leads/:id', component: _bank_leads_bank_leads_component__WEBPACK_IMPORTED_MODULE_10__["BankLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Bank Lead Management', 'can_read', 'can_bank'] } },
    // bank lead details
    { path: 'bank-leads/:id', component: _bank_leads_bank_lead_details_bank_lead_details_component__WEBPACK_IMPORTED_MODULE_11__["BankLeadDetailsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Bank Lead Management', 'can_read', 'can_bank'] } }
];
var BanksModule = /** @class */ (function () {
    ...
    BanksModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _banks_component__WEBPACK_IMPORTED_MODULE_8__["BanksComponent"],
                _bank_leads_bank_leads_component__WEBPACK_IMPORTED_MODULE_10__["BankLeadsComponent"],
                _bank_leads_bank_lead_details_bank_lead_details_component__WEBPACK_IMPORTED_MODULE_11__["BankLeadDetailsComponent"]
            ]
        })
    ], BanksModule);
    return BanksModule;
