...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9jb21wYW5pZXMvYWRkLWNvbXBhbnkvYWRkLWNvbXBhbnkuY29tcG9uZW50LmNzcyJ9 */"
...
var AddCompanyComponent = /** @class */ (function () {
    function AddCompanyComponent(constant, cs, mapsAPILoader, ngZone, admin, route, spinner, translate, router) {
    ...
    AddCompanyComponent.prototype.getCurrencies = function () {
        var _this = this;
    ...
    AddCompanyComponent.prototype.onCountryChange = function (e) {
    ...
    AddCompanyComponent.prototype.add = function (formData) {
        ...
        this.admin.postDataApi('addTowerManagerCompany', modelSave)
            ...
            if (success.success === '0') {
                ...
                // }
                _this.router.navigate(['/dashboard/companies/view-all']);
            }
        }, function (error) {
            _this.spinner.hide();
        });
    ...
    AddCompanyComponent.prototype.addLegalEntityBank = function (e) {
    ...
    AddCompanyComponent.prototype.removeLegalEntityBank = function ($event, item, i) {
        var _this = this;
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9jb21wYW5pZXMvY29tcGFuaWVzLmNvbXBvbmVudC5jc3MifQ== */"
...
var CompaniesComponent = /** @class */ (function () {
    function CompaniesComponent(constant, admin, spinner, router, translate, route) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.router = router;
    ...
    CompaniesComponent.prototype.getManagers = function (company) {
    ...
    CompaniesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"], src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]])
    ], CompaniesComponent);
...
var routes = [
    {
        path: 'view-all', component: _companies_component__WEBPACK_IMPORTED_MODULE_11__["CompaniesComponent"],
    ...
    {
        path: 'view-all/:name', component: _companies_component__WEBPACK_IMPORTED_MODULE_11__["CompaniesComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_12__["AclUserGuard"]], data: { roles: ['Companies Management', 'can_read', ''] }
    },
    {
