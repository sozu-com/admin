...
var ManualLeadDetailsComponent = /** @class */ (function () {
    function ManualLeadDetailsComponent(route, admin, router, cs, constant, model, spinner) {
        this.route = route;
        this.admin = admin;
        this.router = router;
        this.cs = cs;
...
/* harmony import */ var _manual_leads_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./manual-leads.component */ "./src/app/layout/manual-leads/manual-leads.component.ts");
/* harmony import */ var _manual_lead_details_manual_lead_details_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./manual-lead-details/manual-lead-details.component */ "./src/app/layout/manual-leads/manual-lead-details/manual-lead-details.component.ts");
...
var routes = [
    ...
    { path: 'view-all', component: _manual_leads_component__WEBPACK_IMPORTED_MODULE_6__["ManualLeadsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Manual Leads', 'can_read', ''] } },
    { path: 'view-details/:id', component: _manual_lead_details_manual_lead_details_component__WEBPACK_IMPORTED_MODULE_7__["ManualLeadDetailsComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_9__["AclUserGuard"]], data: { roles: ['Manual Leads', 'can_read', ''] } }
];
var ManualLeadsModule = /** @class */ (function () {
    ...
    ManualLeadsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _manual_leads_component__WEBPACK_IMPORTED_MODULE_6__["ManualLeadsComponent"],
                _manual_lead_details_manual_lead_details_component__WEBPACK_IMPORTED_MODULE_7__["ManualLeadDetailsComponent"]
            ]
        })
    ], ManualLeadsModule);
