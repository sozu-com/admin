(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["collection-report-collection-report-module"],{

/***/ "./src/app/layout/collection-report/app-unapproved/app-unapproved.component.css":
/*!**************************************************************************************!*\
  !*** ./src/app/layout/collection-report/app-unapproved/app-unapproved.component.css ***!
  \**************************************************************************************/
...
module.exports = ".filters{\n    padding: 30px 20px 60px 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/app-unapproved/app-unapproved.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/layout/collection-report/app-unapproved/app-unapproved.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/models/collection-report.model */ "./src/app/models/collection-report.model.ts");
...
var AppUnapprovedComponent = /** @class */ (function () {
    function AppUnapprovedComponent(admin, spinner, translate) {
        this.admin = admin;
    ...
    AppUnapprovedComponent.prototype.onSelect = function (event) { };
    AppUnapprovedComponent.prototype.ngOnInit = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(12, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
    ...
    AppUnapprovedComponent.prototype.initCalendarLocale = function () {
    ...
    AppUnapprovedComponent.prototype.iniDropDownSetting = function () {
    ...
    AppUnapprovedComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    AppUnapprovedComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    AppUnapprovedComponent.prototype.onSelectAll = function (obj) {
    };
    AppUnapprovedComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
            _this.currencies.map(function (r) {
    ...
    AppUnapprovedComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
    ...
    AppUnapprovedComponent.prototype.getReportData = function () {
        var _this = this;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.end_date).format('YYYY-MM-DD');
        if (this.selctedProjects) {
            var d = this.selctedProjects.map(function (o) { return o.id; });
            input.building_id = d;
        }
        if (this.selectedCurrencies) {
            var d = this.selectedCurrencies.map(function (o) { return o.id; });
            input.currency_id = d;
        }
        this.spinner.show();
        this.admin.postDataApi('graphs/sales-reports', input).subscribe(function (r) {
            _this.spinner.hide();
    ...
    AppUnapprovedComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
    ...
    AppUnapprovedComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
        this.selectedCurrencies = [];
        this.selctedProjects = [];
    };
    AppUnapprovedComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-app-unapproved',
            template: __webpack_require__(/*! ./app-unapproved.component.html */ "./src/app/layout/collection-report/app-unapproved/app-unapproved.component.html"),
            styles: [__webpack_require__(/*! ./app-unapproved.component.css */ "./src/app/layout/collection-report/app-unapproved/app-unapproved.component.css")]
        }),
...
/***/ "./src/app/layout/collection-report/arrear-report/arrear-report.component.css":
/*!************************************************************************************!*\
  !*** ./src/app/layout/collection-report/arrear-report/arrear-report.component.css ***!
  \************************************************************************************/
/*! no static exports found */
...
module.exports = ".text-bold {\n    font-weight: 600;\n    background-color: #F9F9F9;\n}\n.main-table{\n    height: 700px;\n  }\ntable.table-striped.quick-table th {\n      width: 190px;\n    }\ntable.table-striped.quick-table {\n      table-layout: fixed;\n      width:100%;\n    }\n/* table.table-striped.quick-table thead tr th:nth-child(1), \n    table.table-striped.quick-table thead tr th:nth-child(2), */\n/* table.table-striped.quick-table thead tr th:nth-child(3) */\ntable.table-striped.quick-table thead tr th\n    {\n      position:-webkit-sticky !important;\n      position:sticky !important;\n      left:0 !important;\n      top: 0 !important;\n      z-index:1 !important;\n      background-color: #00B96F;\n      color: #fff;\n    }\ntable.table-striped.quick-table th:first-child {\n      z-index:2;\n    }\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/arrear-report/arrear-report.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/layout/collection-report/arrear-report/arrear-report.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../models/collection-report.model */ "./src/app/models/collection-report.model.ts");
...
var ArrearReportComponent = /** @class */ (function () {
    function ArrearReportComponent(constant, admin, spinner, translate) {
    ...
    ArrearReportComponent.prototype.ngOnInit = function () {
        this.finalData = [];
        this.iniDropDownSetting();
        this.today = new Date();
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.previousMonth = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(1, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.nextMonth = moment__WEBPACK_IMPORTED_MODULE_1__().add(1, 'months').toDate();
        this.getDevelopers();
        this.getBuyers();
        this.getLegalRep();
        this.searchBuilding();
    ...
    ArrearReportComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    ArrearReportComponent.prototype.iniDropDownSetting = function () {
    ...
    ArrearReportComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    ArrearReportComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    ArrearReportComponent.prototype.onSelectAll = function (obj) {
    };
    ArrearReportComponent.prototype.getAllPaymentChoices = function () {
        var _this = this;
    ...
    ArrearReportComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    ArrearReportComponent.prototype.onSelectProject = function (isSelected, obj) {
        if (isSelected) {
    ...
    ArrearReportComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    ArrearReportComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
        });
    };
    ArrearReportComponent.prototype.getBuyers = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 1 })
            .subscribe(function (success) {
            _this.buyers = success.data;
        });
    };
    ArrearReportComponent.prototype.getLegalRep = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 2 })
            .subscribe(function (success) {
            _this.legalReps = success.data;
        });
    };
    ArrearReportComponent.prototype.getListing = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.end_date).format('YYYY-MM-DD');
        input.year = new Date(this.input.end_date).getFullYear(),
            input.month = new Date(this.input.end_date).getMonth() + 1;
        this.previousMonth = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.end_date).subtract(1, 'months').toDate();
        this.nextMonth = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.end_date).add(1, 'months').toDate();
        if (this.selctedProjects) {
            var d = this.selctedProjects.map(function (o) { return o.id; });
            input.building_id = d;
        }
        ...
        if (this.selectedBuyers) {
            var d = this.selectedBuyers.map(function (o) { return o.id; });
            input.buyer_id = d;
        }
        if (this.selectedLegalReps) {
            var d = this.selectedLegalReps.map(function (o) { return o.id; });
            input.legal_rep_id = d;
        }
        if (this.selectedBuyerDev) {
            var d = this.selectedBuyerDev.map(function (o) { return o.id; });
            input.buyer_dev_id = d;
        }
        this.admin.postDataApi('generateCollectionArrearsReport', input).subscribe(function (success) {
            _this.spinner.hide();
            _this.data = success['data'];
            _this.incomeProjection = success['income_projection'];
            _this.paidConcepts = success['data2'];
            _this.finalData = [];
            _this.model = [];
            for (var property in _this.data) {
                if (property) {
                    _this.model.push(property);
                }
            }
            var _loop_1 = function (index) {
                var element = _this.model[index];
                _this.data[element][0]['showInfo'] = true;
                var t = 0;
                _this.data[element].map(function (r) {
                    t = t + (r['amount'] || 0) + (r['penelty'] || 0);
                });
                _this.data[element][0]['total_amount'] = t;
                _this.finalData = _this.finalData.concat(_this.data[element]);
            };
            for (var index = 0; index < _this.model.length; index++) {
                _loop_1(index);
            }
            var grand_amount = 0;
            var grand_penalty = 0;
            var grand_total_amount = 0;
            for (var index = 0; index < _this.finalData.length; index++) {
                var element = _this.finalData[index];
            ...
            _this.finalData.push({ id: 'Total', key: 1, amount: grand_amount, penelty: grand_penalty, total_amount: grand_total_amount });
            console.log('finalData', _this.finalData, 'response', success['data']);
            var _loop_2 = function (index) {
                var element = _this.paymentChoices[index];
                var expected_amt = [];
                var penalty = [];
                expected_amt = _this.incomeProjection.filter(function (r) { if (r.id == element.id) {
                    return r['expected_amt'];
                } });
                penalty = _this.incomeProjection.filter(function (r) { if (r.id == element.id) {
                    return r['expected_penalty'];
                } });
                var ea = expected_amt && expected_amt.length > 0 ? expected_amt[0].expected_amt : 0;
                var p = penalty && penalty.length > 0 ? penalty[0].expected_penalty : 0;
                var paid_amount = _this.paidConcepts.filter(function (r) { if (r.id == element.id) {
                    return r['paid_amount'];
                } });
                element.paid_amount = paid_amount && paid_amount.length > 0 ? paid_amount[0].paid_amount : 0;
                element.total = (ea + p).toFixed(2);
            };
            for (var index = 0; index < _this.paymentChoices.length; index++) {
                _loop_2(index);
            }
        }, function (error) {
            _this.spinner.hide();
    ...
    ArrearReportComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selctedProjects = [];
        this.selectedCurrencies = [];
    ...
    ArrearReportComponent.prototype.exportData = function () {
        if (this.finalData) {
            var finalData = [];
            for (var index = 0; index < this.finalData.length; index++) {
                var item = this.finalData[index];
                if (item.id != 'Total') {
                    finalData.push({
                        'Account ID': item.id || '',
    ...
    ArrearReportComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
    ...
    ArrearReportComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        ...
        file_saver__WEBPACK_IMPORTED_MODULE_7__["saveAs"](data, fileName + EXCEL_EXTENSION);
    };
    ArrearReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-arrear-report',
            template: __webpack_require__(/*! ./arrear-report.component.html */ "./src/app/layout/collection-report/arrear-report/arrear-report.component.html"),
            styles: [__webpack_require__(/*! ./arrear-report.component.css */ "./src/app/layout/collection-report/arrear-report/arrear-report.component.css")]
        }),
...
/***/ "./src/app/layout/collection-report/buyer-report/buyer-report.component.css":
/*!**********************************************************************************!*\
  !*** ./src/app/layout/collection-report/buyer-report/buyer-report.component.css ***!
  \**********************************************************************************/
/*! no static exports found */
...
module.exports = "\ntable.table-striped.quick-table th:nth-child(1),\ntable.table-striped.quick-table thead tr th \n{\n  background-color: #00B96F;\n  color: #fff;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/buyer-report/buyer-report.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/layout/collection-report/buyer-report/buyer-report.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container-fluid\">\n      <div class=\"row\">\n            <div class=\"col-md-4\">\n                  <div class=\"form-group\">\n                        <h5>{{'collectionReport.buyerReport' | translate}}</h5>\n                  </div>\n            </div>\n      </div>\n\n      <hr>\n\n      <div class=\"row\">\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.developer' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"developers\" [(ngModel)]=\"selectedDevelopers\" [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectDeveloper(0, $event)\" (onSelect)=\"onSelectDeveloper(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.project' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"projects\" [(ngModel)]=\"selctedProjects\" [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectProject(0, $event)\" (onSelect)=\"onSelectProject(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.tower' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"buildingTowers\" [(ngModel)]=\"selectedTowers\" [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectTower(0, $event)\" (onSelect)=\"onSelectTower(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.floor' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"floors\" [(ngModel)]=\"selectedFloors\" [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectFloor(0, $event)\" (onSelect)=\"onSelectFloor(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.property' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"properties\" [(ngModel)]=\"selectedProperties\" [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('properties', $event)\"\n                              (onSelect)=\"onItemSelect('selectedProperties', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group marginB0\">\n                        <label>{{'collectionReport.currency' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\" [placeholder]=\"''\"\n                              [data]=\"currencies\" [(ngModel)]=\"selectedCurrencies\" [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                              (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                        <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n      </div>\n\n\n      <div class=\"row\">\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.start_date' | translate}}</label>\n                        <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\"\n                              [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" showButtonBar=\"true\"\n                              class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\"\n                              yearRange=\"2000:2040\"></p-calendar>\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                        <label>{{'collectionReport.end_date' | translate}}</label>\n                        <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\"\n                              [maxDate]=\"today\" showButtonBar=\"true\" class=\"coll-report-calendar\"\n                              [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                  </div>\n            </div>\n            <!-- <div class=\"col-lg-2 col-md-2\">\n                <div class=\"form-group\">\n                  <label>{{'collectionReport.buyerAsAPerson' | translate}}</label>\n                <div class=\"clearfix\"></div>\n                      <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                            [placeholder]=\"''\"\n                            [data]=\"buyers\"\n                            [(ngModel)]=\"selectedBuyers\"\n                            [settings]=\"multiDropdownSettings\"\n                            (onDeSelect)=\"onItemDeSelect('buyers', $event)\"\n                            (onSelect)=\"onItemSelect('selectedBuyers', $event)\"\n                            (onSelectAll)=\"onSelectAll($event)\">\n                      </ng-multiselect-dropdown>\n                <div class=\"clearfix\"></div>\n                </div>\n          </div>\n          <div class=\"col-lg-2 col-md-2\">\n                <div class=\"form-group\">\n                  <label>{{'collectionReport.buyerAsADev' | translate}}</label>\n                <div class=\"clearfix\"></div>\n                      <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                            [placeholder]=\"''\"\n                            [data]=\"buyersAsDev\"\n                            [(ngModel)]=\"selectedBuyerDev\"\n                            [settings]=\"multiDropdownSettings\"\n                            (onDeSelect)=\"onItemDeSelect('buyersAsDev', $event)\"\n                            (onSelect)=\"onItemSelect('selectedBuyerDev', $event)\"\n                            (onSelectAll)=\"onSelectAll($event)\">\n                      </ng-multiselect-dropdown>\n                <div class=\"clearfix\"></div>\n                </div>\n          </div>\n          <div class=\"col-lg-2 col-md-2\">\n                <div class=\"form-group\">\n                  <label>{{'collectionReport.buyerAsALegalRep' | translate}}</label>\n                <div class=\"clearfix\"></div>\n                      <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                            [placeholder]=\"''\"\n                            [data]=\"legalReps\"\n                            [(ngModel)]=\"selectedLegalReps\"\n                            [settings]=\"legalRepDropdownSettings\"\n                            (onDeSelect)=\"onItemDeSelect('legalReps', $event)\"\n                            (onSelect)=\"onItemSelect('selectedLegalReps', $event)\"\n                            (onSelectAll)=\"onSelectAll($event)\">\n                      </ng-multiselect-dropdown>\n                <div class=\"clearfix\"></div>\n                </div>\n          </div> -->\n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                        <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                        <button type=\"button\" (click)=\"getListing()\"\n                              class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                        <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                        <button type=\"button\" (click)=\"resetFilters()\"\n                              class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                        <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                        <button type=\"button\" (click)=\"getExportlisting()\"\n                              class=\"btn btn-primary-new width100P P86\">{{'collectionReport.export' | translate}}</button>\n                  </div>\n            </div>\n      </div>\n\n      <div class=\"cust-tabs\">\n            <div class=\"row flex-wrap-reverse\">\n\n                  <div class=\"col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12\">\n                  </div>\n                  <div class=\"col-xl-2 col-lg-12 col-md-12 col-sm-12 col-12\">\n                        <div class=\"add-new pull-right\">\n                              <!-- *ngIf=\"admin?.admin_acl['Project Management']?.can_create==1 || admin?.permissions?.can_data_collector==1\"  -->\n                              <!-- <a \n            class=\"btn\" href=\"javascript://\" routerLink=\"/dashboard/collections/add-collection/0\">{{'viewCollections.addNew' | translate}}</a> -->\n                        </div>\n                  </div>\n            </div>\n            <div class=\"tab-content white-bg\">\n                  <div class=\"tab-pane active\">\n                        <div class=\"tabel-section\">\n                              <div class=\"table-responsive main-table\">\n                                    <table class=\"table table-bordered table-striped table-align-left quick-table\">\n                                          <thead>\n                                                <tr class=\"text-bold\">\n                                                      <th style=\"width:17%; text-align:left;\">\n                                                            <div class=\"table-search\">\n                                                                  <b>{{'collectionReport.buyerName' | translate}}</b>\n                                                                  <div class=\"searh-3\">\n                                                                        <input autocomplete=\"off\" class=\"width100px\"\n                                                                              type=\"text\" [(ngModel)]=\"input.buyer_name\"\n                                                                              (keyup.enter)=\"getListing()\">\n                                                                        <button *ngIf=\"input.buyer_name\"\n                                                                              (click)=\"getListing()\"><i\n                                                                                    class=\"fa fa-search\"></i></button>\n                                                                  </div>\n                                                            </div>\n                                                      </th>\n                                                      <th style=\"width:17%; text-align:left;\">\n                                                            <div class=\"table-search\">\n                                                                  <b>{{'collectionReport.sellerName' | translate}}</b>\n                                                                  <div class=\"searh-3\">\n                                                                        <input autocomplete=\"off\" class=\"width100px\"\n                                                                              type=\"text\"\n                                                                              [(ngModel)]=\"input.seller_name\"\n                                                                              (keyup.enter)=\"getListing()\">\n                                                                        <button *ngIf=\"input.seller_name\"\n                                                                              (click)=\"getListing()\"><i\n                                                                                    class=\"fa fa-search\"></i></button>\n                                                                  </div>\n                                                            </div>\n                                                      </th>\n                                                      <th style=\"width:10%; text-align:left;\">\n                                                            <b>{{'collectionReport.destinyBank' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:13%; text-align:left;\">\n                                                            <b>{{'collectionReport.project' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:13%; text-align:left;\">\n                                                            <b>{{'collectionReport.tower' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.model' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.propertyName' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:5%; text-align:left;\">\n                                                            <b>{{'collectionReport.currency' | translate}}</b></th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.date' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <div class=\"table-search\">\n                                                                  <b>{{'collectionReport.amountPaidByUser' | translate}}</b>\n                                                                  <div class=\"searh-3\">\n                                                                        <input autocomplete=\"off\" class=\"width100px\"\n                                                                              type=\"text\"\n                                                                              [(ngModel)]=\"input.amountPaidByUser\"\n                                                                              (keyup.enter)=\"getListing()\">\n                                                                        <button *ngIf=\"input.amountPaidByUser\"\n                                                                              (click)=\"getListing()\">\n                                                                              <i class=\"fa fa-search\"></i>\n                                                                        </button>\n                                                                  </div>\n                                                            </div>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.paymentMethod' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.bankName' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:7%; text-align:left;\">\n                                                            <b>{{'collectionReport.accountNumber' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:10%; text-align:left;\">\n                                                            <b>{{'collectionReport.clabeSwift' | translate}} (s)</b>\n                                                      </th>\n                                                      <th style=\"width:10%; text-align:left;\">\n                                                            <b>{{'collectionReport.currency' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:10%; text-align:left;\">\n                                                            <b>{{'collectionReport.totalPaid' | translate}}</b>\n                                                      </th>\n                                                      <th style=\"width:10%; text-align:left;\">\n                                                            <b>{{'collectionReport.remaining' | translate}}</b>\n                                                      </th>\n                                                </tr>\n                                          </thead>\n                                          <tbody>\n                                                <tr *ngFor=\"let item of finalData | paginate: { itemsPerPage: parameter.itemsPerPage, currentPage: parameter.page, totalItems: total }; let i=index\"\n                                                      [ngClass]=\"{'text-bold' : item.calculated==1}\">\n                                                      <td>\n                                                            <span *ngIf=\"item?.buyer_type != 2\">\n                                                                  {{item?.buyer?.name ? (item?.buyer?.name + ' ' + item?.buyer?.first_surname + ' ' + item?.buyer?.second_surname) : ('table.tr.td.NA' | translate)}}\n                                                            </span>\n                                                            <span *ngIf=\"item?.buyer_type == 2\">\n                                                                  {{item?.buyer_legal_entity?.comm_name ? item?.buyer_legal_entity?.comm_name : ('table.tr.td.NA' | translate)}}\n                                                            </span>\n                                                      </td>\n                                                      <td>\n                                                            <span *ngIf=\"item?.seller_type != 2\">\n                                                                  {{item?.seller?.name ? (item?.seller?.name + ' ' + item?.seller?.first_surname + ' ' + item?.seller?.second_surname) : ('table.tr.td.NA' | translate)}}\n                                                            </span>\n                                                            <span *ngIf=\"item?.seller_type == 2\">\n                                                                  {{item?.seller_legal_entity?.comm_name ? item?.seller_legal_entity?.comm_name : ('table.tr.td.NA' | translate)}}\n                                                            </span>\n                                                      </td>\n                                                      <td><span>\n                                                                  {{item?.payment_received_by == 1 ? item?.property?.building?.agency?.name : 'Seller'}}\n                                                            </span></td>\n                                                      <td><span>{{item?.property?.building?.name || ('table.tr.td.NA' | translate)}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.property?.building_towers?.tower_name || ('table.tr.td.NA' | translate)}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.property?.building_configuration?.name || ('table.tr.td.NA' | translate)}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.property?.name || ('table.tr.td.NA' | translate)}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.currency?.code || ('table.tr.td.NA' | translate)}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.payment_date}}</span></td>\n                                                      <td><span>{{item?.amt_paid | currency}}</span></td>\n                                                      <td><span >{{item?.payment_method?.name}}</span></td>\n                                                      <td><span>{{item?.bank_name}}</span></td>\n                                                      <td><span>{{item?.account_number}}</span></td>\n                                                      <td><span>{{item?.swift}}</span></td>\n                                                      <td><span>{{item?.bank_currency}}</span></td>\n                                                      <!-- <td><span>{{item?.deal_price - item?.remaning_amount | currency}}</span></td> -->\n                                                      <td><span>{{(item?.deal_price - (item?.remaning_amount || 0)) | currency}}</span>\n                                                      </td>\n                                                      <td><span>{{item?.remaning_amount || 0 | currency}}</span></td>\n                                                </tr>\n                                          </tbody>\n                                    </table>\n                                    <div class=\"padding20 center\" *ngIf=\"finalData?.length == 0\">\n                                          <img src=\"assets/img/404-error.png\">\n                                    </div>\n                              </div>\n                        </div>\n                  </div>\n\n                  <div class=\"btn-cont marginT15\" *ngIf=\"total\">\n                        <div class=\"row\">\n                              <div class=\"col-6\">\n                                    <div class=\"title-group\">\n                                          <p>{{'table.pagination.showing' | translate}} {{finalData?.length}}\n                                                {{'table.pagination.outof' | translate}} {{total}}</p>\n                                    </div>\n                              </div>\n                              <div class=\"col-6 text-right\">\n                                    <pagination-controls class=\"my-pagination\" (pageChange)=\"getPage($event)\">\n                                    </pagination-controls>\n                              </div>\n                        </div>\n                  </div>\n            </div>\n      </div>\n</div>"

/***/ }),

/***/ "./src/app/layout/collection-report/buyer-report/buyer-report.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/layout/collection-report/buyer-report/buyer-report.component.ts ***!
  \*********************************************************************************/
/*! exports provided: BuyerReportComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BuyerReportComponent", function() { return BuyerReportComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/fesm5/ngx-spinner.js");
...
/* harmony import */ var src_app_common_excelDownload__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/common/excelDownload */ "./src/app/common/excelDownload.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXCEL_TYPE = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
var EXCEL_EXTENSION = '.xlsx';
var BuyerReportComponent = /** @class */ (function () {
    function BuyerReportComponent(constant, admin, spinner, translate) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
    ...
    BuyerReportComponent.prototype.ngOnInit = function () {
        this.finalData = [];
        this.getPaymentMethods();
        this.iniDropDownSetting();
        this.today = new Date();
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.towers = [new src_app_models_addProject_model__WEBPACK_IMPORTED_MODULE_7__["Towers"]()];
        this.previousMonth = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(1, 'months').toDate();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(3, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.nextMonth = moment__WEBPACK_IMPORTED_MODULE_1__().add(1, 'months').toDate();
    ...
    BuyerReportComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    BuyerReportComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    BuyerReportComponent.prototype.getPage = function (page) {
        this.parameter.page = page;
        this.getListing();
    };
    BuyerReportComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    BuyerReportComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    BuyerReportComponent.prototype.onSelectAll = function (obj) {
    };
    BuyerReportComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    BuyerReportComponent.prototype.onSelectDeveloper = function (isSelected, obj) {
        this.projects = [];
        this.selctedProjects = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
    ...
    BuyerReportComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
    ...
    BuyerReportComponent.prototype.onSelectProject = function (isSelected, obj) {
        this.input.building_id = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
        this.selectedProperties = [];
    ...
    BuyerReportComponent.prototype.searchBuilding = function (developer_id) {
        var _this = this;
        this.spinner.show();
        var input = {
    ...
    BuyerReportComponent.prototype.setBuildingId = function (buildingId) {
        var _this = this;
        this.projects.map(function (r) {
            if (r.id == buildingId) {
                _this.buildingTowers = r.building_towers ? r.building_towers : [];
            }
        });
        this.buildingTowers.map(function (s) {
            s.name = s.tower_name;
        });
        this.input.building_id = [buildingId];
    };
    BuyerReportComponent.prototype.onSelectTower = function (isSelected, obj) {
    ...
    BuyerReportComponent.prototype.setTower = function (building_towers_id) {
        var _this = this;
        this.floors = [];
        for (var index = 0; index < this.projects.length; index++) {
            if (this.projects[index].id == this.input.building_id) {
                var bt = this.projects[index].building_towers;
                for (var i = 0; i < bt.length; i++) {
                    if (bt[i].id == building_towers_id) {
                        this.towers = bt[i];
                        this.towers['floors'] = [];
                        // floors
                        this.towers['unique_floors'].map(function (s) {
                            var obj = {};
                            obj = { id: s, name: s == 0 ? 'Ground Floor' : 'Floor ' + s };
                            _this.towers['floors'].push(obj);
                            _this.floors.push(obj);
                        });
                    }
                }
            }
    ...
    BuyerReportComponent.prototype.onSelectFloor = function (isSelected, obj) {
        this.properties = [];
        this.selectedProperties = [];
        if (isSelected) {
    ...
    BuyerReportComponent.prototype.getProperties = function ($event) {
        var _this = this;
        var input = {};
        if (this.selctedProjects) {
            var d = this.selctedProjects.map(function (o) { return o.id; });
        ...
        if (this.selectedTowers) {
            var d = this.selectedTowers.map(function (o) { return o.id; });
            input['building_towers_id'] = d[0];
        }
        if (this.selectedFloors) {
            var d = this.selectedFloors.map(function (o) { return o.id; });
            input['floor_num'] = d[0];
        }
        this.spinner.show();
    ...
    BuyerReportComponent.prototype.getBuyers = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 1 })
            .subscribe(function (success) {
            _this.buyers = success.data;
    ...
    BuyerReportComponent.prototype.getLegalRep = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 2 })
            .subscribe(function (success) {
            _this.legalReps = success.data;
    ...
    BuyerReportComponent.prototype.getBuyersAsDev = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 3 })
            .subscribe(function (success) {
            _this.buyersAsDev = success.data;
        });
    };
    BuyerReportComponent.prototype.getListing = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM-DD');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.end_date).format('YYYY-MM-DD');
        input.page = this.parameter.page;
        if (this.selectedDevelopers) {
            var d = this.selectedDevelopers.map(function (o) { return o.id; });
        ...
        if (this.selectedProperties) {
            var d = this.selectedProperties.map(function (o) { return o.id; });
            input.property_id = d;
        }
        if (this.selectedBuyers) {
            var d = this.selectedBuyers.map(function (o) { return o.id; });
        ...
        this.admin.postDataApi('generateCollectionbuyerReport', input).subscribe(function (success) {
            _this.total = success['total'];
            _this.finalData = success['data'];
            for (var index = 0; index < _this.finalData.length; index++) {
                var element = _this.finalData[index];
                var b = '';
    ...
    BuyerReportComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selectedBuyers = [];
    ...
    BuyerReportComponent.prototype.exportData = function () {
        var self = this;
        if (this.exportfinalData) {
            var exportfinalData = [];
            for (var index = 0; index < this.exportfinalData.length; index++) {
                var item = self.exportfinalData[index];
            ...
            new src_app_common_excelDownload__WEBPACK_IMPORTED_MODULE_8__["ExcelDownload"]().exportAsExcelFile(exportfinalData, 'buyerReport');
        }
    };
    BuyerReportComponent.prototype.getExportlisting = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM-DD');
        ...
        this.admin.postDataApi('generateCollectionbuyerReport', input).subscribe(function (success) {
            ...
            for (var index = 0; index < _this.exportfinalData.length; index++) {
                var element = _this.exportfinalData[index];
                var b = '';
                if (element.payment_received_by == 1) {
                    if (element.bank_id) {
                        b = element.agency_bank_name;
    ...
    BuyerReportComponent.prototype.getPaymentMethods = function () {
        var _this = this;
    ...
    BuyerReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-buyer-report',
            template: __webpack_require__(/*! ./buyer-report.component.html */ "./src/app/layout/collection-report/buyer-report/buyer-report.component.html"),
            styles: [__webpack_require__(/*! ./buyer-report.component.css */ "./src/app/layout/collection-report/buyer-report/buyer-report.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
...
/***/ "./src/app/layout/collection-report/cash-flow/cash-flow.component.css":
/*!****************************************************************************!*\
  !*** ./src/app/layout/collection-report/cash-flow/cash-flow.component.css ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = ".filters{\n    padding: 30px 20px 10px 20px;\n}\n.filters2{\n    padding: 0px 20px 60px 20px;\n}\nbutton.btn.btn-primary-new.export-btn {\n    margin-bottom: 10px;\n}\n.main-table table{\n    text-align: center;\n}\ntable, th, td {\n    border: 1px solid black;\n    border-collapse: collapse;\n  }\nth, td {\n    padding: 5px;\n    text-align: left;\n  }\n/* tbody tr:nth-child(odd){\n    background-color: #00B96F;\n    color: black;\n  } */\nth {\n    background-color: #00B96F;\n    color: black;\n  }\ntable tr > td:first-child {\n    background-color: #ff0000; \n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/cash-flow/cash-flow.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/layout/collection-report/cash-flow/cash-flow.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
var CashFlowComponent = /** @class */ (function () {
    function CashFlowComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    CashFlowComponent.prototype.onSelect = function (event) { };
    ...
    CashFlowComponent.prototype.getListing = function () {
        var _this = this;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.end_date).format('YYYY-MM-DD');
        ...
        if (this.start_purchase_date) {
            input.start_purchase_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.start_purchase_date).format('YYYY-MM-DD');
        }
        if (this.end_purchase_date) {
            input.end_purchase_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.end_purchase_date).format('YYYY-MM-DD');
        }
        this.spinner.show();
        this.spinner.show();
        this.admin.postDataApi('graphs/cash-flow', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.finalDataExpacted = [];
            _this.finalDataActual = [];
            _this.finalDataPending = [];
            _this.finalDatadue = [];
            var reportData = r['data'];
            console.log(reportData, "reportData");
            for (var index = 0; index < reportData['expected'].length; index++) {
                var element = reportData['expected'][index];
                for (var ind = 0; ind < element.y.length; ind++) {
                    var obj = { expected: element.y[ind].y, label: element.y[ind].label };
                    _this.finalDataExpacted.push(obj);
                }
            }
            for (var index = 0; index < reportData['actual'].length; index++) {
                var element = reportData['actual'][index];
                for (var ind = 0; ind < element.y.length; ind++) {
                    var obj = { actual: element.y[ind].y, label: element.y[ind].label };
                    _this.finalDataActual.push(obj);
                }
            }
            for (var index = 0; index < reportData['pending'].length; index++) {
                var element = reportData['pending'][index];
                for (var ind = 0; ind < element.y.length; ind++) {
                    var obj = { pending: element.y[ind].y, label: element.y[ind].label };
                    _this.finalDataPending.push(obj);
                }
            }
            for (var index = 0; index < reportData['total_over_due'].length; index++) {
                var element = reportData['total_over_due'][index];
                for (var ind = 0; ind < element.y.length; ind++) {
                    var obj = { total_over_due: element.y[ind].y, label: element.y[ind].label };
                    _this.finalDatadue.push(obj);
                }
            }
        }, function (error) {
            _this.spinner.hide();
    ...
    CashFlowComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    CashFlowComponent.prototype.getAllPaymentChoices = function () {
        var _this = this;
        this.admin.postDataApi('getPaymentChoices', {})
            .subscribe(function (success) {
            _this.paymentChoices = success.data;
    ...
    CashFlowComponent.prototype.iniDropDownSetting = function () {
        this.multiDropdownSettings = {
            singleSelection: false,
            idField: 'id',
            textField: 'name',
    ...
    CashFlowComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    CashFlowComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    CashFlowComponent.prototype.onSelectAll = function (obj) {
    };
    CashFlowComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    CashFlowComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    CashFlowComponent.prototype.getReportData = function () {
        this.reportType = 1;
        this.getReportData1();
        this.getReportData2();
    };
    CashFlowComponent.prototype.getReportData1 = function () {
        var _this = this;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.end_date).format('YYYY-MM-DD');
    ...
    CashFlowComponent.prototype.getReportData2 = function () {
        var _this = this;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.end_date).format('YYYY-MM-DD');
        ...
        this.spinner.show();
        this.admin.postDataApi('graphs/cash-flows', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.reportData = r['data'];
            _this.items = [];
            for (var index = 0; index < _this.reportData['expected'].length; index++) {
                var element = _this.reportData['expected'][index];
                // array to export
                var obj = { label: element.label, expected: element.y, actual: _this.reportData['actual'][index].y };
    ...
    CashFlowComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            animationEnabled: true,
    ...
    CashFlowComponent.prototype.plotData1 = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer1', {
            animationEnabled: true,
            exportFileName: 'cash-flow',
            exportEnabled: true,
            title: {},
    ...
    CashFlowComponent.prototype.plotData2 = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer2', {
            animationEnabled: true,
            exportFileName: 'cash-flow',
            exportEnabled: true,
            title: {},
    ...
    CashFlowComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
    ...
    CashFlowComponent.prototype.exportData = function () {
        if (this.items) {
            var finalData = [];
    ...
    // will be used in case of excel
    CashFlowComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    CashFlowComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    CashFlowComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./cash-flow.component.html */ "./src/app/layout/collection-report/cash-flow/cash-flow.component.html"),
            styles: [__webpack_require__(/*! ./cash-flow.component.css */ "./src/app/layout/collection-report/cash-flow/cash-flow.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
...
/***/ "./src/app/layout/collection-report/collection-report.component.css":
/*!**************************************************************************!*\
  !*** ./src/app/layout/collection-report/collection-report.component.css ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9jb2xsZWN0aW9uLXJlcG9ydC9jb2xsZWN0aW9uLXJlcG9ydC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/layout/collection-report/collection-report.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/layout/collection-report/collection-report.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/collection-report/collection-report.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/layout/collection-report/collection-report.component.ts ***!
  \*************************************************************************/
/*! exports provided: CollectionReportComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CollectionReportComponent", function() { return CollectionReportComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var CollectionReportComponent = /** @class */ (function () {
    ...
    CollectionReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./collection-report.component.html */ "./src/app/layout/collection-report/collection-report.component.html"),
            styles: [__webpack_require__(/*! ./collection-report.component.css */ "./src/app/layout/collection-report/collection-report.component.css")]
        }),
...
/*!**********************************************************************!*\
  !*** ./src/app/layout/collection-report/collection-report.module.ts ***!
  \**********************************************************************/
/*! exports provided: CollectionReportModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CollectionReportModule", function() { return CollectionReportModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _general_general_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./general/general.component */ "./src/app/layout/collection-report/general/general.component.ts");
/* harmony import */ var _model_model_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./model/model.component */ "./src/app/layout/collection-report/model/model.component.ts");
/* harmony import */ var _concept_concept_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./concept/concept.component */ "./src/app/layout/collection-report/concept/concept.component.ts");
/* harmony import */ var _monthly_monthly_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./monthly/monthly.component */ "./src/app/layout/collection-report/monthly/monthly.component.ts");
/* harmony import */ var _collection_report_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./collection-report.component */ "./src/app/layout/collection-report/collection-report.component.ts");
/* harmony import */ var _sales_trend_sales_trend_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./sales-trend/sales-trend.component */ "./src/app/layout/collection-report/sales-trend/sales-trend.component.ts");
/* harmony import */ var _sales_report_sales_report_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./sales-report/sales-report.component */ "./src/app/layout/collection-report/sales-report/sales-report.component.ts");
/* harmony import */ var _sales_booking_sales_booking_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./sales-booking/sales-booking.component */ "./src/app/layout/collection-report/sales-booking/sales-booking.component.ts");
/* harmony import */ var _commission_income_commission_income_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./commission-income/commission-income.component */ "./src/app/layout/collection-report/commission-income/commission-income.component.ts");
/* harmony import */ var _app_unapproved_app_unapproved_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./app-unapproved/app-unapproved.component */ "./src/app/layout/collection-report/app-unapproved/app-unapproved.component.ts");
/* harmony import */ var _arrear_report_arrear_report_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./arrear-report/arrear-report.component */ "./src/app/layout/collection-report/arrear-report/arrear-report.component.ts");
/* harmony import */ var _cash_flow_cash_flow_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./cash-flow/cash-flow.component */ "./src/app/layout/collection-report/cash-flow/cash-flow.component.ts");
/* harmony import */ var _project_report_project_report_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./project-report/project-report.component */ "./src/app/layout/collection-report/project-report/project-report.component.ts");
/* harmony import */ var _buyer_report_buyer_report_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./buyer-report/buyer-report.component */ "./src/app/layout/collection-report/buyer-report/buyer-report.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    // }
    {
        path: 'general-report', component: _general_general_component__WEBPACK_IMPORTED_MODULE_11__["GeneralComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'monthly-report', component: _monthly_monthly_component__WEBPACK_IMPORTED_MODULE_14__["MonthlyComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'model-report', component: _model_model_component__WEBPACK_IMPORTED_MODULE_12__["ModelComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'concept-report', component: _concept_concept_component__WEBPACK_IMPORTED_MODULE_13__["ConceptComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'arrear-report', component: _arrear_report_arrear_report_component__WEBPACK_IMPORTED_MODULE_21__["ArrearReportComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'sales-report', component: _sales_report_sales_report_component__WEBPACK_IMPORTED_MODULE_17__["SalesReportComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'sales-trend', component: _sales_trend_sales_trend_component__WEBPACK_IMPORTED_MODULE_16__["SalesTrendComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'sales-booking', component: _sales_booking_sales_booking_component__WEBPACK_IMPORTED_MODULE_18__["SalesBookingComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'commission-income', component: _commission_income_commission_income_component__WEBPACK_IMPORTED_MODULE_19__["CommissionIncomeComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'approved-unapproved', component: _app_unapproved_app_unapproved_component__WEBPACK_IMPORTED_MODULE_20__["AppUnapprovedComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'cash-flow-report', component: _cash_flow_cash_flow_component__WEBPACK_IMPORTED_MODULE_22__["CashFlowComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'project-report', component: _project_report_project_report_component__WEBPACK_IMPORTED_MODULE_23__["ProjectReportComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    },
    {
        path: 'buyer-report', component: _buyer_report_buyer_report_component__WEBPACK_IMPORTED_MODULE_24__["BuyerReportComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_8__["AclUserGuard"]], data: { roles: ['Collection Reports', 'can_read', ''] }
    }
];
var CollectionReportModule = /** @class */ (function () {
    function CollectionReportModule() {
    }
    CollectionReportModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                primeng_primeng__WEBPACK_IMPORTED_MODULE_10__["CalendarModule"],
            ...
            declarations: [_collection_report_component__WEBPACK_IMPORTED_MODULE_15__["CollectionReportComponent"], _general_general_component__WEBPACK_IMPORTED_MODULE_11__["GeneralComponent"], _model_model_component__WEBPACK_IMPORTED_MODULE_12__["ModelComponent"], _concept_concept_component__WEBPACK_IMPORTED_MODULE_13__["ConceptComponent"], _monthly_monthly_component__WEBPACK_IMPORTED_MODULE_14__["MonthlyComponent"], _sales_trend_sales_trend_component__WEBPACK_IMPORTED_MODULE_16__["SalesTrendComponent"], _sales_report_sales_report_component__WEBPACK_IMPORTED_MODULE_17__["SalesReportComponent"], _sales_booking_sales_booking_component__WEBPACK_IMPORTED_MODULE_18__["SalesBookingComponent"], _commission_income_commission_income_component__WEBPACK_IMPORTED_MODULE_19__["CommissionIncomeComponent"], _app_unapproved_app_unapproved_component__WEBPACK_IMPORTED_MODULE_20__["AppUnapprovedComponent"], _arrear_report_arrear_report_component__WEBPACK_IMPORTED_MODULE_21__["ArrearReportComponent"], _cash_flow_cash_flow_component__WEBPACK_IMPORTED_MODULE_22__["CashFlowComponent"], _project_report_project_report_component__WEBPACK_IMPORTED_MODULE_23__["ProjectReportComponent"], _buyer_report_buyer_report_component__WEBPACK_IMPORTED_MODULE_24__["BuyerReportComponent"]]
        })
    ], CollectionReportModule);
    return CollectionReportModule;
}());
...
/***/ "./src/app/layout/collection-report/commission-income/commission-income.component.css":
/*!********************************************************************************************!*\
  !*** ./src/app/layout/collection-report/commission-income/commission-income.component.css ***!
  \********************************************************************************************/
/*! no static exports found */
...
module.exports = ".filters{\n    padding: 30px 20px 60px 20px;\n}\nbutton.btn.btn-primary-new.export-btn {\n    margin-bottom: 10px;\n}\n.main-table table{\n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/commission-income/commission-income.component.html":
/*!*********************************************************************************************!*\
  !*** ./src/app/layout/collection-report/commission-income/commission-income.component.html ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/collection-report/commission-income/commission-income.component.ts":
/*!*******************************************************************************************!*\
  !*** ./src/app/layout/collection-report/commission-income/commission-income.component.ts ***!
  \*******************************************************************************************/
/*! exports provided: CommissionIncomeComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommissionIncomeComponent", function() { return CommissionIncomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/assets/js/canvasjs.min.js */ "./src/assets/js/canvasjs.min.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/admin.service */ "./src/app/services/admin.service.ts");
...
var EXCEL_TYPE = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
var EXCEL_EXTENSION = '.xlsx';
var CommissionIncomeComponent = /** @class */ (function () {
    function CommissionIncomeComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    CommissionIncomeComponent.prototype.onSelect = function (event) { };
    CommissionIncomeComponent.prototype.ngOnInit = function () {
        this.reportType = 1;
    ...
    CommissionIncomeComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    CommissionIncomeComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    CommissionIncomeComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    CommissionIncomeComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    CommissionIncomeComponent.prototype.onSelectAll = function (obj) {
    };
    CommissionIncomeComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    CommissionIncomeComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    CommissionIncomeComponent.prototype.onSelectCommission = function (isSelected, obj) {
        if (isSelected) {
            // this.getProperties(obj.id);
            // this.selectedCommissions()
        }
    ...
    CommissionIncomeComponent.prototype.getReportData = function () {
        var _this = this;
        this.reportType = 1;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        ...
        if (this.selectedCommissions) {
            var d = this.selectedCommissions.map(function (o) { return o.id; });
        ...
        this.spinner.show();
        this.admin.postDataApi('graphs/sozu-commission-income', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.items = [];
            _this.reportData = r['data'];
            for (var index = 0; index < _this.reportData.commission.length; index++) {
                var e = _this.reportData.commission[index];
                var obj = { label: e.label, commission: e.y, iva_amount: _this.reportData.iva_amount[index].y };
                _this.items.push(obj);
            }
            _this.plotData();
            _this.plotData1();
    ...
    CommissionIncomeComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            animationEnabled: true,
    ...
    CommissionIncomeComponent.prototype.plotData1 = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer1', {
            animationEnabled: true,
            exportFileName: 'commission-report',
            exportEnabled: true,
    ...
    CommissionIncomeComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
        this.selectedCurrencies = [];
    ...
    CommissionIncomeComponent.prototype.exportData = function () {
        if (this.items) {
            var finalData = [];
            for (var index = 0; index < this.items.length; index++) {
                var p = this.items[index];
    ...
    // will be used in case of excel
    CommissionIncomeComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    CommissionIncomeComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    CommissionIncomeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-commission-income',
            template: __webpack_require__(/*! ./commission-income.component.html */ "./src/app/layout/collection-report/commission-income/commission-income.component.html"),
            styles: [__webpack_require__(/*! ./commission-income.component.css */ "./src/app/layout/collection-report/commission-income/commission-income.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
    ], CommissionIncomeComponent);
    return CommissionIncomeComponent;
}());
...
/***/ "./src/app/layout/collection-report/concept/concept.component.css":
/*!************************************************************************!*\
  !*** ./src/app/layout/collection-report/concept/concept.component.css ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = ".text-bold {\n    font-weight: 600;\n    background-color: #F9F9F9;\n}\n\n\n/* freeze first col and row */\n\n\n.main-table{\n  height: 700px;\n}\n\n\ntable.table-striped.quick-table th {\n    width: 190px;\n  }\n\n\ntable.table-striped.quick-table {\n    table-layout: fixed;\n    width:100%;\n  }\n\n\ntable.table-striped.quick-table th:nth-child(1), \n  table.table-striped.quick-table th:nth-child(2),\n  table.table-striped.quick-table th:nth-child(3),\n  table.table-striped.quick-table thead tr th \n  {\n    position:-webkit-sticky;\n    position:sticky;\n    left:0;\n    top: 0;\n    z-index:1;\n    background-color: #00B96F;\n    color: #fff;\n  }\n\n\ntable.table-striped.quick-table th:first-child {\n    z-index:2;\n  }\n\n\ntable.table-striped.edit-table th:first-child{\n    background-color: #00B96F;\n    color: #fff;\n  }\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/concept/concept.component.html":
/*!*************************************************************************!*\
  !*** ./src/app/layout/collection-report/concept/concept.component.html ***!
  \*************************************************************************/
/*! no static exports found */
...
var ConceptComponent = /** @class */ (function () {
    function ConceptComponent(constant, admin, spinner, translate) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
    ...
    ConceptComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    ConceptComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    ConceptComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    ConceptComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    ConceptComponent.prototype.onSelectAll = function (obj) {
    };
    ConceptComponent.prototype.getAllPaymentChoices = function () {
        var _this = this;
        this.admin.postDataApi('getPaymentChoices', {})
            .subscribe(function (success) {
            _this.paymentChoices = success.data;
    ...
    ConceptComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    ConceptComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
    ...
    ConceptComponent.prototype.onSelectDeveloper = function (isSelected, obj) {
        this.projects = [];
        this.selctedProjects = [];
        if (isSelected) {
            this.searchBuilding(obj.id);
    ...
    ConceptComponent.prototype.searchBuilding = function (developer_id) {
        var _this = this;
        this.spinner.show();
        var input = {
            'developer_id': developer_id
    ...
    ConceptComponent.prototype.getListing = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM-DD');
        ...
        if (this.selctedConcepts) {
            var d = this.selctedConcepts.map(function (o) { return o.id; });
            input.payment_choice_id = d;
        }
        this.admin.postDataApi('generateCollectionConceptReport', input).subscribe(function (success) {
            _this.paymentConcepts = success['payment_concepts'];
            _this.data = success['data'];
            _this.allMonths = [];
            var months = [];
            for (var property in _this.data) {
                if (property) {
                    ...
                    _this.allMonths.push(property);
                }
            }
            _this.colCount = _this.allMonths.length - 6;
            _this.finalData = [];
            var _loop_1 = function (index) {
                var obj = {};
                obj['p'] = _this.paymentConcepts[index];
                obj['key'] = 0;
                var total = 0;
                var _loop_2 = function (i) {
                    var month = _this.allMonths[i];
                    var d = 0;
                    _this.data[month].map(function (o) {
                ...
                for (var i = 0; i < _this.allMonths.length; i++) {
                    _loop_2(i);
                }
                obj['total'] = total;
                _this.finalData.push(obj);
            };
            ...
            var _loop_3 = function (i) {
                months.map(function (e) {
                    e.value = e.value + _this.finalData[i][e.key];
                });
                grandTotal = grandTotal + _this.finalData[i].total;
            };
            for (var i = 0; i < _this.finalData.length; i++) {
                _loop_3(i);
            }
            var obj1 = { p: 'Total', key: 1, total: grandTotal };
            months.map(function (m) {
                obj1[m.key] = m.value;
            });
            _this.finalData.push(obj1);
            _this.spinner.hide();
        }, function (error) {
            _this.spinner.hide();
        });
    };
    ConceptComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selectedDevelopers = [];
    ...
    ConceptComponent.prototype.exportData = function () {
        if (this.finalData) {
            var data = [];
            for (var index = 0; index < this.finalData.length; index++) {
    ...
    // will be used in case of excel
    ConceptComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    ConceptComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    ConceptComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./concept.component.html */ "./src/app/layout/collection-report/concept/concept.component.html"),
            styles: [__webpack_require__(/*! ./concept.component.css */ "./src/app/layout/collection-report/concept/concept.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
...
/***/ "./src/app/layout/collection-report/general/general.component.css":
/*!************************************************************************!*\
  !*** ./src/app/layout/collection-report/general/general.component.css ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = ".text-bold {\n    font-weight: 600;\n    border-top: 1px solid #d6d6d6;\n    border-bottom: 1px solid #d6d6d6;\n}\n\n/* freeze first col and row */\n\n.main-table{\n  height: 700px;\n}\n\ntable.table-striped.quick-table th, table.table-striped.quick-table td {\n  width: 190px;\n}\n\ntable.table-striped.quick-table {\n  table-layout: fixed;\n  width:100%;\n}\n\ntable.table-striped.quick-table td:nth-child(1), table.table-striped.quick-table th:nth-child(1),\ntable.table-striped.quick-table thead tr th \n{\n  position:-webkit-sticky;\n  position:sticky;\n  left:0;\n  top: 0;\n  z-index:1;\n  background-color: #00B96F;\n  color: #fff;\n}\n\ntable.table-striped.quick-table th:first-child {\n  z-index:20;\n}\n\n/* freeze first col and row */\n\n.sticky{\n  position: sticky;  \n  position: -webkit-sticky;  \n  top: 46px;\n  overflow: hidden;\n  z-index: 100000;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/general/general.component.html":
/*!*************************************************************************!*\
  !*** ./src/app/layout/collection-report/general/general.component.html ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n    <div class=\"row\">\n       <div class=\"col-md-4\">\n             <div class=\"form-group\">\n                    <h5>{{'collectionReport.generalReport' | translate}}</h5>\n             </div>\n       </div>\n    </div>\n  \n    <hr>\n    \n  <div class=\"row\">\n    <div class=\"col-lg-2 col-md-2\">\n          <div class=\"form-group\">\n          <label>{{'collectionReport.start_date' | translate}}</label>\n          <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" \n            [maxDate]=\"input.end_date\" \n            showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n          </div>\n    </div>\n    <div class=\"col-lg-2 col-md-2\">\n          <div class=\"form-group\">\n            <label>{{'collectionReport.end_date' | translate}}</label>\n            <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\" [maxDate]=\"today\" \n              showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n          </div>\n    </div>\n    <div class=\"col-lg-2 col-md-2\">\n          <div class=\"form-group\">\n             <label>{{'collectionReport.developer' | translate}}</label>\n             <div class=\"clearfix\"></div>\n              <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                    [placeholder]=\"''\"\n                    [data]=\"developers\"\n                    [(ngModel)]=\"selectedDevelopers\"\n                    [settings]=\"singleDropdownSettings\"\n                    (onDeSelect)=\"onSelectDeveloper(0, $event)\"\n                    (onSelect)=\"onSelectDeveloper(1, $event)\"\n                    (onSelectAll)=\"onSelectAll($event)\">\n              </ng-multiselect-dropdown>\n          <div class=\"clearfix\"></div>\n          </div>\n    </div>\n  \n    <div class=\"col-lg-2 col-md-2\">\n          <div class=\"form-group\">\n             <label>{{'collectionReport.project' | translate}}</label>\n          <div class=\"clearfix\"></div>\n              <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                    [placeholder]=\"''\"\n                    [data]=\"projects\"\n                    [(ngModel)]=\"selctedProjects\"\n                    [settings]=\"multiDropdownSettings\"\n                    (onDeSelect)=\"onItemDeSelect('projects', $event)\"\n                    (onSelect)=\"onItemSelect('selctedProjects', $event)\"\n                    (onSelectAll)=\"onSelectAll($event)\">\n              </ng-multiselect-dropdown>\n          <div class=\"clearfix\"></div>\n          </div>\n    </div>\n  \n    <div class=\"col-lg-2 col-md-2\">\n       <div class=\"form-group marginB0\">\n          <label>{{'collectionReport.currency' | translate}}</label>\n             <div class=\"clearfix\"></div>\n                 <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                       [placeholder]=\"''\"\n                       [data]=\"currencies\"\n                       [(ngModel)]=\"selectedCurrencies\"\n                       [settings]=\"multiDropdownSettings\"\n                       (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                       (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                       (onSelectAll)=\"onSelectAll($event)\">\n                 </ng-multiselect-dropdown>\n             <div class=\"clearfix\"></div>      \n       </div>\n    </div>\n    \n    <div class=\"col-lg-1 col-md-2\">\n          <div class=\"form-group btn-cont\">\n          <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n          <button type=\"button\" (click)=\"getListing()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n          </div>\n    </div>\n  \n    <div class=\"col-lg-1 col-md-2\">\n          <div class=\"form-group btn-cont\">\n          <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n          <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n          </div>\n    </div>\n  </div>\n  \n       <div class=\"cust-tabs\">\n        <div class=\"row flex-wrap-reverse\">\n        \n        <div class=\"col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12\">\n        </div>\n        <div class=\"col-xl-2 col-lg-12 col-md-12 col-sm-12 col-12\">\n        <div class=\"add-new pull-right\">\n                    <!-- *ngIf=\"admin?.admin_acl['Project Management']?.can_create==1 || admin?.permissions?.can_data_collector==1\"  -->\n              <!-- <a \n              class=\"btn\" href=\"javascript://\" (click)=\"exportData()\">{{'collectionReport.export' | translate}}</a> -->\n        </div>\n        </div>\n        </div>\n       <div class=\"tab-content white-bg\">\n          <div class=\"tab-pane active\">\n             <div class=\"tabel-section\">\n                <div class=\"table-responsive main-table\">\n                  <table class=\"table table-striped table-align-left quick-table\">\n                        <thead>\n                            <tr>\n                               <th style=\"width:150px; text-align:left; z-index:100;\">\n                                     <b>{{'collectionReport.monthsOfSchedulePayments' | translate}}</b>\n                               </th>\n                               <th *ngFor=\"let month of allMonths\" style=\"width:150px; text-align:left;\">\n                                     <b>{{month | date:'MMM, y'}}</b>\n                               </th>\n                               <th style=\"width:150px; text-align:left;\">\n                                     <b>{{'collectionReport.grandTotal' | translate}}</b>\n                               </th>\n                            </tr>\n                        </thead>\n                        <tbody>\n                            <tr *ngFor=\"let item of finalData; let i=index\" [ngClass]=\"{'text-bold' : item.key==1}\">\n                            <td><b>{{item?.firstCol}}</b></td>\n                            <td *ngFor=\"let m of allMonths\" >\n                                  <span>{{item[m] ? ((item[m] || 0) | currency) : '' }}</span>\n                              </td>\n                              <td><span>{{(item?.t || 0) | currency}}</span></td>\n                            </tr>\n                        </tbody>\n                     </table>\n                   <div class=\"padding20 center\" *ngIf=\"finalData?.length == 0\">\n                         <img src=\"assets/img/404-error.png\">\n                   </div>\n                </div>\n             </div>\n          </div>\n       </div>\n    </div>\n  </div>\n  "

/***/ }),

/***/ "./src/app/layout/collection-report/general/general.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/layout/collection-report/general/general.component.ts ***!
  \***********************************************************************/
...
var GeneralComponent = /** @class */ (function () {
    function GeneralComponent(constant, admin, spinner, translate, datePipe, titleCase, toastr) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
    ...
    GeneralComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    GeneralComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    GeneralComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    GeneralComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    GeneralComponent.prototype.onSelectAll = function (obj) {
    };
    GeneralComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    GeneralComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
    ...
    GeneralComponent.prototype.onSelectDeveloper = function (isSelected, obj) {
        if (isSelected) {
            this.searchBuilding(obj.id);
        }
        else {
    ...
    GeneralComponent.prototype.searchBuilding = function (developer_id) {
        var _this = this;
        this.spinner.show();
        var input = {
            developer_id: developer_id
    ...
    GeneralComponent.prototype.getListing = function () {
        var _this = this;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM');
        input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.end_date).format('YYYY-MM-DD');
        var a = moment__WEBPACK_IMPORTED_MODULE_1__(input.end_date);
        var b = moment__WEBPACK_IMPORTED_MODULE_1__(input.start_date);
        var f = a.diff(b, 'days');
        input.start_date = input.start_date + '-01';
        if (f > 365) {
        ...
        this.spinner.show();
        this.admin.postDataApi('generateCollectionGeneralReport', input).subscribe(function (success) {
            _this.data = success['data'];
            _this.finalData = [];
            _this.allMonths = [];
            var firstCol = [];
            ...
            for (var property in _this.data[_this.allMonths[0]]) {
                if (property) {
                    firstCol.push(property);
                }
            }
            var obj = {};
            for (var index = 0; index < firstCol.length; index++) {
                var element = firstCol[index];
                obj = {
                    'firstCol': element,
                    key: 0
                };
                for (var i = 0; i < _this.allMonths.length; i++) {
                    var ele = _this.allMonths[i];
                    obj[ele] = _this.data[ele][element] ? _this.data[ele][element][0]['total_amount'] : '';
                }
            ...
            for (var index = 0; index < _this.allMonths.length; index++) {
                var element = _this.allMonths[index];
                var t_2 = 0;
                for (var i = 0; i < _this.finalData.length; i++) {
                    var e = _this.finalData[i];
            ...
            for (var i = 0; i < _this.finalData.length; i++) {
                ...
                if (e['firstCol'].includes('-')) {
                    e['firstCol'] = _this.datePipe.transform(e['firstCol'], 'MMM, y');
                }
                else {
                    e['firstCol'] = _this.titleCase.transform(e['firstCol'].replace('_', ' '));
                }
            }
            f['t'] = t;
            _this.finalData.push(f);
            _this.spinner.hide();
        }, function (error) {
            _this.spinner.hide();
        });
    };
    GeneralComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selectedDevelopers = [];
    ...
    GeneralComponent.prototype.exportData = function () {
        var _this = this;
        if (this.finalData) {
            var data = [];
            var c = this.translate.instant('collectionReport.monthsOfSchedulePayments');
            // header
            var h2_1 = [];
            this.allMonths.forEach(function (r) {
                h2_1.push(_this.datePipe.transform(r, 'MMM, y'));
            });
            var h = ['Months of Schedule Payments'].concat(h2_1, ['Grand Total']);
            for (var index = 0; index < this.finalData.length; index++) {
                var p = this.finalData[index];
    ...
    // will be used in case of excel
    GeneralComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_9__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
        };
    ...
    GeneralComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
            ...
            today.getSeconds();
        fileName = fileName + date;
        file_saver__WEBPACK_IMPORTED_MODULE_8__["saveAs"](data, fileName + EXCEL_EXTENSION);
    };
    GeneralComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-general',
            template: __webpack_require__(/*! ./general.component.html */ "./src/app/layout/collection-report/general/general.component.html"),
            styles: [__webpack_require__(/*! ./general.component.css */ "./src/app/layout/collection-report/general/general.component.css")],
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["DatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["TitleCasePipe"]]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
...
/***/ "./src/app/layout/collection-report/model/model.component.css":
/*!********************************************************************!*\
  !*** ./src/app/layout/collection-report/model/model.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = ".text-bold {\n    font-weight: 600;\n    background-color: #F9F9F9;\n}\n.table td, .table th {\n    width: 10%;\n    text-align: left;\n}\n/* freeze first col and row */\n.main-table{\n  height: 600px;\n}\ntable.table-striped.quick-table th, table.table-striped.quick-table td {\n  width: 190px;\n}\ntable.table-striped.quick-table {\n  table-layout: fixed;\n  width:100%;\n}\n/* table.table-striped.quick-table td:nth-child(1),  */\ntable.table-striped.quick-table th:nth-child(1),\ntable.table-striped.quick-table thead tr th \n{\n  position:-webkit-sticky;\n  position:sticky;\n  left:0;\n  top: 0;\n  z-index:1;\n  background-color: #00B96F;\n  color: #fff;\n}\ntable.table-striped.quick-table th:first-child {\n  z-index:20;\n}\n/* freeze first col and row */\n.sticky{\n  position: sticky;  \n  position: -webkit-sticky;  \n  top: 46px;\n  overflow: hidden;\n  z-index: 100000;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/model/model.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/layout/collection-report/model/model.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n    <div class=\"row\">\n       <div class=\"col-md-4\">\n             <div class=\"form-group\">\n                <h5>{{'collectionReport.modelReport' | translate}}</h5>\n             </div>\n       </div>\n    </div>\n\n    <hr>\n  \n<div class=\"row\">\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.developer' | translate}}</label>\n                     <div class=\"clearfix\"></div>\n                     <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                           [placeholder]=\"''\"\n                           [data]=\"developers\"\n                           [(ngModel)]=\"selectedDevelopers\"\n                           [settings]=\"singleDropdownSettings\"\n                           (onDeSelect)=\"onSelectDeveloper(0, $event)\"\n                           (onSelect)=\"onSelectDeveloper(1, $event)\"\n                           (onSelectAll)=\"onSelectAll($event)\">\n                     </ng-multiselect-dropdown>\n                 <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.project' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"projects\"\n                              [(ngModel)]=\"selctedProjects\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectProject(0, $event)\"\n                              (onSelect)=\"onSelectProject(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.tower' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"buildingTowers\"\n                              [(ngModel)]=\"selectedTowers\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectTower(0, $event)\"\n                              (onSelect)=\"onSelectTower(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.floor' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"floors\"\n                              [(ngModel)]=\"selectedFloors\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectFloor(0, $event)\"\n                              (onSelect)=\"onSelectFloor(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.property' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"properties\"\n                              [(ngModel)]=\"selectedProperties\"\n                              [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('properties', $event)\"\n                              (onSelect)=\"onItemSelect('selectedProperties', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n               <div class=\"form-group marginB0\">\n                  <label>{{'collectionReport.currency' | translate}}</label>\n                     <div class=\"clearfix\"></div>\n                         <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                               [placeholder]=\"''\"\n                               [data]=\"currencies\"\n                               [(ngModel)]=\"selectedCurrencies\"\n                               [settings]=\"multiDropdownSettings\"\n                               (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                               (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                               (onSelectAll)=\"onSelectAll($event)\">\n                         </ng-multiselect-dropdown>\n                     <div class=\"clearfix\"></div>         \n               </div>\n            </div>\n            \n          </div>\n\n          <div class=\"row\">\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                  <label>{{'collectionReport.start_date' | translate}}</label>\n                  <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" \n                    showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                    <label>{{'collectionReport.end_date' | translate}}</label>\n                    <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\" [maxDate]=\"today\" \n                      showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                  </div>\n            </div>\n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                  <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                  <button type=\"button\" (click)=\"getListing()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                  <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                  <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n                  </div>\n            </div>\n          </div>\n  \n       <div class=\"cust-tabs\">\n        <div class=\"row flex-wrap-reverse\">\n        \n        <div class=\"col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12\">\n        </div>\n        <div class=\"col-xl-2 col-lg-12 col-md-12 col-sm-12 col-12\">\n        <div class=\"add-new pull-right\">\n                    <!-- *ngIf=\"admin?.admin_acl['Project Management']?.can_create==1 || admin?.permissions?.can_data_collector==1\"  -->\n              <!-- <a \n              class=\"btn\" href=\"javascript://\" routerLink=\"/dashboard/collections/add-collection/0\">{{'viewCollections.addNew' | translate}}</a> -->\n        </div>\n        </div>\n        </div>\n       <div class=\"tab-content white-bg\">\n          <div class=\"tab-pane active\">\n             <div class=\"tabel-section\">\n                <div id=\"accordion\" class=\"table-responsive main-table\">\n                   <table class=\"table table-striped table-align-left quick-table\">\n                      <thead>\n                          <tr class=\"text-bold\">\n                              <th>\n                                  <b>{{'collectionReport.model' | translate}}</b>\n                              </th>\n                              <th>\n                                  <b>{{'collectionReport.status' | translate}}</b>\n                              </th>\n                              <th>\n                                    <div class=\"table-search\">\n                                    <b>{{'collectionReport.propertyName' | translate}}</b>\n                                    <div class=\"searh-3\">\n                                          <input autocomplete=\"off\" class=\"width100px\" type=\"text\" [(ngModel)]=\"input.property_name\" (keyup.enter)=\"getListing()\" >\n                                          <button *ngIf=\"input.property_name\" (click)=\"getListing()\"><i class=\"fa fa-search\"></i></button>\n                                    </div>\n                                    </div>\n                              </th>\n                              <th>\n                                  <div class=\"table-search\">\n                                    <b>{{'collectionReport.buyerName' | translate}}</b>\n                                    <div class=\"searh-3\">\n                                       <input autocomplete=\"off\" class=\"width100px\" type=\"text\" [(ngModel)]=\"input.buyer_name\" (keyup.enter)=\"getListing()\" >\n                                       <button *ngIf=\"input.buyer_name\" (click)=\"getListing()\"><i class=\"fa fa-search\"></i></button>\n                                    </div>\n                                 </div>\n                              </th>\n                              <th>\n                                  <div class=\"table-search\">\n                                    <b>{{'collectionReport.sellerName' | translate}}</b>\n                                    <div class=\"searh-3\">\n                                       <input autocomplete=\"off\" class=\"width100px\" type=\"text\" [(ngModel)]=\"input.seller_name\" (keyup.enter)=\"getListing()\" >\n                                       <button *ngIf=\"input.seller_name\" (click)=\"getListing()\"><i class=\"fa fa-search\"></i></button>\n                                    </div>\n                                 </div>\n                              </th>\n                              <th>\n                                  <b>{{'collectionReport.price' | translate}}</b>\n                              </th>\n                              <th>\n                                    <b>{{'collectionReport.paid' | translate}}</b>\n                              </th>\n                              <th>\n                                    <b>{{'collectionReport.remaining' | translate}}</b>\n                              </th>\n                              <th>\n                                   <b>{{'collectionReport.penalty' | translate}}</b>\n                              </th>\n                              <th>\n                                    <b>{{'collectionReport.total' | translate}}</b>\n                              </th>\n                           </tr>\n                      </thead>\n                      <tbody *ngFor=\"let final of finalData; let i=index\">\n                        <tr class=\"text-bold\">\n                          <td><span>\n                                <a class=\"color-changed\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse{{i}}\">\n                                    <span><i class=\"fa fa-plus-circle\"></i> </span>{{final?.name}}\n                                </a>\n                              </span></td>\n                          <td>-</td>\n                          <td>-</td>\n                          <td>-</td>\n                          <td>-</td>\n                          <td><span>{{(final?.deal_price || 0 | currency)}}</span></td>\n                           <td><span>{{(final?.received || 0) | currency}}</span></td>\n                           <td><span>{{(final?.remaining || 0) | currency}}</span></td>\n                           <td><span>{{(final?.penalty || 0) | currency}}</span></td>\n                           <td><span>{{((final?.received || 0) + (final?.remaining || 0)) | currency}}</span></td>\n                         </tr>\n                         <tr id=\"collapse{{i}}\" class=\"panel-collapse collapse\">\n                           <td colspan=\"10\">\n                              <table [style.width]=\"'100%'\">\n                                    <thead></thead>\n                                    <tbody>\n                                          <tr *ngFor=\"let item of final.data\"\n                                          [style.background]=\"item.is_cancelled ? '#80808057' : ''\">\n                                             <td><span>\n                                                   <a class=\"color-changed\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse{{i}}\">\n                                                       {{(item?.model || ('table.tr.td.NA' | translate)) | uppercase}}\n                                                   </a>\n                                                 </span></td>\n                                             <td><span>{{(item?.is_approved == 1 ? 'Approved' : (item.is_approved == 0 ? 'Unapproved' : '')) | uppercase}}</span></td>\n                                             <td><span>{{item?.name || ''}}</span></td>\n                                             <td><span>{{item?.buyer_name || ('table.tr.td.NA' | translate)}}</span></td>\n                                          <td><span>{{item?.seller_name || ('table.tr.td.NA' | translate)}}</span></td>\n                                          <td><span>{{(item?.deal_price || 0 | currency)}}</span></td>\n                                              <td><span>{{(item?.received || 0) | currency}}</span></td>\n                                              <td *ngIf=\"item.is_cancelled!=1\"><span>{{((item?.deal_price || 0) + (item?.penalty || 0) - (item?.received || 0)) | currency}}</span></td>\n                                              <td *ngIf=\"item.is_cancelled==1\"><span>$0</span></td>\n                                              <td><span>{{(item?.penalty || 0) | currency}}</span></td>\n                                              <td><span>{{((item?.deal_price || 0) + (item?.penalty || 0)) | currency}}</span></td>\n                                          </tr>\n                                    </tbody>\n                              </table>\n                           </td>\n                          </tr>\n                      </tbody>\n                   </table>\n                   <div class=\"padding20 center\" *ngIf=\"finalData?.length == 0\">\n                         <img src=\"assets/img/404-error.png\">\n                   </div>\n                </div>\n             </div>\n          </div>\n       </div>\n    </div>\n  </div>\n  "

/***/ }),

/***/ "./src/app/layout/collection-report/model/model.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/layout/collection-report/model/model.component.ts ***!
  \*******************************************************************/
...
var ModelComponent = /** @class */ (function () {
    function ModelComponent(constant, admin, spinner, translate) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
    ...
    ModelComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    ModelComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    ModelComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    ModelComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    ModelComponent.prototype.onSelectAll = function (obj) {
    };
    ModelComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    ModelComponent.prototype.onSelectDeveloper = function (isSelected, obj) {
        this.projects = [];
        this.selctedProjects = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
    ...
    ModelComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
    ...
    ModelComponent.prototype.onSelectProject = function (isSelected, obj) {
        this.input.building_id = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
        this.selectedProperties = [];
    ...
    ModelComponent.prototype.searchBuilding = function (developer_id) {
        var _this = this;
        this.spinner.show();
        var input = {
            developer_id: developer_id
    ...
    ModelComponent.prototype.setBuildingId = function (buildingId) {
        var _this = this;
        this.projects.map(function (r) {
            if (r.id == buildingId) {
                _this.buildingTowers = r.building_towers ? r.building_towers : [];
    ...
    ModelComponent.prototype.onSelectTower = function (isSelected, obj) {
        this.input.building_towers_id = [];
        this.selectedFloors = [];
        this.selectedProperties = [];
        if (isSelected) {
    ...
    ModelComponent.prototype.setTower = function (building_towers_id) {
        var _this = this;
        this.floors = [];
        for (var index = 0; index < this.projects.length; index++) {
            if (this.projects[index].id == this.input.building_id) {
    ...
    ModelComponent.prototype.onSelectFloor = function (isSelected, obj) {
        this.properties = [];
        this.selectedProperties = [];
        if (isSelected) {
            this.getProperties(obj.id);
    ...
    ModelComponent.prototype.getProperties = function ($event) {
        var _this = this;
        var input = {};
        if (this.selctedProjects) {
            var d = this.selctedProjects.map(function (o) { return o.id; });
    ...
    ModelComponent.prototype.getListing = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM-DD');
        ...
        this.admin.postDataApi('generateCollectionModelReport', input).subscribe(function (success) {
            _this.data = success['data'];
            _this.model = [];
            _this.finalData = [];
            for (var property in _this.data) {
                if (property) {
                    console.log(_this.data[property]);
                    var deal_price = _this.data[property].reduce(function (a, b) { return a + (b['deal_price'] || 0); }, 0);
                    var penalty = _this.data[property].reduce(function (a, b) { return a + (b['penalty'] || 0); }, 0);
                    var received = _this.data[property].reduce(function (a, b) { return a + (b['received'] || 0); }, 0);
                    var c_deal_price = _this.data[property].reduce(function (a, b) { return a + (b['is_cancelled'] === 1 ? (b['deal_price'] || 0) : 0); }, 0);
                    var c_penalty = _this.data[property].reduce(function (a, b) { return a + (b['is_cancelled'] === 1 ? (b['penalty'] || 0) : 0); }, 0);
                    var c_received = _this.data[property].reduce(function (a, b) { return a + (b['is_cancelled'] === 1 ? (b['received'] || 0) : 0); }, 0);
                    var remaining = (deal_price + penalty - received) - (c_deal_price + c_penalty - c_received);
                    _this.finalData.push({
                        model: property,
                        name: 'TOTAL - ' + property,
                        ...
                        remaining: remaining,
                        penalty: penalty,
                        total: _this.data[property].reduce(function (a, b) { return a + (b['total'] || 0); }, 0),
                        data: _this.data[property]
                    });
                    // this.model.push(property);
                }
            }
            var f = _this.finalData.slice();
            _this.finalData.push({
                model: '',
                name: 'Grand Total',
                deal_price: f.reduce(function (a, b) { return a + (b['deal_price'] || 0); }, 0),
                received: f.reduce(function (a, b) { return a + (b['received'] || 0); }, 0),
                remaining: f.reduce(function (a, b) { return a + (b['remaining'] || 0); }, 0),
                penalty: f.reduce(function (a, b) { return a + (b['penalty'] || 0); }, 0),
                total: f.reduce(function (a, b) { return a + (b['total'] || 0); }, 0),
                data: null
            });
            _this.spinner.hide();
        }, function (error) {
    ...
    ModelComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selectedDevelopers = [];
    ...
    ModelComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-model',
            template: __webpack_require__(/*! ./model.component.html */ "./src/app/layout/collection-report/model/model.component.html"),
            styles: [__webpack_require__(/*! ./model.component.css */ "./src/app/layout/collection-report/model/model.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
...
/***/ "./src/app/layout/collection-report/monthly/monthly.component.css":
/*!************************************************************************!*\
  !*** ./src/app/layout/collection-report/monthly/monthly.component.css ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = ".text-bold {\n    font-weight: 600;\n}\n\n/* freeze first col and row */\n\n/* .main-table{\n  height: 700px;\n}\n  table.table-striped.quick-table th {\n    width: 190px;\n  }\n  table.table-striped.quick-table {\n    table-layout: fixed;\n    width:100%;\n  }\n  table.table-striped.quick-table th:nth-child(1), \n  table.table-striped.quick-table th:nth-child(2),\n  table.table-striped.quick-table th:nth-child(3),\n  table.table-striped.quick-table thead tr th \n  {\n    position:sticky;\n    left:0;\n    top: 0;\n    z-index:1;\n    background-color: #00B96F;\n    color: #fff;\n  }\n  table.table-striped.quick-table th:first-child {\n    z-index:2;\n  } */\n\ntable.table-striped.quick-table thead tr th {\n    background-color: #00B96F;\n    color: #fff;\n  }\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/monthly/monthly.component.html":
/*!*************************************************************************!*\
  !*** ./src/app/layout/collection-report/monthly/monthly.component.html ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n    <div class=\"row\">\n       <div class=\"col-md-4\">\n             <div class=\"form-group\">\n                <h5>{{'collectionReport.monthlyReport' | translate}}</h5>\n             </div>\n       </div>\n    </div>\n\n    <hr>\n\n    <div class=\"row\">\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.developer' | translate}}</label>\n                     <div class=\"clearfix\"></div>\n                     <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                           [placeholder]=\"''\"\n                           [data]=\"developers\"\n                           [(ngModel)]=\"selectedDevelopers\"\n                           [settings]=\"singleDropdownSettings\"\n                           (onDeSelect)=\"onSelectDeveloper(0, $event)\"\n                           (onSelect)=\"onSelectDeveloper(1, $event)\"\n                           (onSelectAll)=\"onSelectAll($event)\">\n                     </ng-multiselect-dropdown>\n                 <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.project' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"projects\"\n                              [(ngModel)]=\"selctedProjects\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectProject(0, $event)\"\n                              (onSelect)=\"onSelectProject(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.tower' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"buildingTowers\"\n                              [(ngModel)]=\"selectedTowers\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectTower(0, $event)\"\n                              (onSelect)=\"onSelectTower(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.floor' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"floors\"\n                              [(ngModel)]=\"selectedFloors\"\n                              [settings]=\"singleDropdownSettings\"\n                              (onDeSelect)=\"onSelectFloor(0, $event)\"\n                              (onSelect)=\"onSelectFloor(1, $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                     <label>{{'collectionReport.property' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"properties\"\n                              [(ngModel)]=\"selectedProperties\"\n                              [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('properties', $event)\"\n                              (onSelect)=\"onItemSelect('selectedProperties', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n               <div class=\"form-group marginB0\">\n                  <label>{{'collectionReport.currency' | translate}}</label>\n                     <div class=\"clearfix\"></div>\n                         <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                               [placeholder]=\"''\"\n                               [data]=\"currencies\"\n                               [(ngModel)]=\"selectedCurrencies\"\n                               [settings]=\"multiDropdownSettings\"\n                               (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                               (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                               (onSelectAll)=\"onSelectAll($event)\">\n                         </ng-multiselect-dropdown>\n                     <div class=\"clearfix\"></div>            \n               </div>\n            </div>\n            \n          </div>\n\n\n          <div class=\"row\">\n\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                  <label>{{'collectionReport.currentMonth' | translate}}</label>\n                  <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" \n                    showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                    <label>{{'collectionReport.buyerAsAPerson' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"buyers\"\n                              [(ngModel)]=\"selectedBuyers\"\n                              [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('buyers', $event)\"\n                              (onSelect)=\"onItemSelect('selectedBuyers', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                    <label>{{'collectionReport.buyerAsADev' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"buyersAsDev\"\n                              [(ngModel)]=\"selectedBuyerDev\"\n                              [settings]=\"multiDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('buyersAsDev', $event)\"\n                              (onSelect)=\"onItemSelect('selectedBuyerDev', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n            <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group\">\n                    <label>{{'collectionReport.buyerAsALegalRep' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                        <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                              [placeholder]=\"''\"\n                              [data]=\"legalReps\"\n                              [(ngModel)]=\"selectedLegalReps\"\n                              [settings]=\"legalRepDropdownSettings\"\n                              (onDeSelect)=\"onItemDeSelect('legalReps', $event)\"\n                              (onSelect)=\"onItemSelect('selectedLegalReps', $event)\"\n                              (onSelectAll)=\"onSelectAll($event)\">\n                        </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>\n                  </div>\n            </div>\n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                  <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                  <button type=\"button\" (click)=\"getListing()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n                  </div>\n            </div>\n          \n            <div class=\"col-lg-1 col-md-2\">\n                  <div class=\"form-group btn-cont\">\n                  <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                  <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n                  </div>\n            </div>\n          </div>\n  \n       <div class=\"cust-tabs\">\n        <div class=\"row flex-wrap-reverse\">\n        \n        <div class=\"col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12\">\n        </div>\n        <div class=\"col-xl-2 col-lg-12 col-md-12 col-sm-12 col-12\">\n        <div class=\"add-new pull-right\">\n                    <!-- *ngIf=\"admin?.admin_acl['Project Management']?.can_create==1 || admin?.permissions?.can_data_collector==1\"  -->\n              <!-- <a \n              class=\"btn\" href=\"javascript://\" routerLink=\"/dashboard/collections/add-collection/0\">{{'viewCollections.addNew' | translate}}</a> -->\n        </div>\n        </div>\n        </div>\n       <div class=\"tab-content white-bg\">\n          <div class=\"tab-pane active\">\n             <div class=\"tabel-section\">\n                <div class=\"table-responsive main-table\">\n                   <table class=\"table table-bordered table-striped table-align-left quick-table\">\n                      <thead>\n                          <tr class=\"text-bold\">\n                              <th rowspan=\"3\" style=\"width:17%; text-align:left;\">\n                                  <b>{{'collectionReport.buyerName' | translate}}</b>\n                              </th>\n                              <th rowspan=\"3\" style=\"width:17%; text-align:left;\">\n                                  <b>{{'collectionReport.sellerName' | translate}}</b>\n                              </th>\n                              <th rowspan=\"3\" style=\"width:13%; text-align:left;\">\n                                  <b>{{'collectionReport.project' | translate}}</b>\n                              </th>\n                              <th rowspan=\"3\" style=\"width:7%; text-align:left;\">\n                                  <b>{{'collectionReport.model' | translate}}</b>\n                              </th>\n                              <th rowspan=\"3\" style=\"width:7%; text-align:left;\">\n                                  <b>{{'collectionReport.propertyName' | translate}}</b>\n                              </th>\n                              <th rowspan=\"3\" style=\"width:5%; text-align:left;\">\n                                    <b>{{'collectionReport.currency' | translate}}</b></th>\n                              <th style=\"width:10%; text-align:left;\">\n                                  <b>{{'collectionReport.previousMonth' | translate}} (s)</b>\n                              </th>\n                              <th style=\"width:10%; text-align:left;\">\n                                  <b>{{'collectionReport.currentMonth' | translate}}</b>\n                              </th>\n                              <th style=\"width:10%; text-align:left;\">\n                                  <b>{{'collectionReport.nextMonth' | translate}}</b>\n                              </th>\n                           </tr>\n                           <tr>\n                              <!-- <th colspan=\"2\"><b>{{previousMonth | date:'mediumDate'}}</b></th>\n                              <th colspan=\"2\"><b>{{input.start_date | date:'mediumDate'}}</b></th>\n                              <th colspan=\"2\"><b>{{nextMonth | date:'mediumDate'}}</b></th> -->\n                              <th><b>{{'collectionReport.monthsBefore' | translate}} {{input.start_date | date:'LLL, yyyy'}}</b></th>\n                              <th><b>{{input.start_date | date:'LLL, yyyy'}}</b></th>\n                              <th><b>{{nextMonth | date:'LLL, yyyy'}}</b></th>\n                            </tr>\n                            <tr>\n                               <th><b>{{'collectionReport.outstandingAmt' | translate}}</b></th>\n                               <!-- <th><b>{{'collectionReport.currency' | translate}}</b></th> -->\n                               <th><b>{{'collectionReport.outstandingAmt' | translate}}</b></th>\n                               <!-- <th><b>{{'collectionReport.currency' | translate}}</b></th> -->\n                               <th><b>{{'collectionReport.outstandingAmt' | translate}}</b></th>\n                               <!-- <th><b>{{'collectionReport.currency' | translate}}</b></th> -->\n                             </tr>\n                      </thead>\n                      <tbody>\n                        <tr *ngFor=\"let item of finalData | paginate: { itemsPerPage: parameter.itemsPerPage, currentPage: parameter.page, totalItems: total }; let i=index\" \n                        [ngClass]=\"{'text-bold' : item.calculated==1}\">\n                          <td><span>{{item?.buyer_name || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>{{item?.seller_name || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>{{item?.project_name || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>{{item?.model || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>{{item?.property_name || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>{{item?.code || ('table.tr.td.NA' | translate)}}</span></td>\n                          <td><span>${{((item?.previous_month_amount || 0) + (item?.previous_month_penalty || 0) - (item?.previous_month_paid || 0)) | roundNumber}}</span></td>\n                          <!-- <td><span>{{item?.code || ('table.tr.td.NA' | translate)}}</span></td> -->\n                          <td><span>${{((item?.curent_month_amount || 0) + (item?.curent_month_penalty || 0) - (item?.curent_month_paid || 0)) | roundNumber}}</span></td>\n                          <!-- <td><span>{{item?.code || ('table.tr.td.NA' | translate)}}</span></td> -->\n                          <td><span>${{((item?.next_month_amount || 0) + (item?.next_month_penalty || 0) - (item?.next_month_paid || 0)) | roundNumber}}</span></td>\n                          <!-- <td><span>{{item?.code || ('table.tr.td.NA' | translate)}}</span></td> -->\n                         </tr>\n                      </tbody>\n                   </table>\n                   <div class=\"padding20 center\" *ngIf=\"finalData?.length == 0\">\n                         <img src=\"assets/img/404-error.png\">\n                   </div>\n                </div>\n             </div>\n          </div>\n\n            <div class=\"btn-cont marginT15\" *ngIf=\"total\">\n                  <div class=\"row\">\n                  <div class=\"col-6\">\n                        <div class=\"title-group\">\n                              <p>{{'table.pagination.showing' | translate}} {{finalData?.length}} {{'table.pagination.outof' | translate}} {{total}}</p>\n                        </div>\n                  </div>\n                  <div class=\"col-6 text-right\">\n                        <pagination-controls class=\"my-pagination\" (pageChange)=\"getPage($event)\"></pagination-controls>\n                  </div>\n                  </div>\n            </div>\n       </div>\n    </div>\n  </div>\n  "

/***/ }),

/***/ "./src/app/layout/collection-report/monthly/monthly.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/layout/collection-report/monthly/monthly.component.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../models/collection-report.model */ "./src/app/models/collection-report.model.ts");
/* harmony import */ var _models_addProject_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../models/addProject.model */ "./src/app/models/addProject.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MonthlyComponent = /** @class */ (function () {
    function MonthlyComponent(constant, admin, spinner, translate) {
        this.constant = constant;
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
    ...
    MonthlyComponent.prototype.ngOnInit = function () {
        ...
        this.today = new Date();
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.towers = [new _models_addProject_model__WEBPACK_IMPORTED_MODULE_7__["Towers"]()];
        this.previousMonth = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(1, 'months').toDate();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.nextMonth = moment__WEBPACK_IMPORTED_MODULE_1__().add(1, 'months').toDate();
        this.parameter.itemsPerPage = this.constant.itemsPerPage;
        this.parameter.page = this.constant.p;
        this.getDevelopers();
    ...
    MonthlyComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    MonthlyComponent.prototype.iniDropDownSetting = function () {
        this.singleDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    MonthlyComponent.prototype.getPage = function (page) {
        this.parameter.page = page;
        this.getListing();
    };
    MonthlyComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    MonthlyComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    MonthlyComponent.prototype.onSelectAll = function (obj) {
    };
    MonthlyComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    MonthlyComponent.prototype.onSelectDeveloper = function (isSelected, obj) {
        this.projects = [];
        this.selctedProjects = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
    ...
    MonthlyComponent.prototype.getDevelopers = function () {
        var _this = this;
        this.admin.postDataApi('getDevelopersForCollections', {})
            .subscribe(function (success) {
            _this.developers = success.data;
    ...
    MonthlyComponent.prototype.onSelectProject = function (isSelected, obj) {
        this.input.building_id = [];
        this.selectedTowers = [];
        this.selectedFloors = [];
        this.selectedProperties = [];
    ...
    MonthlyComponent.prototype.searchBuilding = function (developer_id) {
        var _this = this;
        this.spinner.show();
        var input = {
            developer_id: developer_id
    ...
    MonthlyComponent.prototype.setBuildingId = function (buildingId) {
        var _this = this;
        this.projects.map(function (r) {
            if (r.id == buildingId) {
                _this.buildingTowers = r.building_towers ? r.building_towers : [];
    ...
    MonthlyComponent.prototype.onSelectTower = function (isSelected, obj) {
        this.input.building_towers_id = [];
        this.selectedFloors = [];
        this.selectedProperties = [];
        if (isSelected) {
    ...
    MonthlyComponent.prototype.setTower = function (building_towers_id) {
        var _this = this;
        this.floors = [];
        for (var index = 0; index < this.projects.length; index++) {
            if (this.projects[index].id == this.input.building_id) {
    ...
    MonthlyComponent.prototype.onSelectFloor = function (isSelected, obj) {
        this.properties = [];
        this.selectedProperties = [];
        if (isSelected) {
            this.getProperties(obj.id);
    ...
    MonthlyComponent.prototype.getProperties = function ($event) {
        var _this = this;
        var input = {};
        if (this.selctedProjects) {
            var d = this.selctedProjects.map(function (o) { return o.id; });
    ...
    MonthlyComponent.prototype.getBuyers = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 1 })
            .subscribe(function (success) {
            _this.buyers = success.data;
    ...
    MonthlyComponent.prototype.getLegalRep = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 2 })
            .subscribe(function (success) {
            _this.legalReps = success.data;
    ...
    MonthlyComponent.prototype.getBuyersAsDev = function () {
        var _this = this;
        this.admin.postDataApi('getAllBuyersForCollections', { user_type: 3 })
            .subscribe(function (success) {
            _this.buyersAsDev = success.data;
    ...
    MonthlyComponent.prototype.getListing = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).format('YYYY-MM-DD');
        ...
        input.page = this.parameter.page;
        this.previousMonth = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).subtract(1, 'months').toDate();
        this.nextMonth = moment__WEBPACK_IMPORTED_MODULE_1__(this.input.start_date).add(1, 'months').toDate();
        if (this.selectedDevelopers) {
            var d = this.selectedDevelopers.map(function (o) { return o.id; });
            input.developer_id = d;
        }
        ...
        this.admin.postDataApi('generateCollectionMonthlyReport', input).subscribe(function (success) {
    ...
    MonthlyComponent.prototype.resetFilters = function () {
        this.input = new _models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_1__().toDate();
        this.selectedBuyers = [];
    ...
    MonthlyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./monthly.component.html */ "./src/app/layout/collection-report/monthly/monthly.component.html"),
            styles: [__webpack_require__(/*! ./monthly.component.css */ "./src/app/layout/collection-report/monthly/monthly.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_common_constants__WEBPACK_IMPORTED_MODULE_3__["Constant"],
            src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_4__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
...
/***/ "./src/app/layout/collection-report/project-report/project-report.component.css":
/*!**************************************************************************************!*\
  !*** ./src/app/layout/collection-report/project-report/project-report.component.css ***!
  \**************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9jb2xsZWN0aW9uLXJlcG9ydC9wcm9qZWN0LXJlcG9ydC9wcm9qZWN0LXJlcG9ydC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/layout/collection-report/project-report/project-report.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/layout/collection-report/project-report/project-report.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n  <div class=\"row\">\n      <div class=\"col-12\">\n        <div class=\"title-group\">\n            <h5>{{'collectionReport.projectReport' | translate}}</h5>\n        </div>\n      </div>\n  </div>\n\n<div class=\"white-bg marginT15 padding15\">\n    <div class=\"page-title-4\">\n        <h3>{{'reports.statsAndTrendAnalytics' | translate}}</h3>\n    </div>\n    \n    <div class=\"filters row\">\n      <div class=\"col-lg-2 col-md-2\">\n            <div class=\"form-group\">\n               <label>{{'collectionReport.project' | translate}}</label>\n            <div class=\"clearfix\"></div>\n                <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                      [placeholder]=\"''\"\n                      [data]=\"projects\"\n                      [(ngModel)]=\"selctedProjects\"\n                      [settings]=\"multiDropdownSettings\"\n                      (onDeSelect)=\"onItemDeSelect('projects', $event)\"\n                      (onSelect)=\"onItemSelect('selctedProjects', $event)\"\n                      (onSelectAll)=\"onSelectAll($event)\">\n                </ng-multiselect-dropdown>\n            <div class=\"clearfix\"></div>\n            </div>\n      </div>\n      \n      <div class=\"col-lg-1 col-md-2\">\n            <div class=\"form-group btn-cont\">\n            <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n            <button type=\"button\" (click)=\"getReportData()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n            </div>\n      </div>\n    \n      <div class=\"col-lg-1 col-md-2\">\n            <div class=\"form-group btn-cont\">\n            <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n            <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n            </div>\n      </div>\n    </div>\n      <div class=\"row\">\n      <div class=\"graph-area col-lg-6 col-md-6\">\n        <div id=\"chartContainer\" style=\"height: 370px; width: 90%; margin-left:auto;margin-right:auto;\"></div>\n      </div>\n      <div class=\"graph-area col-lg-5 col-md-5\">\n        <table *ngIf=\"reportData?.length>0\" class=\"table table-striped table-align-left quick-table\">\n          <thead>\n              <tr>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.model' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.totalUnits' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.soldUnits' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.soldPer' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.availableUnits' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.availablePer' | translate}}</b>\n                 </th>\n              </tr>\n          </thead>\n          <tbody>\n              <tr *ngFor=\"let item of reportData; let i=index\">\n                <td>{{item?.model || ('collectionReport.total' | translate)}}</td>\n                <td>{{item?.total_units}}</td>\n                <td>{{item?.sold_units}}</td>\n                <td>{{item?.sold_per}}</td>\n                <td>{{item?.available_units}}</td>\n                <td>{{item?.available_per}}</td>\n              </tr>\n          </tbody>\n          </table>\n      </div>\n      </div>\n      <div class=\"row\">\n      <div class=\"graph-area col-lg-6 col-md-6\">\n        <div id=\"agentContainer\" style=\"height: 370px; width: 90%; margin-left:auto;margin-right:auto;\"></div>\n      </div>\n      <div class=\"graph-area col-lg-4 col-md-4\">\n        <table *ngIf=\"agentData?.length>0\" class=\"table table-striped table-align-left quick-table\">\n          <thead>\n              <tr>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.name' | translate}}</b>\n                 </th>\n                 <th style=\"width:10%; text-align:left;\">\n                       <b>{{'collectionReport.totalUnits' | translate}}</b>\n                 </th>\n              </tr>\n          </thead>\n          <tbody>\n              <tr *ngFor=\"let item of agentData; let i=index\">\n                <td>{{item?.indexLabel}}</td>\n                <td>{{item?.y}}</td>\n              </tr>\n          </tbody>\n       </table>\n      </div>\n      </div>\n  </div>\n    \n</div>"

/***/ }),

/***/ "./src/app/layout/collection-report/project-report/project-report.component.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/layout/collection-report/project-report/project-report.component.ts ***!
  \*************************************************************************************/
/*! exports provided: ProjectReportComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectReportComponent", function() { return ProjectReportComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/assets/js/canvasjs.min.js */ "./src/assets/js/canvasjs.min.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/admin.service */ "./src/app/services/admin.service.ts");
...
var ProjectReportComponent = /** @class */ (function () {
    function ProjectReportComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    ProjectReportComponent.prototype.onSelect = function (event) { };
    ...
    ProjectReportComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    ProjectReportComponent.prototype.iniDropDownSetting = function () {
        this.multiDropdownSettings = {
            singleSelection: true,
            idField: 'id',
            textField: 'name',
    ...
    ProjectReportComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    ProjectReportComponent.prototype.onItemSelect = function (param, obj) {
        this[param] = [obj];
    };
    ProjectReportComponent.prototype.onSelectAll = function (obj) {
    };
    ProjectReportComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    ProjectReportComponent.prototype.getReportData = function () {
        var _this = this;
        var v = this.selctedProjects.length > 0 ? this.selctedProjects[0].id : '';
        if (!v) {
            return false;
        }
        this.spinner.show();
        this.admin.postDataApi('projectReport', { building_id: v }).subscribe(function (r) {
            _this.spinner.hide();
            _this.reportData = r['data'];
            _this.agentData = r['agent_data'];
            var obj = {};
            for (var index = 0; index < _this.reportData.length; index++) {
                var element = _this.reportData[index];
            ...
            _this.dataPoints1 = [];
            for (var index = 0; index < _this.reportData.length; index++) {
                _this.dataPoints1.push({
                    indexLabel: _this.reportData[index].model,
                    y: ((_this.reportData[index].total_units / obj['total_units']) * 100).toFixed(2)
                });
            }
            var externalAgent = { indexLabel: 'Outside Agent', y: 0 };
            var removeValFromIndex = [];
            for (var index = 0; index < _this.agentData.length; index++) {
                var r1 = _this.agentData[index];
            ...
            for (var i = removeValFromIndex.length - 1; i >= 0; i--) {
                _this.agentData.splice(removeValFromIndex[i], 1);
            }
            _this.agentData.push(externalAgent);
            _this.reportData.push(obj);
            _this.plotData();
        }, function (error) {
            _this.spinner.hide();
        });
    };
    ProjectReportComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            title: {
        ...
        chart.render();
        var chart1 = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('agentContainer', {
            title: {
    ...
    ProjectReportComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.selctedProjects = [];
    };
    ProjectReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./project-report.component.html */ "./src/app/layout/collection-report/project-report/project-report.component.html"),
            styles: [__webpack_require__(/*! ./project-report.component.css */ "./src/app/layout/collection-report/project-report/project-report.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
...
/***/ "./src/app/layout/collection-report/sales-booking/sales-booking.component.css":
/*!************************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-booking/sales-booking.component.css ***!
  \************************************************************************************/
/*! no static exports found */
...
module.exports = ".filters{\n    padding: 30px 20px 60px 20px;\n}\nbutton.btn.btn-primary-new.export-btn {\n    margin-bottom: 10px;\n}\n.main-table table{\n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-booking/sales-booking.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-booking/sales-booking.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n            <div class=\"row\">\n                <div class=\"col-12\">\n                  <div class=\"title-group\">\n                      <h5>{{'collectionReport.salesBooking' | translate}}</h5>\n                  </div>\n                </div>\n            </div>\n          \n          <div class=\"white-bg marginT15 padding15\">\n            <div class=\"page-title-4 row\">\n                <h3 class=\"col-10\">{{'reports.statsAndTrendAnalytics' | translate}}</h3>\n                <span class=\"pull-right col-2\">\n                      <select class=\"form-control\" [(ngModel)]=\"reportType\">\n                            <option value=\"1\">{{'collectionReport.graphicalview' | translate}}</option>\n                            <option value=\"2\">{{'collectionReport.tabularView' | translate}}</option>\n                      </select>\n                </span>\n            </div>\n              \n              <div class=\"filters row\">\n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                      <label>{{'collectionReport.start_date' | translate}}</label>\n                      <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" \n                        showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                      </div>\n                </div>\n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                        <label>{{'collectionReport.end_date' | translate}}</label>\n                        <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\" [maxDate]=\"today\" \n                          showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                      </div>\n                </div>\n              \n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                         <label>{{'collectionReport.project' | translate}}</label>\n                      <div class=\"clearfix\"></div>\n                          <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                                [placeholder]=\"''\"\n                                [data]=\"projects\"\n                                [(ngModel)]=\"selctedProjects\"\n                                [settings]=\"multiDropdownSettings\"\n                                (onDeSelect)=\"onItemDeSelect('projects', $event)\"\n                                (onSelect)=\"onItemSelect('selctedProjects', $event)\"\n                                (onSelectAll)=\"onSelectAll($event)\">\n                          </ng-multiselect-dropdown>\n                      <div class=\"clearfix\"></div>\n                      </div>\n                </div>\n                \n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group marginB0\">\n                      <label>{{'collectionReport.currency' | translate}}</label>\n                            <div class=\"clearfix\"></div>\n                            <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                                  [placeholder]=\"''\"\n                                  [data]=\"currencies\"\n                                  [(ngModel)]=\"selectedCurrencies\"\n                                  [settings]=\"multiDropdownSettings\"\n                                  (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                                  (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                                  (onSelectAll)=\"onSelectAll($event)\">\n                            </ng-multiselect-dropdown>\n                            <div class=\"clearfix\"></div>      \n                      </div>\n                </div>\n                <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group marginB0\">\n                        <label>{{'collectionReport.sortBy' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <select class=\"form-control\" name=\"sort_sales_by\" [(ngModel)]=\"input.sort_sales_by\">\n                              <option value=\"1\">{{'collectionReport.successiveBookings' | translate}}</option>\n                              <option value=\"2\">{{'collectionReport.accumulatedBookings' | translate}}</option>\n                        </select>\n                        <div class=\"clearfix\"></div>      \n                  </div>\n                  </div>\n                <div class=\"col-lg-1 col-md-2\">\n                      <div class=\"form-group btn-cont\">\n                      <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                      <button type=\"button\" (click)=\"getReportData()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n                      </div>\n                </div>\n              \n                <div class=\"col-lg-1 col-md-2\">\n                      <div class=\"form-group btn-cont\">\n                      <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                      <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n                      </div>\n                </div>\n              </div>\n                \n              <div class=\"graph-area\" [style.display]=\"reportType==1 ? 'block' : 'none'\">\n                <div id=\"chartContainer\" style=\"height: 370px; width: 90%; margin-left:auto;margin-right:auto;\"></div>\n              </div>\n\n            <div class=\"table-responsive main-table\" *ngIf=\"reportType == 2\" style=\"width: 90%; margin-left:auto;margin-right:auto;\">\n                  <h5>{{'collectionReport.tabularView' | translate}}<span class=\" pull-right\">\n                        <button class=\"btn btn-primary-new export-btn\" (click)=\"exportData()\">{{'collectionReport.export' | translate}}</button>\n                  </span></h5>\n                  <table class=\"table table-bordered table-striped\">\n                        <thead>\n                              <th>{{'collectionReport.month' | translate}}</th>\n                              <th>{{'collectionReport.value' | translate}}</th>\n                        </thead>\n                        <tbody>\n                              <tr *ngFor=\"let item of reportData\">\n                                    <td>{{item.label}}</td>\n                                    <td>{{(item.y || 0) | currency}}</td>\n                              </tr>\n                        </tbody>\n                  </table>\n            </div>\n            </div>\n              \n          </div>"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-booking/sales-booking.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-booking/sales-booking.component.ts ***!
  \***********************************************************************************/
/*! exports provided: SalesBookingComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SalesBookingComponent", function() { return SalesBookingComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/assets/js/canvasjs.min.js */ "./src/assets/js/canvasjs.min.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/admin.service */ "./src/app/services/admin.service.ts");
...
var EXCEL_TYPE = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
var EXCEL_EXTENSION = '.xlsx';
var SalesBookingComponent = /** @class */ (function () {
    function SalesBookingComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    SalesBookingComponent.prototype.onSelect = function (event) { };
    SalesBookingComponent.prototype.ngOnInit = function () {
        this.reportType = 1;
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
    ...
    SalesBookingComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    SalesBookingComponent.prototype.iniDropDownSetting = function () {
        this.multiDropdownSettings = {
            singleSelection: false,
            idField: 'id',
            textField: 'name',
    ...
    SalesBookingComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    SalesBookingComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    SalesBookingComponent.prototype.onSelectAll = function (obj) {
    };
    SalesBookingComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    SalesBookingComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    SalesBookingComponent.prototype.getReportData = function () {
        var _this = this;
        this.reportType = 1;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        ...
        this.spinner.show();
        this.admin.postDataApi('graphs/sales-booking', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.reportData = r['data']['trends'];
            var s = 0;
    ...
    SalesBookingComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            animationEnabled: true,
    ...
    SalesBookingComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
        this.selectedCurrencies = [];
    ...
    SalesBookingComponent.prototype.exportData = function () {
        if (this.reportData) {
            var finalData = [];
            for (var index = 0; index < this.reportData.length; index++) {
                var p = this.reportData[index];
                finalData.push({
                    'Month': p.label || '',
                    'Count': p.y || 0
                });
    ...
    // will be used in case of excel
    SalesBookingComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    SalesBookingComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    SalesBookingComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-sales-booking',
            template: __webpack_require__(/*! ./sales-booking.component.html */ "./src/app/layout/collection-report/sales-booking/sales-booking.component.html"),
            styles: [__webpack_require__(/*! ./sales-booking.component.css */ "./src/app/layout/collection-report/sales-booking/sales-booking.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
    ], SalesBookingComponent);
    return SalesBookingComponent;
}());
...
/***/ "./src/app/layout/collection-report/sales-report/sales-report.component.css":
/*!**********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-report/sales-report.component.css ***!
  \**********************************************************************************/
/*! no static exports found */
...
module.exports = ".filters{\n    padding: 30px 20px 60px 20px;\n}\nbutton.btn.btn-primary-new.export-btn {\n    margin-bottom: 10px;\n}\n.main-table table{\n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-report/sales-report.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-report/sales-report.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n  <div class=\"row\">\n      <div class=\"col-12\">\n        <div class=\"title-group\">\n            <h5>{{'collectionReport.salesReport' | translate}}</h5>\n        </div>\n      </div>\n  </div>\n\n<div class=\"white-bg marginT15 padding15\">\n    <div class=\"page-title-4 row\">\n        <h3 class=\"col-10\">{{'reports.statsAndTrendAnalytics' | translate}}</h3>\n        <span class=\"pull-right col-2\">\n              <select class=\"form-control\" [(ngModel)]=\"reportType\">\n                    <option value=\"1\">{{'collectionReport.graphicalview' | translate}}</option>\n                    <option value=\"2\">{{'collectionReport.tabularView' | translate}}</option>\n              </select>\n        </span>\n    </div>\n    \n    <div class=\"filters row\">\n      <div class=\"col-lg-2 col-md-2\">\n            <div class=\"form-group\">\n            <label>{{'collectionReport.start_date' | translate}}</label>\n            <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" \n              showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n            </div>\n      </div>\n      <div class=\"col-lg-2 col-md-2\">\n            <div class=\"form-group\">\n              <label>{{'collectionReport.end_date' | translate}}</label>\n              <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\" [maxDate]=\"today\" \n                showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n            </div>\n      </div>\n    \n      <div class=\"col-lg-2 col-md-2\">\n            <div class=\"form-group\">\n               <label>{{'collectionReport.project' | translate}}</label>\n            <div class=\"clearfix\"></div>\n                <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                      [placeholder]=\"''\"\n                      [data]=\"projects\"\n                      [(ngModel)]=\"selctedProjects\"\n                      [settings]=\"multiDropdownSettings\"\n                      (onDeSelect)=\"onItemDeSelect('projects', $event)\"\n                      (onSelect)=\"onItemSelect('selctedProjects', $event)\"\n                      (onSelectAll)=\"onSelectAll($event)\">\n                </ng-multiselect-dropdown>\n            <div class=\"clearfix\"></div>\n            </div>\n      </div>\n      \n      <div class=\"col-lg-2 col-md-2\">\n            <div class=\"form-group marginB0\">\n            <label>{{'collectionReport.currency' | translate}}</label>\n                  <div class=\"clearfix\"></div>\n                  <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                        [placeholder]=\"''\"\n                        [data]=\"currencies\"\n                        [(ngModel)]=\"selectedCurrencies\"\n                        [settings]=\"multiDropdownSettings\"\n                        (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                        (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                        (onSelectAll)=\"onSelectAll($event)\">\n                  </ng-multiselect-dropdown>\n                  <div class=\"clearfix\"></div>      \n            </div>\n      </div>\n      <div class=\"col-lg-2 col-md-2\">\n        <div class=\"form-group marginB0\">\n              <label>{{'collectionReport.sortBy' | translate}}</label>\n              <div class=\"clearfix\"></div>\n              <select class=\"form-control\" name=\"sort_sales_by\" [(ngModel)]=\"input.sort_sales_by\">\n                    <option value=\"1\">{{'collectionReport.purchaseDate' | translate}}</option>\n                    <option value=\"2\">{{'collectionReport.firstPayment' | translate}}</option>\n              </select>\n              <div class=\"clearfix\"></div>      \n        </div>\n        </div>\n      <div class=\"col-lg-1 col-md-2\">\n            <div class=\"form-group btn-cont\">\n            <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n            <button type=\"button\" (click)=\"getReportData()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n            </div>\n      </div>\n    \n      <div class=\"col-lg-1 col-md-2\">\n            <div class=\"form-group btn-cont\">\n            <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n            <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n            </div>\n      </div>\n    </div>\n      \n    <div class=\"graph-area\" [style.display]=\"reportType==1 ? 'block' : 'none'\">\n      <div id=\"chartContainer\" style=\"height: 370px; width: 90%; margin-left:auto;margin-right:auto;\"></div>\n    </div>\n\n    <div class=\"table-responsive main-table\" *ngIf=\"reportType == 2\" style=\"width: 90%; margin-left:auto;margin-right:auto;\">\n      <h5>{{'collectionReport.tabularView' | translate}}<span class=\" pull-right\">\n            <button class=\"btn btn-primary-new export-btn\" (click)=\"exportData()\">{{'collectionReport.export' | translate}}</button>\n      </span></h5>\n      <table class=\"table table-bordered table-striped\">\n            <thead>\n                  <th>{{'collectionReport.month' | translate}}</th>\n                  <th>{{'collectionReport.InhouseAgentApprovedCollections' | translate}}</th>\n                  <th>{{'collectionReport.OutsideAgentApprovedCollections' | translate}}</th>\n            </thead>\n            <tbody>\n                  <tr *ngFor=\"let item of items\">\n                        <td>{{item.label}}</td>\n                        <td>{{item.approved_count}}</td>\n                        <td>{{item.unapproved_count}}</td>\n                  </tr>\n            </tbody>\n      </table>\n    </div>\n  </div>\n    \n</div>"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-report/sales-report.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-report/sales-report.component.ts ***!
  \*********************************************************************************/
...
var SalesReportComponent = /** @class */ (function () {
    function SalesReportComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    SalesReportComponent.prototype.onSelect = function (event) { };
    ...
    SalesReportComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    SalesReportComponent.prototype.iniDropDownSetting = function () {
        this.multiDropdownSettings = {
            singleSelection: false,
            idField: 'id',
            textField: 'name',
    ...
    SalesReportComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    SalesReportComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    SalesReportComponent.prototype.onSelectAll = function (obj) {
    };
    SalesReportComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    SalesReportComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    SalesReportComponent.prototype.getReportData = function () {
        var _this = this;
        this.reportType = 1;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        ...
        this.spinner.show();
        this.admin.postDataApi('graphs/sales-reports-2', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.reportData = r['data'];
            _this.items = [];
            for (var index = 0; index < _this.reportData.approved.length; index++) {
                var e = _this.reportData.approved[index];
                var obj = { label: e.label, approved_count: e.y, unapproved_count: _this.reportData.unapproved[index].y };
                _this.items.push(obj);
            }
            _this.plotData();
        }, function (error) {
    ...
    SalesReportComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            animationEnabled: true,
    ...
    SalesReportComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
        this.selectedCurrencies = [];
    ...
    SalesReportComponent.prototype.exportData = function () {
        if (this.items) {
            var finalData = [];
            for (var index = 0; index < this.items.length; index++) {
                var p = this.items[index];
    ...
    // will be used in case of excel
    SalesReportComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    SalesReportComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    SalesReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./sales-report.component.html */ "./src/app/layout/collection-report/sales-report/sales-report.component.html"),
            styles: [__webpack_require__(/*! ./sales-report.component.css */ "./src/app/layout/collection-report/sales-report/sales-report.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
...
/***/ "./src/app/layout/collection-report/sales-trend/sales-trend.component.css":
/*!********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-trend/sales-trend.component.css ***!
  \********************************************************************************/
/*! no static exports found */
...
module.exports = ".filters{\n    padding: 30px 20px 60px 20px;\n}\nbutton.btn.btn-primary-new.export-btn {\n    margin-bottom: 10px;\n}\n.main-table table{\n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-trend/sales-trend.component.html":
/*!*********************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-trend/sales-trend.component.html ***!
  \*********************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div class=\"container-fluid\">\n            <div class=\"row\">\n                <div class=\"col-12\">\n                  <div class=\"title-group\">\n                      <h5>{{'collectionReport.salesTrend' | translate}}</h5>\n                  </div>\n                </div>\n            </div>\n          \n          <div class=\"white-bg marginT15 padding15\">\n            <div class=\"page-title-4 row\">\n                <h3 class=\"col-10\">{{'reports.statsAndTrendAnalytics' | translate}}</h3>\n                <span class=\"pull-right col-2\">\n                      <select class=\"form-control\" [(ngModel)]=\"reportType\">\n                            <option value=\"1\">{{'collectionReport.graphicalview' | translate}}</option>\n                            <option value=\"2\">{{'collectionReport.tabularView' | translate}}</option>\n                      </select>\n                </span>\n            </div>\n              \n              <div class=\"filters row\">\n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                      <label>{{'collectionReport.start_date' | translate}}</label>\n                      <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.start_date\" [maxDate]=\"today\" \n                        showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                      </div>\n                </div>\n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                        <label>{{'collectionReport.end_date' | translate}}</label>\n                        <p-calendar dateFormat=\"dd/M/yy\" [locale]=\"locale\" showIcon=\"true\" [(ngModel)]=\"input.end_date\" [maxDate]=\"today\" \n                          showButtonBar=\"true\" class=\"coll-report-calendar\" [monthNavigator]=\"true\" [yearNavigator]=\"true\" yearRange=\"2000:2040\"></p-calendar>\n                      </div>\n                </div>\n              \n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group\">\n                         <label>{{'collectionReport.project' | translate}}</label>\n                      <div class=\"clearfix\"></div>\n                          <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                                [placeholder]=\"''\"\n                                [data]=\"projects\"\n                                [(ngModel)]=\"selctedProjects\"\n                                [settings]=\"multiDropdownSettings\"\n                                (onDeSelect)=\"onItemDeSelect('projects', $event)\"\n                                (onSelect)=\"onItemSelect('selctedProjects', $event)\"\n                                (onSelectAll)=\"onSelectAll($event)\">\n                          </ng-multiselect-dropdown>\n                      <div class=\"clearfix\"></div>\n                      </div>\n                </div>\n                \n                <div class=\"col-lg-2 col-md-2\">\n                      <div class=\"form-group marginB0\">\n                      <label>{{'collectionReport.currency' | translate}}</label>\n                            <div class=\"clearfix\"></div>\n                            <ng-multiselect-dropdown class=\"section-section2 multi-select\"\n                                  [placeholder]=\"''\"\n                                  [data]=\"currencies\"\n                                  [(ngModel)]=\"selectedCurrencies\"\n                                  [settings]=\"multiDropdownSettings\"\n                                  (onDeSelect)=\"onItemDeSelect('currencies', $event)\"\n                                  (onSelect)=\"onItemSelect('selectedCurrencies', $event)\"\n                                  (onSelectAll)=\"onSelectAll($event)\">\n                            </ng-multiselect-dropdown>\n                            <div class=\"clearfix\"></div>      \n                      </div>\n                </div>\n\n                <div class=\"col-lg-2 col-md-2\">\n                  <div class=\"form-group marginB0\">\n                        <label>{{'collectionReport.sortBy' | translate}}</label>\n                        <div class=\"clearfix\"></div>\n                        <select class=\"form-control\" name=\"sort_sales_by\" [(ngModel)]=\"input.sort_sales_by\">\n                              <option value=\"1\">{{'collectionReport.purchaseDate' | translate}}</option>\n                              <option value=\"2\">{{'collectionReport.firstPayment' | translate}}</option>\n                        </select>\n                        <div class=\"clearfix\"></div>      \n                  </div>\n                  </div>\n            \n                <div class=\"col-lg-1 col-md-2\">\n                      <div class=\"form-group btn-cont\">\n                      <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                      <button type=\"button\" (click)=\"getReportData()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.apply' | translate}}</button>\n                      </div>\n                </div>\n              \n                <div class=\"col-lg-1 col-md-2\">\n                      <div class=\"form-group btn-cont\">\n                      <label style=\"display: block; margin-top: 3px;\">&nbsp;</label>\n                      <button type=\"button\" (click)=\"resetFilters()\" class=\"btn btn-primary-new width100P P86\">{{'collectionReport.reset' | translate}}</button>\n                      </div>\n                </div>\n              </div>\n                \n              <div class=\"graph-area\" [style.display]=\"reportType==1 ? 'block' : 'none'\">\n                  <div id=\"chartContainer\" style=\"height: 370px; width: 90%; margin-left:auto;margin-right:auto;\"></div>\n                </div>\n  \n              <div class=\"table-responsive main-table\" *ngIf=\"reportType == 2\" style=\"width: 90%; margin-left:auto;margin-right:auto;\">\n                    <h5>{{'collectionReport.tabularView' | translate}}<span class=\" pull-right\">\n                          <button class=\"btn btn-primary-new export-btn\" (click)=\"exportData()\">{{'collectionReport.export' | translate}}</button>\n                    </span></h5>\n                    <table class=\"table table-bordered table-striped\">\n                          <thead>\n                                <th>{{'collectionReport.month' | translate}}</th>\n                                <th>{{'collectionReport.count' | translate}}</th>\n                          </thead>\n                          <tbody>\n                                <tr *ngFor=\"let item of reportData\">\n                                      <td>{{item.label}}</td>\n                                      <td>{{item.y}}</td>\n                                </tr>\n                          </tbody>\n                    </table>\n              </div>\n            </div>\n              \n          </div>"

/***/ }),

/***/ "./src/app/layout/collection-report/sales-trend/sales-trend.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/layout/collection-report/sales-trend/sales-trend.component.ts ***!
  \*******************************************************************************/
/*! exports provided: SalesTrendComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SalesTrendComponent", function() { return SalesTrendComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/assets/js/canvasjs.min.js */ "./src/assets/js/canvasjs.min.js");
/* harmony import */ var src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/admin.service */ "./src/app/services/admin.service.ts");
...
var EXCEL_TYPE = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
var EXCEL_EXTENSION = '.xlsx';
var SalesTrendComponent = /** @class */ (function () {
    function SalesTrendComponent(admin, spinner, translate) {
        this.admin = admin;
        this.spinner = spinner;
        this.translate = translate;
        this.parameter = {};
    ...
    SalesTrendComponent.prototype.onSelect = function (event) { };
    SalesTrendComponent.prototype.ngOnInit = function () {
        this.reportType = 1;
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.sort_sales_by = 1;
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(12, 'months').toDate();
    ...
    SalesTrendComponent.prototype.initCalendarLocale = function () {
        if (this.translate.defaultLang === 'en') {
            this.locale = {
                firstDayOfWeek: 0,
                dayNames: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    SalesTrendComponent.prototype.iniDropDownSetting = function () {
        this.multiDropdownSettings = {
            singleSelection: false,
            idField: 'id',
            textField: 'name',
    ...
    SalesTrendComponent.prototype.onItemDeSelect = function (arrayNAme, obj) {
        this[arrayNAme].push(obj);
    };
    SalesTrendComponent.prototype.onItemSelect = function (param, obj) {
        this[param].push(obj);
    };
    SalesTrendComponent.prototype.onSelectAll = function (obj) {
    };
    SalesTrendComponent.prototype.getCurrencies = function () {
        var _this = this;
        this.admin.postDataApi('getCurrencies', {})
            .subscribe(function (success) {
            _this.currencies = success.data;
    ...
    SalesTrendComponent.prototype.searchBuilding = function () {
        var _this = this;
        this.spinner.show();
        this.admin.postDataApi('getProjectsForCollections', {})
            .subscribe(function (success) {
    ...
    SalesTrendComponent.prototype.getReportData = function () {
        var _this = this;
        this.reportType = 1;
        var input = JSON.parse(JSON.stringify(this.input));
        input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__(this.input.start_date).format('YYYY-MM-DD');
        ...
        this.spinner.show();
        this.admin.postDataApi('graphs/sales-trend', input).subscribe(function (r) {
            _this.spinner.hide();
            _this.reportData = r['data']['trends'];
            _this.avgValue = 0;
            if (_this.reportData) {
                for (var index = 0; index < _this.reportData.length; index++) {
                    var element = _this.reportData[index];
                    _this.avgValue = _this.avgValue + element['y'];
                }
                _this.avgValue = _this.avgValue / _this.reportData.length;
            }
            _this.plotData();
        }, function (error) {
            _this.spinner.hide();
    ...
    SalesTrendComponent.prototype.plotData = function () {
        var chart = new src_assets_js_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_1__["Chart"]('chartContainer', {
            animationEnabled: true,
    ...
    SalesTrendComponent.prototype.resetFilters = function () {
        this.input = new src_app_models_collection_report_model__WEBPACK_IMPORTED_MODULE_6__["CollectionReport"]();
        this.input.start_date = moment__WEBPACK_IMPORTED_MODULE_3__().subtract(6, 'months').toDate();
        this.input.end_date = moment__WEBPACK_IMPORTED_MODULE_3__().toDate();
        this.selectedCurrencies = [];
    ...
    SalesTrendComponent.prototype.exportData = function () {
        if (this.reportData) {
            var finalData = [];
            for (var index = 0; index < this.reportData.length; index++) {
                var p = this.reportData[index];
    ...
    // will be used in case of excel
    SalesTrendComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
        var worksheet = xlsx__WEBPACK_IMPORTED_MODULE_8__["utils"].json_to_sheet(json);
        var workbook = {
            Sheets: { data: worksheet },
            SheetNames: ['data']
    ...
    SalesTrendComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
        var data = new Blob([buffer], { type: EXCEL_TYPE });
        var today = new Date();
        var date = today.getDate() +
            '-' +
    ...
    SalesTrendComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-sales-trend',
            template: __webpack_require__(/*! ./sales-trend.component.html */ "./src/app/layout/collection-report/sales-trend/sales-trend.component.html"),
            styles: [__webpack_require__(/*! ./sales-trend.component.css */ "./src/app/layout/collection-report/sales-trend/sales-trend.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"]])
    ], SalesTrendComponent);
    return SalesTrendComponent;
}());
...
/***/ "./src/app/models/collection-report.model.ts":
/*!***************************************************!*\
  !*** ./src/app/models/collection-report.model.ts ***!
  \***************************************************/
/*! exports provided: CollectionReport */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CollectionReport", function() { return CollectionReport; });
var CollectionReport = /** @class */ (function () {
...
//# sourceMappingURL=collection-report-collection-report-module.js.map