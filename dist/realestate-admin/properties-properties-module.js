...
/* harmony import */ var src_app_lang_translate_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/lang/translate.service */ "./src/app/lang/translate.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddPropertyComponent = /** @class */ (function () {
    ...
    function AddPropertyComponent(model, us, cs, router, sanitization, mapsAPILoader, ngZone, building, constant, route, http, spinner, element, ts) {
        this.model = model;
        this.us = us;
        this.cs = cs;
        this.router = router;
    ...
    AddPropertyComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_models_addProperty_model__WEBPACK_IMPORTED_MODULE_6__["AddPropertyModel"], src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_10__["AdminService"], src_app_services_common_service__WEBPACK_IMPORTED_MODULE_11__["CommonService"],
            ...
            src_app_lang_translate_service__WEBPACK_IMPORTED_MODULE_14__["TranslateService"]])
...
var BulkAddComponent = /** @class */ (function () {
    function BulkAddComponent(model, us, router, mapsAPILoader, ngZone, building, constant, spinner) {
        this.model = model;
        this.us = us;
        this.router = router;
        this.mapsAPILoader = mapsAPILoader;
...
var PropertiesComponent = /** @class */ (function () {
    function PropertiesComponent(constant, admin, propertyService, spinner, route, router) {
        this.constant = constant;
        this.admin = admin;
...
/* harmony import */ var ngx_malihu_scrollbar__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ngx-malihu-scrollbar */ "./node_modules/ngx-malihu-scrollbar/fesm5/ngx-malihu-scrollbar.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'view-properties/:project_id', component: _properties_component__WEBPACK_IMPORTED_MODULE_9__["PropertiesComponent"],
        canActivate: [_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_12__["AclUserGuard"]], data: { roles: ['Property Management', 'can_read', ''] } }
];
    ...
    PropertiesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                ngx_malihu_scrollbar__WEBPACK_IMPORTED_MODULE_19__["MalihuScrollbarModule"].forRoot()
            ],
            declarations: [
