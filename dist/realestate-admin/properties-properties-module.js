...
var PropertiesComponent = /** @class */ (function () {
    ...
    PropertiesComponent.prototype.getInhouseBroker = function (property, keyword) {
        var _this = this;
        this.parameter.loading = true;
        if (property) {
        ...
        this.admin.postDataApi('getExternalBroker', input).subscribe(function (r) {
            _this.parameter.loading = false;
            if (property) {
    ...
    PropertiesComponent.prototype.attachExternalBrokerPopUp = function (broker) {
        var _this = this;
        this.parameter.title = this.constant.title.ARE_YOU_SURE;
        ...
        swal({
            ...
            if (result.value) {
                _this.attachExternalBroker(broker);
            }
        });
    };
    PropertiesComponent.prototype.attachExternalBroker = function (broker) {
        var _this = this;
        this.admin.postDataApi('attachExternalBroker', { property_id: this.property.id,
            broker_id: broker.id }).subscribe(function (r) {
            _this.closeExtBrokerModal.nativeElement.click();
            _this.property.external_broker = broker;
