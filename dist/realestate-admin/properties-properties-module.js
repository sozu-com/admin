...
var PropertiesComponent = /** @class */ (function () {
    ...
    PropertiesComponent.prototype.editAgentCommissionPopup = function (item, index) {
        var _this = this;
        this.parameter.title = this.translate.instant('message.question.areYouSure');
        swal({
