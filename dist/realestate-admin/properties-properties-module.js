...
module.exports = ".upload-cover-img{\n    /* background-size: contain;background-repeat: no-repeat; */\n}\n.width100{\n    width: 100%;\n}\n.paddingleft0{\n    padding-left: 0px;\n}\nagm-map {\n    height: 300px;\n}\n.floor-plan{\n    -o-object-fit: cover;\n       object-fit: cover;\n    width: 100%;\n    height: auto;\n}\n.upload-cover-img{\n    display: flex;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AddPropertyComponent = /** @class */ (function () {
    ...
    function AddPropertyComponent(model, us, cs, router, sanitization, mapsAPILoader, ngZone, building, constant, route, http, spinner, element, translate) {
        var _this = this;
        this.model = model;
        this.us = us;
        this.cs = cs;
            ...
            for (var index = 0; index < _this.testMarital.length; index++) {
                if (success['data'].marital_statuses.length !== 0) {
                    for (var i = 0; i < success['data'].marital_statuses.length; i++) {
                        if (_this.testMarital[index].name_en === success['data'].marital_statuses[i].name_en) {
            ...
            this.us.postDataApi('addProperty', input)
                ...
                if (_this.model.step.toString() === '4') {
                    var successText = _this.parameter.bulk_approve_property ? '' :
                        _this.translate.instant('message.error.notifiedWhenAdminReview');
                    swal({
    ...
    AddPropertyComponent.prototype.getBuildingIndex = function (i) {
    ...
    AddPropertyComponent.prototype.setVideoStaticThumb = function (myIndex) {
    ...
    AddPropertyComponent.prototype.showamenVideoOld = function (event, type) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var arr, index;
            return __generator(this, function (_a) {
...
module.exports = "\nagm-map {\n    height: 300px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var BulkAddComponent = /** @class */ (function () {
    function BulkAddComponent(model, us, router, mapsAPILoader, ngZone, building, constant, spinner, translate) {
        this.model = model;
        this.us = us;
        this.router = router;
        this.mapsAPILoader = mapsAPILoader;
    ...
    BulkAddComponent.prototype.getPage = function (page) {
        this.parameter.page = page;
    };
    BulkAddComponent.prototype.getBuildingIndex = function (i) {
        this.searchedBuildings.forEach(function (e) {
            e.selected = false;
        });
        var searchindex = (this.parameter.page - 1) * 4 + i;
    ...
    BulkAddComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [src_app_models_addProperty_model__WEBPACK_IMPORTED_MODULE_6__["AddPropertyModel"], src_app_models_addProperty_model__WEBPACK_IMPORTED_MODULE_6__["Building"], src_app_common_constants__WEBPACK_IMPORTED_MODULE_5__["Constant"]]
        }),
        __metadata("design:paramtypes", [src_app_models_addProperty_model__WEBPACK_IMPORTED_MODULE_6__["AddPropertyModel"], src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _agm_core__WEBPACK_IMPORTED_MODULE_4__["MapsAPILoader"],
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], src_app_models_addProperty_model__WEBPACK_IMPORTED_MODULE_6__["Building"], src_app_common_constants__WEBPACK_IMPORTED_MODULE_5__["Constant"],
...
module.exports = "input[type=\"text\"] {\n    background-color : #d1d1d1; \n}\n.modal-dialog {\n    max-width: 500px;\n    margin: 24.75rem auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PropertiesComponent = /** @class */ (function () {
    function PropertiesComponent(constant, admin, propertyService, spinner, route, router, translate) {
        this.constant = constant;
        this.admin = admin;
        ...
        this.baseUrl = this.admin.baseUrl + 'exportProperties';
    }
    PropertiesComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.parameter.keyword = params.name;
            if (params.availability_filter) {
                _this.parameter.availability_filter = params.availability_filter;
            }
    ...
    PropertiesComponent.prototype.setFloors = function () {
    ...
    PropertiesComponent.prototype.close = function () {
        $('.modal').modal('hide');
    };
    ...
    PropertiesComponent.prototype.searchProperties = function () {
        this.close();
        this.getListing();
    };
    ...
    PropertiesComponent.prototype.blockUnblock = function (item, flag) {
        var _this = this;
        switch (flag) {
            case 0:
    ...
    PropertiesComponent.prototype.blockProperty = function (item, flag) {
        var _this = this;
    ...
    PropertiesComponent.prototype.getAllSellers = function (property, keyword, index, user_type, seller_type) {
        var _this = this;
        ...
        this.admin.postDataApi('getAllBuyers', input).subscribe(function (r) {
            _this.spinner.hide();
            if (property) {
    ...
    PropertiesComponent.prototype.changeStatusPopUp = function (property_id, user_id, name, status, type) {
        var _this = this;
        this.parameter.property_id = property_id;
        this.parameter.user_id = user_id;
    ...
    PropertiesComponent.prototype.changeStatusSellerSelection = function () {
        ...
        var url = this.user_type == 'seller' ? 'changeStatusSellerSelection' : 'changeStatusBuyerSelection';
        this.admin.postDataApi(url, input).subscribe(function (r) {
            if (_this.parameter.status === 1) {
                if (_this.user_type == 'seller') {
                    ...
                    _this.parameter.buyer_id = _this.parameter.user_id;
                    _this.items[_this.parameter.index].selected_buyer_id = _this.parameter.user_id;
                    var sel_user = {
                        user: { name: '' }
                    };
                    _this.items[_this.parameter.index].selected_buyer = sel_user;
                    _this.items[_this.parameter.index].selected_buyer.user.name = _this.parameter.fullName;
                }
            }
            else {
                // reject
                if (_this.user_type == 'seller') {
                    _this.items[_this.parameter.index].selected_seller_id = null;
                    _this.items[_this.parameter.index].selected_seller = null;
                }
                else {
                    _this.items[_this.parameter.index].selected_buyer_id = null;
                    _this.items[_this.parameter.index].selected_buyer = null;
                }
            }
    ...
    PropertiesComponent.prototype.changeSoldStatusPopup = function (property, index, event) {
        var _this = this;
        swal({
    ...
    PropertiesComponent.prototype.editPricePopup = function (item, index) {
        var _this = this;
        ...
        swal({
            ...
            if (result.value) {
                swal({
                    text: _this.translate.instant('message.error.pleaseEnterNewPropertyPrice'),
                    input: 'number',
                    showCancelButton: true,
    ...
    PropertiesComponent.prototype.editAgentCommissionPopup = function (item, index, isBrokerCommissionEdited) {
        var _this = this;
        this.parameter.title = this.translate.instant('message.error.areYouSure');
        swal({
            ...
            if (result.value) {
                swal({
                    text: _this.translate.instant('message.error.pleaseEnterNewCommission') + ' -',
                    input: 'number',
                    showCancelButton: true,
                    confirmButtonColor: _this.constant.confirmButtonColor,
                    cancelButtonColor: _this.constant.cancelButtonColor,
                    ...
                    inputValidator: function (value) {
                        if (!value) {
                            return _this.translate.instant('message.error.pleaseEnterNewCommission');
                        }
                    }
                }).then(function (r) {
                    if (r.value) {
                        var broker_commision_1 = isBrokerCommissionEdited ? r.value : (item.broker_commision || 0);
                        var total_commission_1 = isBrokerCommissionEdited ? (item.total_commission || 0) : r.value;
                        var input = { id: item.id, broker_commision: broker_commision_1, total_commission: total_commission_1 };
                        _this.admin.postDataApi('updateBrokerCommision', input).subscribe(function (success) {
                            _this.items[index].broker_commision = broker_commision_1;
                            _this.items[index].total_commission = total_commission_1;
                            swal(_this.translate.instant('swal.success'), _this.translate.instant('message.success.updatedSuccessfully'), 'success');
                        }, function (error) {
                            swal(_this.translate.instant('swal.error'), error.error.message, 'error');
                        });
    ...
    PropertiesComponent.prototype.viewPropertyDetails = function (property_id, data) {
    ...
    PropertiesComponent.prototype.getExportlisting = function () {
        var _this = this;
        this.spinner.show();
        var input = JSON.parse(JSON.stringify(this.parameter));
        input.page = 0;
    ...
    PropertiesComponent.prototype.exportData = function () {
    ...
    PropertiesComponent.prototype.exportAsExcelFile = function (json, excelFileName) {
    ...
    PropertiesComponent.prototype.saveAsExcelFile = function (buffer, fileName) {
...
/* harmony import */ var _properties_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./properties.component */ "./src/app/layout/properties/properties.component.ts");
/* harmony import */ var _add_property_add_property_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./add-property/add-property.component */ "./src/app/layout/properties/add-property/add-property.component.ts");
/* harmony import */ var _property_details_property_details_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./property-details/property-details.component */ "./src/app/layout/properties/property-details/property-details.component.ts");
/* harmony import */ var src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/guards/acl-user.guard */ "./src/app/guards/acl-user.guard.ts");
/* harmony import */ var src_app_pipes_filter_by_id_pipe__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/pipes/filter-by-id.pipe */ "./src/app/pipes/filter-by-id.pipe.ts");
/* harmony import */ var src_app_pipes_filter_by_name_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/app/pipes/filter-by-name.pipe */ "./src/app/pipes/filter-by-name.pipe.ts");
/* harmony import */ var src_app_modules_shared_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/modules/shared.module */ "./src/app/modules/shared.module.ts");
...
/* harmony import */ var _bulk_add_bulk_add_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./bulk-add/bulk-add.component */ "./src/app/layout/properties/bulk-add/bulk-add.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'details/:property_id', component: _property_details_property_details_component__WEBPACK_IMPORTED_MODULE_13__["PropertyDetailsComponent"] },
    ...
    {
        path: 'add-bulk-property/:property_id/:seller_id', component: _bulk_add_bulk_add_component__WEBPACK_IMPORTED_MODULE_19__["BulkAddComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_create', 'can_csr_seller'] }
    },
    {
        path: 'add-property/:property_id/:seller_id', component: _add_property_add_property_component__WEBPACK_IMPORTED_MODULE_12__["AddPropertyComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_create', 'can_csr_seller'] }
    },
    {
        path: 'edit-property/:property_id', component: _add_property_add_property_component__WEBPACK_IMPORTED_MODULE_12__["AddPropertyComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_update', 'can_csr_seller'] }
    },
    {
        path: 'edit-property/:property_id/:edit', component: _add_property_add_property_component__WEBPACK_IMPORTED_MODULE_12__["AddPropertyComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_update', 'can_csr_seller'] }
    },
    {
        path: 'view-properties', component: _properties_component__WEBPACK_IMPORTED_MODULE_11__["PropertiesComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_read', ''] }
    },
    {
        path: 'view-properties/:project_id', component: _properties_component__WEBPACK_IMPORTED_MODULE_11__["PropertiesComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_read', ''] }
    },
    {
        path: 'view-properties/:name/:availability_filter', component: _properties_component__WEBPACK_IMPORTED_MODULE_11__["PropertiesComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_read', ''] }
    },
    {
        path: 'view-properties/:id/:type', component: _properties_component__WEBPACK_IMPORTED_MODULE_11__["PropertiesComponent"],
        canActivate: [src_app_guards_acl_user_guard__WEBPACK_IMPORTED_MODULE_14__["AclUserGuard"]], data: { roles: ['Property Management', 'can_read', ''] }
    }
];
    ...
    PropertiesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                primeng_primeng__WEBPACK_IMPORTED_MODULE_18__["CalendarModule"],
                src_app_modules_shared_module__WEBPACK_IMPORTED_MODULE_17__["SharedModule"],
            ...
            declarations: [
                _properties_component__WEBPACK_IMPORTED_MODULE_11__["PropertiesComponent"],
                _add_property_add_property_component__WEBPACK_IMPORTED_MODULE_12__["AddPropertyComponent"],
                _property_details_property_details_component__WEBPACK_IMPORTED_MODULE_13__["PropertyDetailsComponent"],
                src_app_pipes_filter_by_id_pipe__WEBPACK_IMPORTED_MODULE_15__["FilterByIdPipe"],
                src_app_pipes_filter_by_name_pipe__WEBPACK_IMPORTED_MODULE_16__["FilterByNamePipe"],
                _bulk_add_bulk_add_component__WEBPACK_IMPORTED_MODULE_19__["BulkAddComponent"]
            ]
        })
    ], PropertiesModule);
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9wcm9wZXJ0aWVzL3Byb3BlcnR5LWRldGFpbHMvcHJvcGVydHktZGV0YWlscy5jb21wb25lbnQuY3NzIn0= */"
...
module.exports = "\n<div class=\"container-fluid\">\n  <div class=\"white-bg configuration-page\">\n      <div class=\"top-main-img-outer\">\n        <div class=\"avl\">{{'propertyDetail.availableFor' | translate}}\n            <span *ngIf=\"property?.for_rent\">{{'propertyDetail.rent' | translate}}</span>\n            <span *ngIf=\"property?.for_rent && property?.for_sale\">/</span>\n            <span *ngIf=\"property?.for_sale\">{{'propertyDetail.sale' | translate}}</span>\n        </div>\n        <div class=\"fig-block\">\n            <!-- <img class=\"img-fluid top-main-img\" [src]=\"property?.image\" onerror='this.src=\"assets/img/loading_image_1.gif\"'> -->\n            <img class=\"img-fluid top-main-img\" onerror='this.src=\"assets/img/placeholder.png\"' [defaultImage]=\"property?.image| img:'thumb'\" [lazyLoad]=\"property?.image\">\n      </div> \n      </div>\n      <div class=\"padding30\">\n        <div class=\"apart-info \">\n            <p *ngIf=\"property?.name\" class=\"p14\">\n              {{property?.name}}\n            </p>\n            <p class=\"p12\">\n              <app-property-configuration *ngIf=\"property?.building_configuration\" [configuration]=\"property?.building_configuration?.config\"></app-property-configuration>\n              <span>&middot; {{property?.property_type?.name}} </span>\n            </p>\n\n            <h6 class=\"float-left\">{{property?.max_area}} {{'propertyDetail.sqmt' | translate}}</h6> <h6 class=\"float-right\">{{property?.max_price|price}}</h6>\n            <div class=\"clearfix\"></div>\n        </div> \n        <div class=\"building-name\">\n            <div class=\"float-left\">\n                <p *ngIf=\"property?.building\" class=\"p14\">{{property?.building?.name}}</p>\n                <p class=\"p12 marginB0\">{{'propertyDetail.building' | translate}}</p>\n            </div>\n            <div class=\"float-right\"><a href=\"javascript://\">\n                <img src=\"assets/img/viewfull.png\" alt=\"img\"></a></div>\n            <!-- <div *ngIf=\"property.building\" class=\"float-right\" [routerLink]=\"['/project',property.building.id]\"><a href=\"javascript://\"><img src=\"assets/img/viewfull.png\" alt=\"img\"></a></div> -->\n            <div class=\"clearfix\"></div>\n        </div>\n\n        <div class=\"clearfix\"></div>\n        <div class=\"row\">\n            <div class=\"col-md-6 col-12\">\n                <h4>{{'propertyDetail.description' | translate}}</h4>\n                <p class=\"p15 newline\">{{property?.description}}</p>\n\n                <h4>{{'propertyDetail.area' | translate}}</h4>\n                <div class=\"area-table\" *ngIf=\"property?.carpet_areas\">\n                    <table class=\"table table-borderless\">\n                       <tbody><tr>\n                       <th>{{'propertyDetail.carpetArea' | translate}}</th>\n                       <th>{{'propertyDetail.basePrice' | translate}}</th>\n                       </tr>\n                       <tr *ngFor=\"let area of property?.carpet_areas \" >\n                         <td>{{area.area}} {{'propertyDetail.sqmt' | translate}}</td>\n                         <td>{{area.price|price}}</td>\n                       </tr>\n\n                    </tbody></table>\n                 </div>\n\n                <h4>{{'propertyDetail.Specifications' | translate}}</h4>\n                <div class=\"spec-table\">\n                    <table class=\"table table-borderless\">\n                       <tbody><tr>\n                          <td>\n                          <label>{{'propertyDetail.Bedrooms' | translate}}</label>\n                          <span>{{property?.bedroom}}</span>\n                          </td>\n                          <td>\n                          <label>{{'propertyDetail.Bathrooms' | translate}}</label>\n                          <span>{{property?.bathroom}}</span>\n                          </td>\n                       </tr>\n                        <tr>\n                          <td>\n                          <label>{{'propertyDetail.Parking' | translate}}</label>\n                          <span>{{property?.parking ? ('propertyDetail.yes' | translate) : ('propertyDetail.no' | translate)}}</span>\n                          </td>\n                          <td>\n                          <label>{{'propertyDetail.Furnished' | translate}}</label>\n                          <span>{{property?.furnished ? ('propertyDetail.yes' | translate) : ('propertyDetail.no' | translate)}}</span>\n                          </td>\n                       </tr>\n                        <tr>\n                          <td>\n                          <label>{{'propertyDetail.petsAllowed' | translate}}</label>\n                          <span>{{property?.pets ? ('propertyDetail.yes' | translate) : ('propertyDetail.no' | translate)}}</span>\n                          </td>\n                          <td *ngIf=\"property?.marital_statuses\">\n                          <label>{{'propertyDetail.availableFor' | translate}}</label>\n                          <span *ngFor=\"let ms of property.marital_statuses; let i=index\">\n                              {{ms.name}}\n                              <span *ngIf=\"i<property?.marital_statuses?.length-1\">,</span>\n                            </span>\n                          </td>\n\n                       </tr>\n                    </tbody></table>\n                </div>\n\n                <div *ngIf=\"property?.amenities?.length > 0\">\n                 <h4>{{'propertyDetail.amenities' | translate}}</h4>\n                 <ul class=\"green-icon-list\">\n                    <li *ngFor=\"let amenity of property?.amenities\">\n                      <span><img src=\"assets/img/green-icon.png\" alt=\"img\"></span>\n                      {{amenity.name}}\n                    </li>\n                 </ul>\n                </div>\n\n            </div>\n            <div class=\"col-md-6 col-12\">\n                <div class=\"fig-block text-center\">\n                    <!-- <img class=\"img-fluid\" [src]=\"property?.floor_plan\" alt=\"img\"> -->\n                    <img class=\"img-fluid\" onerror='this.src=\"assets/img/placeholder.png\"' [defaultImage]=\"property?.floor_plan| img:'thumb'\" [lazyLoad]=\"property?.floor_plan\">\n                </div>\n            </div>\n\n\n        </div>\n      </div>\n      </div>\n</div>\n  "
...
var PropertyDetailsComponent = /** @class */ (function () {
    function PropertyDetailsComponent(admin, route, spinner, constant, propertyService) {
        this.admin = admin;
        this.route = route;
        this.spinner = spinner;
        this.constant = constant;
    ...
    PropertyDetailsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_admin_service__WEBPACK_IMPORTED_MODULE_3__["AdminService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"],
