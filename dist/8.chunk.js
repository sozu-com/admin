...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__add_template_add_template_component__ = __webpack_require__("../../../../../src/app/layout/templates/add-template/add-template.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__templates_component__ = __webpack_require__("../../../../../src/app/layout/templates/templates.component.ts");
...
var routes = [
    { path: 'view-all', component: __WEBPACK_IMPORTED_MODULE_11__templates_component__["a" /* TemplatesComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_9__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Templates', 'can_read', ''] } },
    { path: 'add-template/:id', component: __WEBPACK_IMPORTED_MODULE_10__add_template_add_template_component__["a" /* AddTemplateComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_9__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Templates', 'can_create', ''] } },
    { path: 'edit-template/:id', component: __WEBPACK_IMPORTED_MODULE_10__add_template_add_template_component__["a" /* AddTemplateComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_9__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Templates', 'can_update', ''] } }
];
var TemplatesModule = /** @class */ (function () {
    ...
    TemplatesModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_11__templates_component__["a" /* TemplatesComponent */],
                __WEBPACK_IMPORTED_MODULE_10__add_template_add_template_component__["a" /* AddTemplateComponent */]
            ],
            imports: [
