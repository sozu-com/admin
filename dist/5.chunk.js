...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__project_details_project_details_component__ = __webpack_require__("../../../../../src/app/layout/projects/project-details/project-details.component.ts");
...
var routes = [
    { path: 'details/:project_id', component: __WEBPACK_IMPORTED_MODULE_11__project_details_project_details_component__["a" /* ProjectDetailsComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Building Management', 'can_read', ''] } },
    { path: 'view-projects', component: __WEBPACK_IMPORTED_MODULE_2__projects_component__["a" /* ProjectsComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Building Management', 'can_read', ''] } },
    { path: 'view-projects/:id', component: __WEBPACK_IMPORTED_MODULE_2__projects_component__["a" /* ProjectsComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Building Management', 'can_read', ''] } },
    { path: 'add-project', component: __WEBPACK_IMPORTED_MODULE_4__add_project_add_project_component__["a" /* AddProjectComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Building Management', 'can_create', ''] } },
    { path: 'edit-project/:id', component: __WEBPACK_IMPORTED_MODULE_4__add_project_add_project_component__["a" /* AddProjectComponent */],
        canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_acl_user_guard__["a" /* AclUserGuard */]], data: { roles: ['Building Management', 'can_update', ''] } }
];
// const routes: Routes = [
    ...
    ProjectsModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__project_details_project_details_component__["a" /* ProjectDetailsComponent */]
            ]
        })
    ], ProjectsModule);
