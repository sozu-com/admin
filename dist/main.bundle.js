...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.dashboard = function () {
        ...
        this.admin.getDataApi(this.parameter.url)
            ...
            _this.parameter.loading = false;
            _this.dashModel = success.data;
            console.log(_this.dashModel, success);
        }, function (error) {
            _this.parameter.loading = false;
...
var InhouseUsersComponent = (function () {
    ...
    InhouseUsersComponent.prototype.getCountries = function (type) {
        var _this = this;
        this.parameter.loading = true;
        this.parameter.url = 'getCountries';
        var input = new FormData();
    ...
    InhouseUsersComponent.prototype.getStates = function (country_id, type) {
        var _this = this;
        this.parameter.loading = true;
        this.parameter.url = 'country/getStates';
        this.parameter.country_id = country_id;
    ...
    InhouseUsersComponent.prototype.getCities = function (state_id, type) {
        var _this = this;
        this.parameter.loading = true;
        this.parameter.url = 'getCities';
        this.parameter.state_id = state_id;
    ...
    InhouseUsersComponent.prototype.getLocalities = function (city_id, type) {
        var _this = this;
        this.parameter.loading = true;
        this.parameter.url = 'getLocalities';
        this.parameter.city_id = city_id;
        if (city_id == -1) {
            ...
            this.admin.postDataApi(this.parameter.url, input)
                ...
                if (success.data.length != 0)
                    _this.parameter.locality_id = success.data[0].id;
                _this.getInhouseUsers();
            }, function (error) {
                // console.log(error)
                _this.parameter.loading = false;
...
module.exports = "\n<div class=\"container-fluid\">\n    <div class=\"row\">\n        <div class=\"col-md-6\">\n          <div class=\"title-group\">\n              <h5>Users</h5>\n              <p>Showing {{parameter.total}} out of {{parameter.total}}</p>\n          </div>\n        </div>\n        <div class=\"col-md-6\">\n          <div class=\"add-new text-right\">\n              <a class=\"btn\" href=\"javascript://\" data-toggle=\"modal\" data-target=\"#add\" #modalOpen>Add New</a>\n          </div>\n        </div>\n    </div>\n  \n    <ngx-loading [show]=\"parameter.loading\"></ngx-loading>\n  \n    <div class=\"cust-tabs\">\n        <div class=\"row flex-wrap-reverse\">\n          <div class=\"col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12\">\n            <ul class=\"nav nav-tabs\">\n              <li class=\"nav-item\">\n                  <a class=\"nav-link active\" data-toggle=\"tab\" href=\"#approved\">BUYER</a>\n              </li>\n              <li class=\"nav-item\">\n                  <a class=\"nav-link\" data-toggle=\"tab\" href=\"#unapproved\">SELLER</a>\n              </li>\n            </ul>\n          </div>\n        </div>\n\n          <div class=\"tab-content\">\n             <div class=\"tab-pane active\">\n                <div class=\"tabel-section\">\n                   <div class=\"table-responsive\">\n                      <table class=\"table table-striped table-align-left\">\n                         <tr>\n                            <th style=\"width:6%\">&nbsp;</th>\n                                <th style=\"width:20%\">\n                                  <div class=\"table-search\">\n                                      <label>Name</label>\n                                      <input type=\"Search here\" name=\"\">\n                                  </div>\n                                </th>\n                                <th style=\"width:20%; text-align:left;\">\n                                  <div class=\"table-search\">\n                                      <label>Contact Number</label>\n                                      <input type=\"Search here\" name=\"\">\n                                  </div>\n                                </th>\n                                <th style=\"width:20%\">\n                                  <div class=\"table-search\">\n                                      <label>Email Address</label>\n                                      <input type=\"Search here\" name=\"\">\n                                  </div>\n                                </th>\n                                <th style=\"width:20%; vertical-align: top;\">\n                                  Building<a href=\"javascript://\"><img src=\"./../../../../assets/img/top-arrow.png\" alt=\"img\"></a>\n                                </th>\n                                <th style=\"width:14%\">\n                                  &nbsp;\n                                </th>\n                         </tr>\n                   \n            <tr *ngFor=\"let item of parameter.items| paginate: { itemsPerPage: parameter.itemsPerPage, currentPage: parameter.p, totalItems: parameter.total }\">\n                <td> \n                  <img *ngIf=\"item.image\" class=\"rounded-circle\" [src]=\"item.image\" alt=\"img\">\n                  <img *ngIf=\"!item.image\" class=\"rounded-circle\" src=\"http://via.placeholder.com/50x50\" alt=\"img\">\n                </td>\n                <td class=\"text-left\">\n                  <span class=\"name\">{{item.name}}</span>\n                </td>\n                <td class=\"text-left\" *ngIf=\"item.phone\">{{item.country_code}}-{{item.phone}}</td>\n                <td class=\"text-left\" *ngIf=\"!item.phone\">NA</td>\n                <td class=\"text-left\">{{item.email}}</td>\n                <td>14</td>\n                <td>\n                  <a href=\"javascript://\" (click)=\"editUser(item)\" class=\"icon-block edit-icon\"><img src=\"./../../../../assets/img/edit.png\" alt=\"img\"></a>\n                  <a href=\"javascript://\" class=\"icon-block block-icon\"><img src=\"./../../../../assets/img/block.png\" alt=\"img\"></a>\n                </td>\n              </tr>\n                      </table>\n                   </div>\n                </div>\n                <div class=\"btn-cont text-right marginT15\">\n                    <pagination-controls class=\"my-pagination\" (pageChange)=\"getPage($event)\"></pagination-controls>\n                   <!-- <button class=\"btn btn-secondary\">View All</button> -->\n                </div>\n             </div>\n             <div class=\"tab-pane container fade\" id=\"seller\">Seller tab on</div>\n          </div>\n       </div>\n</div>\n\n\n\n<!-- add inhouse user modal -->\n<div class=\"modal animated\" id=\"add\">\n  <div class=\"modal-dialog fadeIndown modal-lg\">\n     <div class=\"modal-content\">\n        <div class=\"modal-header\">\n           <button type=\"button\" class=\"close\" data-dismiss=\"modal\" #modalClose>&times;</button>\n        </div>\n\n        <form class=\"form-horizontal form-model0P\" role=\"form\" ngNativeValidate #addForm=\"ngForm\" (ngSubmit)=\"addNewUser(addForm)\">\n        <div class=\"modal-body\">\n            <div class=\"row\">\n               <div class=\"col-6\">\n                  <div class=\"add-img\">\n                  <input required accept=\"image/*\" class=\"image\" (change)=\"changeListner($event)\" type=\"file\">\n                  <label>+ Add Image</label>\n                  </div>\n               </div>\n               <div class=\"col-6\">\n                  <div class=\"btn-cont text-right\">\n                     <button type=\"submit\" [disabled]=\"addForm.invalid\" class=\"btn btn-primary\">ADD</button>\n                  </div>\n               </div>\n               <div class=\"col-12\">\n                  <div class=\"spacer40\"></div>\n               </div>\n               <div class=\"col-12\">\n                  <div class=\"form-group-2\">\n                     <label>Name</label>\n                     <div class=\"form-group\">\n                      <!-- <input type=\"text\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"model.userModel.name\" name=\"name\" #name=\"ngModel\">\n                      <div *ngIf=\"name.errors && (name.dirty || name.touched)\" class=\"show-error\">\n                          <div [hidden]=\"!name.errors.required\">\n                            {{constant.errorMsg.COUNTRY_NAME_REQUIRED}}\n                          </div>\n                      </div> -->\n                      <input autocomplete=\"off\" type=\"text\" class=\"form-control\" required [(ngModel)]=\"model.userModel.name\" name=\"name\">\n                    </div>\n                  </div>\n               </div>\n               <div class=\"col-12\">\n                  <div class=\"form-group-2\">\n                     <label>Contact number</label>\n                     <div class=\"form-group\">\n                        <!-- <input type=\"text\" class=\"form-control\"\n                        id=\"phone\" required minlength=\"1\" [(ngModel)]=\"model.userModel.phone\" \n                        name=\"phone\" #phone=\"ngModel\"\n    ng2TelInput\n    [ng2TelInputOptions]=\"initialCountry\"\n    (countryChange)=\"onCountryChange($event)\" />\n                      <div *ngIf=\"phone.errors && (phone.dirty || phone.touched)\" class=\"show-error\">\n                          <div [hidden]=\"!phone.errors.required\">\n                            {{constant.errorMsg.COUNTRY_NAME_REQUIRED}}\n                          </div>\n                      </div> -->\n                      <input autocomplete=\"off\" type=\"text\" class=\"form-control\" id=\"phone\" required minlength=\"1\" [(ngModel)]=\"model.userModel.phone\" name=\"phone\"\n                            ng2TelInput [ng2TelInputOptions]=\"initialCountry\" (countryChange)=\"onCountryChange($event)\" />\n                    </div>\n                  </div>\n               </div>\n               <div class=\"col-12\">\n                  <div class=\"form-group-2\">\n                     <label>Email ID</label>\n                     <div class=\"form-group\">\n                      <!-- <input type=\"text\" class=\"form-control\" id=\"email\" required [(ngModel)]=\"model.userModel.email\" name=\"email\" #email=\"ngModel\">\n                      <div *ngIf=\"email.errors && (email.dirty || email.touched)\" class=\"show-error\">\n                          <div [hidden]=\"!email.errors.required\">\n                            {{constant.errorMsg.COUNTRY_NAME_REQUIRED}}\n                          </div>\n                      </div> -->\n                      <input autocomplete=\"off\" type=\"text\" class=\"form-control\" required [(ngModel)]=\"model.userModel.email\" name=\"email\">\n                    </div>\n                  </div>\n               </div>\n            </div>\n            <div class=\"form-group marginB0\">\n                <label>Intereseted In</label>\n                <select class=\"form-control\">\n                  <option>All</option>\n                  <option>All</option>\n                  <option>All</option>\n                </select>\n            </div>\n         </div>\n        </form>\n\n     </div>\n  </div>\n</div>"
...
var UsersComponent = (function () {
    ...
    UsersComponent.prototype.getInhouseUsers = function () {
        var _this = this;
        this.parameter.loading = true;
...
UsersComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_4__models_inhouse_users_model__["a" /* InhouseUsers */], __WEBPACK_IMPORTED_MODULE_5__common_constants__["a" /* Constant */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_5__common_constants__["a" /* Constant */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__common_constants__["a" /* Constant */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__models_inhouse_users_model__["a" /* InhouseUsers */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__models_inhouse_users_model__["a" /* InhouseUsers */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__services_admin_service__["a" /* AdminService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_admin_service__["a" /* AdminService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_3_ngx_sweetalert2__["a" /* SweetAlertService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ngx_sweetalert2__["a" /* SweetAlertService */]) === "function" && _g || Object])
], UsersComponent);
...
var AdminService = (function () {
    ...
    function AdminService(http, swal) {
        ...
        this.loginData$ = new __WEBPACK_IMPORTED_MODULE_7_rxjs_BehaviorSubject__["BehaviorSubject"]({});
    }
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        if (this.admin.loginData$.data == undefined) {
            ...
            this.admin.postDataApi('get-details', input)
                ...
                _this.admin.loginData$ = success.data;
            });
        }
        if (token) {
            return true;
