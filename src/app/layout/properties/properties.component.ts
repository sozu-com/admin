    ...
    if (this.exportfinalData) {
      ...
      for (let index = 0; index < this.exportfinalData.length; index++) {
        ...
        let obj = {
          ...
          'Configuration Bed': p.building_configuration.config ? p.building_configuration.config.bedroom + ' Bed' : "0 Bed",
          'Configuration Bath': p.building_configuration.config ? p.building_configuration.config.bathroom + ' Bath' : '0 Bath',
          'Configuration Half Bath': p.building_configuration.config ? p.building_configuration.config.half_bathroom + ' Half Bath' : '0 Half Bath',
