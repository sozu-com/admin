...
export class CollectionsComponent implements OnInit, OnDestroy {
  ...
  setPaymentAmount(item: any) {
    ...
    if (this.typeOfPayment === 'commission-popup') {
      ...
      this.ivaAmount = 0;
      if (this.commission_type == 1) {
        this.paymentAmount = (item.purchase_comm_amount || 0) - (this.purchase__amount || 0);
        ...
        this.paymentAmount = (item.agent_comm_amount  || 0) - (this.agent_amount || 0) ;
        ...
        this.paymentAmount = (item.amount || 0) - (this.collection_amount || 0);
