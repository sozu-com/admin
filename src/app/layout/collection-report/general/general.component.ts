      ...
      success => {
        ...
        for (let index = 0; index < this.allMonths.length; index++) {
          ...
          for (let i = 0; i < this.finalData.length; i++) {
            ...
            if (!e.firstCol.toLocaleLowerCase().includes('total') && !e.firstCol.toLocaleLowerCase().includes('commission') && !e.firstCol.toLocaleLowerCase().includes(' pc_amount') && !e.firstCol.toLocaleLowerCase().includes('iva')) {
              t = t + (e[element] || 0);
            }
          }
          f[element] = t;
