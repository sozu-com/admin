...
@Component({
  selector: 'app-outside-pro-detail',
  templateUrl: './outside-pro-detail.component.html',
  styleUrls: ['./outside-pro-detail.component.css']
})
export class OutsideProDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params) => {
      ...
      this.getPropertyDetails(params.pro_id)
    })
  }
