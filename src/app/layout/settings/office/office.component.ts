...
export class OfficeComponent implements OnInit {
  ...
  addParkingLotSpaces(id, name_en, name_es, status, type) {
    ...
    this.parameter.url = 'addOfficeParkingLotSpaces';
  ...
  addPossessionStatus(id, name_en, name_es, status, type) {
    if (type === 'edit') { this.modalRef.hide(); }
    this.parameter.url = 'addOfficePossessionStatus';
    const input = new FormData();
    input.append('name_en', name_en);
    input.append('name_es', name_es);
    input.append('status', status);
  ...
  addBuildingType(id, name_en, name_es, status, type) {
    if (type === 'edit') { this.modalRef.hide(); }
    this.parameter.url = 'addOfficeBuildingType';
  ...
  addAmenity(id, icon, name_en, name_es, status, type) {
    ...
    this.parameter.url = 'addOfficeAmenity';
  ...
  getPossessionStatuses() {
    this.spinner.show();
    this.parameter.url = 'getOfficePossessionStatuses';
    const input = new FormData();
    this.admin.postDataApi(this.parameter.url, { hide_blocked: 0 })
      .subscribe(
        success => {
  ...
  getBuildingTypes() {
    this.spinner.show();
    this.parameter.url = 'getOfficeBuildingTypes';
    const input = new FormData();
    this.admin.postDataApi(this.parameter.url, { hide_blocked: 0 })
      .subscribe(
        success => {
  ...
  getAmenities() {
    this.spinner.show();
    this.parameter.url = 'getOfficeAmenities';
    const input = new FormData();
    this.admin.postDataApi(this.parameter.url, { hide_blocked: 0 })
      .subscribe(
        success => {
